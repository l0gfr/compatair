...
- recherche globale, comparateur de deux ou trois modèles, pages par marque et pages par usage ; le périmètre compte 122 129 combinaisons explorables, dont 119 500 verdicts fixes audités et 2 629 combinaisons paramétriques nécessitant des entrées utilisateur ;
...
- snapshots JSON du catalogue et des 119 500 verdicts fixes, validation, checksums, détection des doublons et rapports de différences ;
