...
- recherche globale, comparateur de deux ou trois modèles, pages par marque et pages par usage ; le périmètre compte 14 400 combinaisons explorables, dont 13 080 verdicts fixes audités et 1 320 combinaisons paramétriques nécessitant des entrées utilisateur ;
...
- snapshots JSON du catalogue et des 13 080 verdicts fixes, validation, checksums, détection des doublons et rapports de différences ;
