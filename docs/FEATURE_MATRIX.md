...
- recherche globale, comparateur de deux ou trois modèles, pages par marque et pages par usage ; le périmètre compte 301 379 combinaisons explorables, dont 298 750 verdicts fixes audités et 2 629 combinaisons paramétriques nécessitant des entrées utilisateur ;
...
- snapshots JSON du catalogue et des 298 750 verdicts fixes, validation, checksums, détection des doublons et rapports de différences ;
