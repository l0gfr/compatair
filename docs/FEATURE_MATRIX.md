...
- recherche globale, comparateur de deux ou trois modèles, pages par marque et pages par usage ; le périmètre compte 927 453 combinaisons explorables, dont 920 706 verdicts fixes audités et 6 747 combinaisons paramétriques nécessitant des entrées utilisateur ;
...
- snapshots JSON du catalogue et des 920 706 verdicts fixes, validation, checksums, détection des doublons et rapports de différences ;
