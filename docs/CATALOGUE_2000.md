...
Les suggestions du calculateur sont servies séparément avec une empreinte SHA-256 vérifiée par le navigateur. Leur chargement commence à l’approche du formulaire ou lors de son interaction ; un lien prérempli les charge immédiatement avant la restauration des paramètres. Une indisponibilité, une empreinte incohérente ou un dépassement de délai bloque le calcul avec une erreur visible. Le HTML passe de 545 277 à 92 143 octets. Trois contrôles Lighthouse ciblés mesurent un LCP de 2,40 à 2,41 s, avec 97/100 en performance et 100/100 en accessibilité. Le plafond LCP de 2,5 s reste inchangé.
