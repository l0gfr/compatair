...
const airGraphToolDefinitions = [
	...
	['build_complete_air_system', 'Build a source-backed compressor, pneumatic tool, hose, connector, filtration and lubrication system. The complete-system verdict remains insufficient_data until real network pressure loss is verified; missing component data stays explicit.', { toolIds: { type: 'array', minItems: 1, maxItems: 20, items: { type: 'string' } }, mode: { type: 'string', enum: ['simultaneous', 'successive'] }, compressorId: { type: 'string' }, limit: { type: 'integer', minimum: 1, maximum: 10 } }, ['toolIds']],
