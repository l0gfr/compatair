...
try {
	const staticAffiliateRoutes = await readdir('src/pages/go', { recursive: true });
	if (staticAffiliateRoutes.length) errors.push('src/pages/go: les redirections marchandes doivent rester exclusivement servies par le proxy Node');
} catch (error) {
