...
const report = { generatedAt: new Date().toISOString(), compressors: changes(previous.compressors, current.compressors), tools: changes(previous.tools, current.tools), offers: changes(previous.offers, current.offers), verdicts: changes(previous.pairs, current.pairs) };
