...
describe('CompatAir passport PDF', () => {
	it('emits a self-contained versioned PDF with multiple sections', () => {
		const report = {
			schemaVersion: '1.0.0', calculationVersion: '1.1.0', catalogVerifiedAt: '2026-07-14', passportId: 'a'.repeat(64), generatedAt: '2026-07-14T10:00:00.000Z',
			...
			result: { verdict: 'continuous', peakFlowLpm: 100, averageFlowLpm: 100, recommendedFadLpm: 125, requiredPressureBar: 6.3, usefulPressureBar: 6.3, confidence: 'high', hypotheses: [], warnings: [], flowBasis: 'documented-continuous', calculationVersion: '1.1.0' },
