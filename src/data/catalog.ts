...
const rawTools = [
	...
	},
	{
		...
		editorial: { overview: 'La TC-PN 50 combine agrafage et clouage. Sa notice exprime le besoin en volume par action, environ 0,66 litre par tir, à 6,3 bar recommandés. Un débit en L/min ne peut être obtenu qu’en ajoutant un rythme de tir explicite.', verifiedFacts: ['La notice publie environ 0,66 litre d’air par tir, une pression recommandée de 6,3 bar et un maximum autorisé de 8,3 bar.', 'L’outil accepte des agrafes de 13 à 40 mm et des clous de 10 à 50 mm, avec un flexible intérieur recommandé de 9 mm.'], limitations: ['CompatAir ne transforme pas 0,66 litre par tir en L/min sans nombre de tirs par minute.', 'Aucun verdict de compatibilité automatique n’est publié tant que ce rythme d’utilisation n’est pas renseigné.'] },
		evidence: [
	...
	{
		id: 'abac-g-550f', slug: 'pistolet-peinture-hvlp-abac-g-550f', category: 'Pistolet à peinture HVLP', label: 'Pistolet à peinture HVLP ABAC G-550F', brand: 'ABAC', model: 'G-550F', mpn: '2809913544',
