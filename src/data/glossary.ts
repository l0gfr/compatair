export const glossarySources = {
	...
	ralstonThreads: {
		label: 'Ralston Instruments, NPT, BSPP et BSPT',
		url: 'https://www.ralstoninst.com/news/story/the-difference-between-npt-bspp-and-bspt-seals',
	},
	atlasFlow: {
...
export const glossaryTerms: GlossaryTerm[] = [
	...
	{ term: 'BSPP / BSPT', slug: 'bspp-bspt', definition: 'Familles de filetages de raccordement : BSPP est parallèle, BSPT conique côté mâle. Leur identification doit inclure la connexion exacte et son mode d’étanchéité ; la taille nominale seule ne suffit pas.', source: 'ralstonThreads', related: { label: 'Identifier un raccord d’air', href: '/guides/raccord-air-comprime-bsp-npt-1-4/' } },
	...
	{ term: 'Compresseur alternatif', slug: 'compresseur-alternatif', definition: 'Compresseur dans lequel un piston effectue un mouvement alternatif dans un cylindre pour comprimer l’air.', source: 'cagi', related: { label: 'Comparer piston et vis', href: '/guides/compresseur-piston-ou-vis-profil-charge/' } },
	...
	{ term: 'Compresseur rotatif à vis', slug: 'compresseur-rotatif-vis', definition: 'Compresseur volumétrique rotatif dans lequel deux rotors engrenés emprisonnent l’air puis réduisent son volume jusqu’au refoulement.', source: 'doe', related: { label: 'Comparer piston et vis', href: '/guides/compresseur-piston-ou-vis-profil-charge/' } },
	...
	{ term: 'Fréquence d’utilisation', slug: 'frequence-utilisation', definition: 'Part déclarée d’une session pendant laquelle un outil est effectivement sollicité. Elle sert à décrire la demande moyenne et ne remplace ni le débit instantané publié ni une mesure de terrain.', source: 'method', related: { label: 'Décrire plusieurs outils', href: '/guides/utiliser-plusieurs-outils-pneumatiques/' } },
	{ term: 'FRL', slug: 'frl', definition: 'Ensemble filtre, régulateur et lubrificateur placé au voisinage d’un usage lorsque ces trois fonctions sont requises. Chaque composant peut ajouter une perte de charge.', source: 'doe', related: { label: 'Installer et entretenir un FRL', href: '/guides/groupe-frl-filtre-regulateur-lubrificateur/' } },
	...
	{ term: 'Lubrificateur', slug: 'lubrificateur', definition: 'Dispositif qui introduit une quantité réglée de lubrifiant dans l’air aval pour les équipements dont la notice l’exige. Il ne doit pas alimenter un usage qui impose un air non huilé.', source: 'cagi', related: { label: 'Installer et entretenir un FRL', href: '/guides/groupe-frl-filtre-regulateur-lubrificateur/' } },
	...
	{ term: 'Nl/min', slug: 'normolitre-par-minute', definition: 'Débit volumique ramené à des conditions dites normales. Température, pression absolue et convention de référence doivent être connues avant comparaison avec un débit exprimé selon d’autres conditions.', source: 'atlasFlow', related: { label: 'Comparer les unités de débit', href: '/guides/convertir-cfm-l-min-nl-min-air-comprime/' } },
	{ term: 'NPT', slug: 'npt', definition: 'Famille américaine de filetages coniques. Sa géométrie diffère de celle du BSPT ; un début de vissage ne démontre pas la compatibilité ni l’étanchéité de deux raccords.', source: 'ralstonThreads', related: { label: 'BSP ou NPT : vérifier les interfaces', href: '/guides/raccord-air-comprime-bsp-npt-1-4/' } },
	...
	{ term: 'Profil de demande', slug: 'profil-demande', definition: 'Évolution du débit demandé au cours du temps. Il révèle les pointes, les charges intermittentes et les périodes sans consommation productive.', source: 'doe', related: { label: 'Comparer piston et vis', href: '/guides/compresseur-piston-ou-vis-profil-charge/' } },
	...
	{ term: 'Régulateur de pression', slug: 'regulateur-pression', definition: 'Dispositif qui maintient une pression aval adaptée à l’usage dans sa plage de fonctionnement. Il ne compense pas un débit amont insuffisant.', source: 'atlas', related: { label: 'Installer et entretenir un FRL', href: '/guides/groupe-frl-filtre-regulateur-lubrificateur/' } },
	{ term: 'SCFM', slug: 'scfm', definition: 'Débit d’air libre en pieds cubes par minute ramené à des conditions standard. La définition de ces conditions doit accompagner la valeur et rester attachée à toute conversion d’unité.', source: 'cagi', related: { label: 'Convertir sans perdre les conditions', href: '/guides/convertir-cfm-l-min-nl-min-air-comprime/' } },
	...
	{ term: 'Qualité des sources', slug: 'qualite-sources', definition: 'Appréciation de la complétude, de la traçabilité et de l’adéquation d’une source aux caractéristiques nécessaires au verdict. CompatAir affiche un libellé humain et conserve le grade technique dans le détail.', source: 'method', related: { label: 'Sources et fiabilité', href: '/sources-fiabilite/' } },
