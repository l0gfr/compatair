const product = {
	"id": "schneider-unm-sts-1000-10-270-c",
	"slug": "schneider-unm-sts-1000-10-270-c",
	"brand": "Schneider",
	"model": "UNM STS 1000-10-270 C",
	"mpn": "1121570228",
	"tankLiters": 270,
	"maxPressureBar": 10,
	"fadCurve": [
	...
	"editorial": {
		"overview": "UNM STS 1000-10-270 C, référence 1121570228, associe une cuve de 270 L à un moteur de 5,5 kW. Le débit restitué publié est de 785 L/min à 9 bar. Démarreur étoile-triangle prémonté (version C).",
		"verifiedFacts": [
			"Pression publiée : 10 bar ; débit aspiré : 1 070 L/min, distinct du débit restitué.",
			"Poids publié : 206 kg ; dimensions : 920 × 705 × 1 800 mm.",
	...
	"evidence": [
		{
			"id": "schneider-2025-1121570228",
			"sourceUrl": "https://www.schneider-airsystems.de/content/dam/brands/schneider/documents/catalogs-brochures/Schneider%20airsystems-Gesamtkatalog-2025-DE-SCREEN.pdf#page=46",
			"sourceLabel": "Schneider airsystems, catalogue 2025, p. 46, réf. 1121570228",
	...
	"notes": [
		...
		"Source : catalogue 2025, page 46, référence 1121570228."
	]
};
