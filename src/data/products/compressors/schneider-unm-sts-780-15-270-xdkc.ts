const product = {
	"id": "schneider-unm-sts-780-15-270-xdkc",
	"slug": "schneider-unm-sts-780-15-270-xdkc",
	"brand": "Schneider",
	"model": "UNM STS 780-15-270 XDKC",
	"mpn": "1121570244",
	"tankLiters": 270,
	"maxPressureBar": 15,
	"fadCurve": [
	...
	"editorial": {
		"overview": "UNM STS 780-15-270 XDKC, référence 1121570244, associe une cuve de 270 L à un moteur de 5,5 kW. Le débit restitué publié est de 570 L/min à 14 bar. Démarreur étoile-triangle prémonté (version C). Sécheur frigorifique intégré.",
		"verifiedFacts": [
			"Pression publiée : 15 bar ; débit aspiré : 830 L/min, distinct du débit restitué.",
			"Poids publié : 248 kg ; dimensions : 1 020 × 705 × 1 800 mm.",
	...
	"evidence": [
		{
			"id": "schneider-2025-1121570244",
			"sourceUrl": "https://www.schneider-airsystems.de/content/dam/brands/schneider/documents/catalogs-brochures/Schneider%20airsystems-Gesamtkatalog-2025-DE-SCREEN.pdf#page=48",
			"sourceLabel": "Schneider airsystems, catalogue 2025, p. 48, réf. 1121570244",
	...
	"notes": [
		...
		"Source : catalogue 2025, page 48, référence 1121570244."
	]
};
