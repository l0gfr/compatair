const product = {
	"id": "fini-plus-8-08-270",
	"slug": "fini-plus-8-08-270",
	"brand": "Fini",
	"model": "PLUS 8-08-270",
	"mpn": "V91NG92FNM701",
	"tankLiters": 270,
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/fini-plus-8-08-270.webp",
		"alt": "Repères techniques Fini PLUS 8-08-270, référence V91NG92FNM701",
	...
	"editorial": {
		"overview": "Fini PLUS 8-08-270, référence V91NG92FNM701 : cuve de 270 L, pression maximale publiée de 8 bar. Le point documenté le plus élevé en pression fournit 1 250 L/min à 8 bar. Version sans sécheur intégré.",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "fini-v91ng92fnm701-20260926",
			"sourceUrl": "https://finicompressors.com/wp-content/uploads/Catalogo-Micro-Plus_Fini_IT_04-2024_9990394.pdf#page=17",
			"sourceLabel": "Fini, catalogue MICRO / PLUS, édition 04-2024, p. 17, réf. V91NG92FNM701",
		...
		{
			"id": "fini-v91ng92fnm701-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"fini-v91ng92fnm701-20260926-lubrification"
		],
		"powerKw": [
			"fini-v91ng92fnm701-20260926"
		],
