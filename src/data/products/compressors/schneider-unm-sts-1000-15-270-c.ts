const product = {
	"id": "schneider-unm-sts-1000-15-270-c",
	"slug": "schneider-unm-sts-1000-15-270-c",
	"brand": "Schneider",
	"model": "UNM STS 1000-15-270 C",
	"mpn": "1121570231",
	"tankLiters": 270,
	"maxPressureBar": 15,
	"fadCurve": [
	...
	"editorial": {
		"overview": "UNM STS 1000-15-270 C, référence 1121570231, associe une cuve de 270 L à un moteur de 7,5 kW. Le débit restitué publié est de 790 L/min à 14 bar. Démarreur étoile-triangle prémonté (version C).",
		"verifiedFacts": [
			"Pression publiée : 15 bar ; débit aspiré : 1 000 L/min, distinct du débit restitué.",
			"Poids publié : 253 kg ; dimensions : 975 × 705 × 1 875 mm.",
	...
	"specifications": [
		{
			...
			"value": "975 × 705 × 1 875 mm",
			"evidenceIds": [
				"schneider-2025-1121570231"
			]
		},
		{
	...
	"evidence": [
		{
			"id": "schneider-2025-1121570231",
			"sourceUrl": "https://www.schneider-airsystems.de/content/dam/brands/schneider/documents/catalogs-brochures/Schneider%20airsystems-Gesamtkatalog-2025-DE-SCREEN.pdf#page=46",
			"sourceLabel": "Schneider airsystems, catalogue 2025, p. 46, réf. 1121570231",
	...
	"notes": [
		...
		"Source : catalogue 2025, page 46, référence 1121570231."
	]
};
