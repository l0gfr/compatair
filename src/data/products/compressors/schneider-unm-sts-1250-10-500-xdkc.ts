const product = {
	"id": "schneider-unm-sts-1250-10-500-xdkc",
	"slug": "schneider-unm-sts-1250-10-500-xdkc",
	"brand": "Schneider",
	"model": "UNM STS 1250-10-500 XDKC",
	"mpn": "1121580505",
	"tankLiters": 500,
	"maxPressureBar": 10,
	"fadCurve": [
	...
	"editorial": {
		"overview": "UNM STS 1250-10-500 XDKC, référence 1121580505, associe une cuve de 500 L à un moteur de 7,5 kW. Le débit restitué publié est de 980 L/min à 9 bar. Démarreur étoile-triangle prémonté (version C). Sécheur frigorifique intégré.",
		"verifiedFacts": [
			"Pression publiée : 10 bar ; débit aspiré : 1 250 L/min, distinct du débit restitué.",
			"Poids publié : 328 kg ; dimensions : 1 145 × 850 × 2 020 mm.",
	...
	"evidence": [
		{
			"id": "schneider-2025-1121580505",
			"sourceUrl": "https://www.schneider-airsystems.de/content/dam/brands/schneider/documents/catalogs-brochures/Schneider%20airsystems-Gesamtkatalog-2025-DE-SCREEN.pdf#page=48",
			"sourceLabel": "Schneider airsystems, catalogue 2025, p. 48, réf. 1121580505",
	...
	"notes": [
		...
		"Source : catalogue 2025, page 48, référence 1121580505."
	]
};
