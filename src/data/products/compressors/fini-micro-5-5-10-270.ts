const product = {
	"id": "fini-micro-5-5-10-270",
	"slug": "fini-micro-5-5-10-270",
	"brand": "Fini",
	"model": "MICRO 5.5-10-270",
	"mpn": "V91JO92FNM701",
	"tankLiters": 270,
	"maxPressureBar": 10,
	"fadCurve": [
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/fini-micro-5-5-10-270.webp",
		"alt": "Repères techniques Fini MICRO 5.5-10-270, référence V91JO92FNM701",
	...
	"editorial": {
		"overview": "Fini MICRO 5.5-10-270, référence V91JO92FNM701 : cuve de 270 L, pression maximale publiée de 10 bar. Le point documenté le plus élevé en pression fournit 650 L/min à 10 bar. Version sans sécheur intégré.",
		"verifiedFacts": [
			"Débit restitué publié : 650 L/min à 10 bar.",
			"Vis lubrifiée, vitesse fixe. Puissance moteur publiée : 5,5 kW.",
			"Masse nette publiée : 202 kg."
		],
		"limitations": [
	...
	"evidence": [
		{
			"id": "fini-v91jo92fnm701-20260926",
			"sourceUrl": "https://finicompressors.com/wp-content/uploads/Catalogo-Micro-Plus_Fini_IT_04-2024_9990394.pdf#page=16",
			"sourceLabel": "Fini, catalogue MICRO / PLUS, édition 04-2024, p. 16, réf. V91JO92FNM701",
		...
		{
			"id": "fini-v91jo92fnm701-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"fini-v91jo92fnm701-20260926-lubrification"
		],
		"powerKw": [
			"fini-v91jo92fnm701-20260926"
		],
