const product = {
	...
	"editorial": {
		"overview": "UNM STL 660-10-500 XS, référence 1121580507, associe une cuve de 500 L à un moteur de 4 kW. Le débit restitué publié est de 520 L/min à 9 bar. Version avec réduction du bruit publiée par le fabricant.",
		"verifiedFacts": [
			"Pression publiée : 10 bar ; débit aspiré : 660 L/min, distinct du débit restitué.",
			"Poids publié : 267 kg ; dimensions : 1 950 × 670 × 1 415 mm.",
	...
	"specifications": [
		{
			...
			"value": "1 950 × 670 × 1 415 mm",
			"evidenceIds": [
				"schneider-2025-1121580507"
			]
		},
		{
	...
	"evidence": [
		{
			"id": "schneider-2025-1121580507",
			"sourceUrl": "https://www.schneider-airsystems.de/content/dam/brands/schneider/documents/catalogs-brochures/Schneider%20airsystems-Gesamtkatalog-2025-DE-SCREEN.pdf#page=51",
			"sourceLabel": "Schneider airsystems, catalogue 2025, p. 51, réf. 1121580507",
	...
	"notes": [
		...
		"Source : catalogue 2025, page 51, référence 1121580507."
	]
};
