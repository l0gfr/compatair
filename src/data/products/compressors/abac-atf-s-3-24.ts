const product = {
		...
		evidence: [{ id: 'abac-4116000868-official', sourceUrl: 'https://shop.abacaircompressors.com/en-US/products/4116000868/atf-s-3-24-10-230150-ce', sourceLabel: 'ABAC, catalogue produit officiel', sourceType: 'manufacturer', retrievedAt: '2026-07-13', confidence: 'A', notes: 'FAD annoncé à la pression maximale pour la variante 24 L.' }], notes: [],
	};
