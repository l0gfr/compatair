const product = {
	"id": "lacair-fixair-60-hp",
	"slug": "lacair-fixair-60-hp",
	"brand": "Lacair",
	"model": "Fixair 60 - HP",
	"mpn": "465611",
	"tankLiters": 0,
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/lacair-fixair-60-hp.webp",
		"alt": "Repères techniques Lacair Fixair 60 - HP, référence 465611",
	...
	"editorial": {
		"overview": "Lacair Fixair 60 - HP, référence 465611 : configuration sans cuve intégrée, pression maximale publiée de 14 bar. Le point documenté le plus élevé en pression fournit 885 L/min à 6 bar. Platine sans cuve.",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "lacair-465611-20260926",
			"sourceUrl": "https://s3.eu-west-1.amazonaws.com/s37.lacme.com/crm/Catalogues/LACME%20-%20Catalogue%20Lacair%202026.pdf#page=33",
			"sourceLabel": "Lacair / Lacmé, catalogue 2026, p. 33, réf. 465611",
		...
		{
			"id": "lacair-465611-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"lacair-465611-20260926-lubrification"
		],
		"intakeFlowLpm": [
			"lacair-465611-20260926"
		],
