const product = {
	"id": "fini-plus-16-08-500",
	"slug": "fini-plus-16-08-500",
	"brand": "Fini",
	"model": "PLUS 16-08-500",
	"mpn": "V83NB92FNM701",
	"tankLiters": 500,
	"maxPressureBar": 8,
	"fadCurve": [
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/fini-plus-16-08-500.webp",
		"alt": "Repères techniques Fini PLUS 16-08-500, référence V83NB92FNM701",
	...
	"editorial": {
		"overview": "Fini PLUS 16-08-500, référence V83NB92FNM701 : cuve de 500 L, pression maximale publiée de 8 bar. Le point documenté le plus élevé en pression fournit 2 350 L/min à 8 bar. Version sans sécheur intégré.",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "fini-v83nb92fnm701-20260926",
			"sourceUrl": "https://finicompressors.com/wp-content/uploads/Catalogo-Micro-Plus_Fini_IT_04-2024_9990394.pdf#page=18",
			"sourceLabel": "Fini, catalogue MICRO / PLUS, édition 04-2024, p. 18, réf. V83NB92FNM701",
		...
		{
			"id": "fini-v83nb92fnm701-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"fini-v83nb92fnm701-20260926-lubrification"
		],
		"powerKw": [
			"fini-v83nb92fnm701-20260926"
		],
