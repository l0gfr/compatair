const product = {
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/fini-micro-5-5-08.webp",
		"alt": "Repères techniques Fini MICRO 5.5-08, référence V51JW92FNM760",
	...
	"editorial": {
		"overview": "Fini MICRO 5.5-08, référence V51JW92FNM760 : configuration sans cuve intégrée, pression maximale publiée de 8 bar. Le point documenté le plus élevé en pression fournit 720 L/min à 8 bar. Version sans sécheur intégré.",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "fini-v51jw92fnm760-20260926",
			"sourceUrl": "https://finicompressors.com/wp-content/uploads/Catalogo-Micro-Plus_Fini_IT_04-2024_9990394.pdf#page=16",
			"sourceLabel": "Fini, catalogue MICRO / PLUS, édition 04-2024, p. 16, réf. V51JW92FNM760",
		...
		{
			"id": "fini-v51jw92fnm760-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"fini-v51jw92fnm760-20260926-lubrification"
		],
		"powerKw": [
			"fini-v51jw92fnm760-20260926"
		],
