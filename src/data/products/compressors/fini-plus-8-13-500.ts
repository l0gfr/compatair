const product = {
	"id": "fini-plus-8-13-500",
	"slug": "fini-plus-8-13-500",
	"brand": "Fini",
	"model": "PLUS 8-13-500",
	"mpn": "V83NI92FNM701",
	"tankLiters": 500,
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/fini-plus-8-13-500.webp",
		"alt": "Repères techniques Fini PLUS 8-13-500, référence V83NI92FNM701",
	...
	"editorial": {
		"overview": "Fini PLUS 8-13-500, référence V83NI92FNM701 : cuve de 500 L, pression maximale publiée de 13 bar. Le point documenté le plus élevé en pression fournit 750 L/min à 13 bar. Version sans sécheur intégré.",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "fini-v83ni92fnm701-20260926",
			"sourceUrl": "https://finicompressors.com/wp-content/uploads/Catalogo-Micro-Plus_Fini_IT_04-2024_9990394.pdf#page=17",
			"sourceLabel": "Fini, catalogue MICRO / PLUS, édition 04-2024, p. 17, réf. V83NI92FNM701",
		...
		{
			"id": "fini-v83ni92fnm701-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"fini-v83ni92fnm701-20260926-lubrification"
		],
		"powerKw": [
			"fini-v83ni92fnm701-20260926"
		],
