const product = {
		...
		fieldSources: { fadCurve: ['einhell-4020600-official'], ean: ['einhell-4020600-official'], noiseDb: ['einhell-4020600-official'], maxPressureBar: ['einhell-4020600-official'] }, notes: ['Le niveau sonore publié mesure la pression acoustique au poste d’écoute (LpA).'],
	};
