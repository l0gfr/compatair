const product = {
	"id": "schneider-unm-stb-780-15-10-c",
	"slug": "schneider-unm-stb-780-15-10-c",
	"brand": "Schneider",
	"model": "UNM STB 780-15-10 C",
	"mpn": "1122030310",
	"tankLiters": 10,
	"maxPressureBar": 15,
	"fadCurve": [
	...
	"editorial": {
		"overview": "UNM STB 780-15-10 C, référence 1122030310, associe une cuve de 10 L à un moteur de 5,5 kW. Le débit restitué publié est de 570 L/min à 14 bar. Démarreur étoile-triangle prémonté (version C). Unité d’appoint destinée à étendre un réseau d’air comprimé existant.",
		"verifiedFacts": [
			"Pression publiée : 15 bar ; débit aspiré : 830 L/min, distinct du débit restitué.",
			"Poids publié : 130 kg ; dimensions : 950 × 650 × 720 mm.",
			"Cuve : 10 L ; puissance moteur : 5,5 kW ; rotation : 980 tr/min.",
	...
	"evidence": [
		{
			"id": "schneider-2025-1122030310",
			"sourceUrl": "https://www.schneider-airsystems.de/content/dam/brands/schneider/documents/catalogs-brochures/Schneider%20airsystems-Gesamtkatalog-2025-DE-SCREEN.pdf#page=52",
			"sourceLabel": "Schneider airsystems, catalogue 2025, p. 52, réf. 1122030310",
	...
	"notes": [
		...
		"Source : catalogue 2025, page 52, référence 1122030310."
	]
};
