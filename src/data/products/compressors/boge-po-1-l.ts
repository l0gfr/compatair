const product = {
	...
	brand: 'BOGE',
	model: 'PO 1 L',
	variant: { familyId: 'boge-po-l', label: '10 bar, 70 L/min', distinguishingAttributes: { pression: '10 bar', debitEffectif: '70 L/min', puissance: '0,75 kW' } },
	tankLiters: 0,
	maxPressureBar: 10,
	fadCurve: [{ pressureBar: 8, litersPerMinute: 70 }],
	oilType: 'oil-free',
	powerKw: 0.75,
	weightKg: 58,
	confidence: 'A',
	...
	editorial: {
		overview: 'Le PO 1 L est un groupe compresseur fixe sans réservoir. BOGE publie 70 L/min de débit d’air effectif à 80 % de la pression maximale, soit à 8 bar pour cette version 10 bar.',
		verifiedFacts: ['Le groupe comprime sans huile et développe une puissance moteur de 0,75 kW.', 'Le tableau actuel indique un poids maximal de 58 kg pour le PO 1 L et distingue le débit effectif du débit aspiré.'],
	...
	notes: ['Point de débit restitué : 70 L/min à 8 bar, car BOGE mesure le débit effectif à 80 % des 10 bar maximaux.'],
};
