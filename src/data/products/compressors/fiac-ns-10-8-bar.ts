const product = {
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/fiac-ns-10-8-bar.webp",
		"alt": "Repères techniques FIAC NS 10 8 bar, référence 4152040018",
	...
	"editorial": {
		"overview": "FIAC NS 10 8 bar, référence 4152040018 : configuration sans cuve intégrée, pression maximale publiée de 8 bar. Le point documenté le plus élevé en pression fournit 1 038 L/min à 8 bar. Version sans sécheur intégré.",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "fiac-4152040018-20260926",
			"sourceUrl": "https://web.fiac.it/content/dam/brands/fiac/website/documents/Fiac_Cat%20S226-R1-062026%20-%20screen__compressed.pdf#page=18",
			"sourceLabel": "FIAC, catalogue S226 R1, juin 2026, p. 18, réf. 4152040018",
		...
		{
			"id": "fiac-4152040018-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"fiac-4152040018-20260926-lubrification"
		],
		"powerKw": [
			"fiac-4152040018-20260926"
		],
