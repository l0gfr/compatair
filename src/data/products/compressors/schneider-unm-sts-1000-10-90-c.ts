const product = {
	"id": "schneider-unm-sts-1000-10-90-c",
	"slug": "schneider-unm-sts-1000-10-90-c",
	"brand": "Schneider",
	"model": "UNM STS 1000-10-90 C",
	"mpn": "1121560023",
	"tankLiters": 90,
	"maxPressureBar": 10,
	"fadCurve": [
	...
	"editorial": {
		"overview": "UNM STS 1000-10-90 C, référence 1121560023, associe une cuve de 90 L à un moteur de 5,5 kW. Le débit restitué publié est de 785 L/min à 9 bar. Démarreur étoile-triangle prémonté (version C).",
		"verifiedFacts": [
			"Pression publiée : 10 bar ; débit aspiré : 1 070 L/min, distinct du débit restitué.",
			"Poids publié : 159 kg ; dimensions : 920 × 705 × 1 170 mm.",
			"Cuve : 90 L ; puissance moteur : 5,5 kW ; rotation : 1 260 tr/min.",
	...
	"specifications": [
		{
			...
			"value": "920 × 705 × 1 170 mm",
			"evidenceIds": [
				"schneider-2025-1121560023"
			]
		},
		{
	...
	"evidence": [
		{
			"id": "schneider-2025-1121560023",
			"sourceUrl": "https://www.schneider-airsystems.de/content/dam/brands/schneider/documents/catalogs-brochures/Schneider%20airsystems-Gesamtkatalog-2025-DE-SCREEN.pdf#page=46",
			"sourceLabel": "Schneider airsystems, catalogue 2025, p. 46, réf. 1121560023",
	...
	"notes": [
		...
		"Source : catalogue 2025, page 46, référence 1121560023."
	]
};
