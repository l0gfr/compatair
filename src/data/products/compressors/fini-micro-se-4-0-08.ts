const product = {
	"id": "fini-micro-se-4-0-08",
	"slug": "fini-micro-se-4-0-08",
	"brand": "Fini",
	"model": "MICRO SE 4.0-08",
	"mpn": "V51JR72FNM760",
	"tankLiters": 0,
	"maxPressureBar": 8,
	"fadCurve": [
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/fini-micro-se-4-0-08.webp",
		"alt": "Repères techniques Fini MICRO SE 4.0-08, référence V51JR72FNM760",
	...
	"editorial": {
		"overview": "Fini MICRO SE 4.0-08, référence V51JR72FNM760 : configuration sans cuve intégrée, pression maximale publiée de 8 bar. Le point documenté le plus élevé en pression fournit 580 L/min à 8 bar. Version sans sécheur intégré.",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "fini-v51jr72fnm760-20260926",
			"sourceUrl": "https://finicompressors.com/wp-content/uploads/Catalogo-Micro-Plus_Fini_IT_04-2024_9990394.pdf#page=16",
			"sourceLabel": "Fini, catalogue MICRO / PLUS, édition 04-2024, p. 16, réf. V51JR72FNM760",
		...
		{
			"id": "fini-v51jr72fnm760-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"fini-v51jr72fnm760-20260926-lubrification"
		],
		"powerKw": [
			"fini-v51jr72fnm760-20260926"
		],
