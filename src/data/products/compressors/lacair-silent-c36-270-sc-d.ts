const product = {
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/lacair-silent-c36-270-sc-d.webp",
		"alt": "Repères techniques Lacair Silent C36/270 SC-D, référence 464810",
	...
	"editorial": {
		"overview": "Lacair Silent C36/270 SC-D, référence 464810 : cuve de 270 L, pression maximale publiée de 10 bar. Le point documenté le plus élevé en pression fournit 420 L/min à 7 bar. Sécheur frigorifique intégré (version SC).",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "lacair-464810-20260926",
			"sourceUrl": "https://s3.eu-west-1.amazonaws.com/s37.lacme.com/crm/Catalogues/LACME%20-%20Catalogue%20Lacair%202026.pdf#page=41",
			"sourceLabel": "Lacair / Lacmé, catalogue 2026, p. 41, réf. 464810",
		...
		{
			"id": "lacair-464810-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"lacair-464810-20260926-lubrification"
		],
		"intakeFlowLpm": [
			"lacair-464810-20260926"
		],
