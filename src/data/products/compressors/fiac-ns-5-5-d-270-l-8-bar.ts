const product = {
	"id": "fiac-ns-5-5-d-270-l-8-bar",
	"slug": "fiac-ns-5-5-d-270-l-8-bar",
	"brand": "FIAC",
	"model": "NS 5.5 D 270 L 8 bar",
	"mpn": "4152044206",
	"tankLiters": 270,
	"maxPressureBar": 8,
	"fadCurve": [
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/fiac-ns-5-5-d-270-l-8-bar.webp",
		"alt": "Repères techniques FIAC NS 5.5 D 270 L 8 bar, référence 4152044206",
	...
	"editorial": {
		"overview": "FIAC NS 5.5 D 270 L 8 bar, référence 4152044206 : cuve de 270 L, pression maximale publiée de 8 bar. Le point documenté le plus élevé en pression fournit 594 L/min à 8 bar. Sécheur intégré (version D).",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "fiac-4152044206-20260926",
			"sourceUrl": "https://web.fiac.it/content/dam/brands/fiac/website/documents/Fiac_Cat%20S226-R1-062026%20-%20screen__compressed.pdf#page=20",
			"sourceLabel": "FIAC, catalogue S226 R1, juin 2026, p. 20, réf. 4152044206",
		...
		{
			"id": "fiac-4152044206-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"fiac-4152044206-20260926-lubrification"
		],
		"powerKw": [
			"fiac-4152044206-20260926"
		],
