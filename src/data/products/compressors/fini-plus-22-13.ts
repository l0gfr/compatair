const product = {
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/fini-plus-22-13.webp",
		"alt": "Repères techniques Fini PLUS 22-13, référence V60QF92FNM760",
	...
	"editorial": {
		"overview": "Fini PLUS 22-13, référence V60QF92FNM760 : configuration sans cuve intégrée, pression maximale publiée de 13 bar. Le point documenté le plus élevé en pression fournit 2 400 L/min à 13 bar. Version sans sécheur intégré.",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "fini-v60qf92fnm760-20260926",
			"sourceUrl": "https://finicompressors.com/wp-content/uploads/Catalogo-Micro-Plus_Fini_IT_04-2024_9990394.pdf#page=18",
			"sourceLabel": "Fini, catalogue MICRO / PLUS, édition 04-2024, p. 18, réf. V60QF92FNM760",
		...
		{
			"id": "fini-v60qf92fnm760-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"fini-v60qf92fnm760-20260926-lubrification"
		],
		"powerKw": [
			"fini-v60qf92fnm760-20260926"
		],
