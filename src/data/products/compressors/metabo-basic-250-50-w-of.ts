const product = {
	...
	fieldSources: { fadCurve: ['metabo-601535000-official'], intakeFlowLpm: ['metabo-601535000-official'], oilType: ['metabo-601535000-official'], weightKg: ['metabo-601535000-official'], maxPressureBar: ['metabo-601535000-official'] }, notes: ['Point effectif unique à 6,4 bar.'],
};
