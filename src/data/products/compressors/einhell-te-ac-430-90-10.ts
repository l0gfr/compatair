const product = {
		...
		evidence: [{ id: 'einhell-4010800-official', sourceUrl: 'https://www.einhell.fr/p/4010800-te-ac-430-90-10/', sourceLabel: 'Einhell France, fiche produit officielle', sourceType: 'manufacturer', retrievedAt: '2026-07-13', confidence: 'A' }],
		fieldSources: { mpn: ['einhell-4010800-official'], ean: ['einhell-4010800-official'], tankLiters: ['einhell-4010800-official'], maxPressureBar: ['einhell-4010800-official'], fadCurve: ['einhell-4010800-official'], intakeFlowLpm: ['einhell-4010800-official'], dutyCycle: ['einhell-4010800-official'], oilType: ['einhell-4010800-official'], noiseDb: ['einhell-4010800-official'] }, notes: [],
	};
