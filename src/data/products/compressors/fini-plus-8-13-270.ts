const product = {
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/fini-plus-8-13-270.webp",
		"alt": "Repères techniques Fini PLUS 8-13-270, référence V91NI92FNM701",
	...
	"editorial": {
		"overview": "Fini PLUS 8-13-270, référence V91NI92FNM701 : cuve de 270 L, pression maximale publiée de 13 bar. Le point documenté le plus élevé en pression fournit 750 L/min à 13 bar. Version sans sécheur intégré.",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "fini-v91ni92fnm701-20260926",
			"sourceUrl": "https://finicompressors.com/wp-content/uploads/Catalogo-Micro-Plus_Fini_IT_04-2024_9990394.pdf#page=17",
			"sourceLabel": "Fini, catalogue MICRO / PLUS, édition 04-2024, p. 17, réf. V91NI92FNM701",
		...
		{
			"id": "fini-v91ni92fnm701-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"fini-v91ni92fnm701-20260926-lubrification"
		],
		"powerKw": [
			"fini-v91ni92fnm701-20260926"
		],
