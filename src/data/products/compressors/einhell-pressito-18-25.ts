const product = {
	...
	image: { src: '/images/products/einhell-pressito-18-25.webp', alt: 'Compresseur sans fil Einhell PRESSITO 18/25', sourceUrl: 'https://www.einhell.fr/p/4020420-pressito-18-25/', sourceLabel: 'Visuel officiel Einhell' },
	...
	fieldSources: { fadCurve: ['einhell-4020420-official'], intakeFlowLpm: ['einhell-4020420-official'], ean: ['einhell-4020420-official'], weightKg: ['einhell-4020420-official'], maxPressureBar: ['einhell-4020420-official'] }, notes: ['Profil multipoint constructeur.'],
};
