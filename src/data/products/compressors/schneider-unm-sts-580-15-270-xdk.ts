const product = {
	"id": "schneider-unm-sts-580-15-270-xdk",
	"slug": "schneider-unm-sts-580-15-270-xdk",
	"brand": "Schneider",
	"model": "UNM STS 580-15-270 XDK",
	"mpn": "1121570239",
	"tankLiters": 270,
	"maxPressureBar": 15,
	"fadCurve": [
	...
	"editorial": {
		"overview": "UNM STS 580-15-270 XDK, référence 1121570239, associe une cuve de 270 L à un moteur de 4 kW. Le débit restitué publié est de 470 L/min à 14 bar. Sécheur frigorifique intégré.",
		"verifiedFacts": [
			"Pression publiée : 15 bar ; débit aspiré : 580 L/min, distinct du débit restitué.",
			"Poids publié : 213 kg ; dimensions : 945 × 705 × 1 800 mm.",
	...
	"evidence": [
		{
			"id": "schneider-2025-1121570239",
			"sourceUrl": "https://www.schneider-airsystems.de/content/dam/brands/schneider/documents/catalogs-brochures/Schneider%20airsystems-Gesamtkatalog-2025-DE-SCREEN.pdf#page=48",
			"sourceLabel": "Schneider airsystems, catalogue 2025, p. 48, réf. 1121570239",
	...
	"notes": [
		...
		"Source : catalogue 2025, page 48, référence 1121570239."
	]
};
