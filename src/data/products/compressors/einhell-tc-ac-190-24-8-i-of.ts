const product = {
		...
		fieldSources: { fadCurve: ['einhell-4007375-official'], ean: ['einhell-4007375-official'], dutyCycle: ['einhell-4007375-official'], maxPressureBar: ['einhell-4007375-official'] }, notes: ['Fonctionnement intermittent annoncé à 50 % (code S3 du fabricant).'],
	};
