const product = {
	"id": "fini-micro-se-2-2-08-m",
	"slug": "fini-micro-se-2-2-08-m",
	"brand": "Fini",
	"model": "MICRO SE 2.2-08 M",
	"mpn": "V51JU60FNM560",
	"tankLiters": 0,
	"maxPressureBar": 8,
	"fadCurve": [
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/fini-micro-se-2-2-08-m.webp",
		"alt": "Repères techniques Fini MICRO SE 2.2-08 M, référence V51JU60FNM560",
	...
	"editorial": {
		"overview": "Fini MICRO SE 2.2-08 M, référence V51JU60FNM560 : configuration sans cuve intégrée, pression maximale publiée de 8 bar. Le point documenté le plus élevé en pression fournit 300 L/min à 8 bar. Version sans sécheur intégré.",
		"verifiedFacts": [
			"Débit restitué publié : 300 L/min à 8 bar.",
			"Vis lubrifiée, vitesse fixe. Puissance moteur publiée : 2,2 kW.",
			"Masse nette publiée : 98 kg."
		],
		"limitations": [
	...
	"evidence": [
		{
			"id": "fini-v51ju60fnm560-20260926",
			"sourceUrl": "https://finicompressors.com/wp-content/uploads/Catalogo-Micro-Plus_Fini_IT_04-2024_9990394.pdf#page=16",
			"sourceLabel": "Fini, catalogue MICRO / PLUS, édition 04-2024, p. 16, réf. V51JU60FNM560",
		...
		{
			"id": "fini-v51ju60fnm560-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"fini-v51ju60fnm560-20260926-lubrification"
		],
		"powerKw": [
			"fini-v51ju60fnm560-20260926"
		],
