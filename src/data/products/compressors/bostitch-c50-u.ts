const product = {
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/bostitch-c50-u.webp",
		"alt": "Repères techniques Bostitch C50-U, référence C50-U",
		"sourceUrl": "https://v3.pdf.bostitch.eu/literature/Construction_Catalogue_A4_UK.pdf#page=27",
		"sourceLabel": "Carte technique CompatAir, valeurs déclarées par le fabricant ; pas une photographie du produit"
	},
	"editorial": {
		"overview": "Bostitch C50-U, référence C50-U : cuve de 50 L, pression maximale publiée de 10 bar. Le point documenté le plus élevé en pression fournit 108 L/min à 7 bar.",
		"verifiedFacts": [
			"Débit restitué publié : 108 L/min à 7 bar.",
			"Compresseur de chantier.",
			"Débit aspiré : 233 L/min, distinct du débit restitué.",
			"Masse nette publiée : 36 kg.",
	...
	"specifications": [
		{
			...
			"evidenceIds": [
				"bostitch-c50-u-20260926"
			]
		}
	],
	"evidence": [
		{
			"id": "bostitch-c50-u-20260926",
			"sourceUrl": "https://v3.pdf.bostitch.eu/literature/Construction_Catalogue_A4_UK.pdf#page=27",
			"sourceLabel": "Bostitch, catalogue officiel construction UK, p. 27, réf. C50-U",
