const product = {
	...
	image: { src: '/images/products/metabo-mega-350-50-w.png', alt: 'Compresseur Metabo Mega 350-50 W', sourceUrl: 'https://www.metabo.com/com/en/tools/compressed-air/compressors/mobile-workshop-compressors/mega-350-50-w-compressor/601589000', sourceLabel: 'Visuel officiel Metabo' },
	...
	fieldSources: { fadCurve: ['metabo-601589000-official'], intakeFlowLpm: ['metabo-601589000-official'], oilType: ['metabo-601589000-official'], powerKw: ['metabo-601589000-official'] }, notes: ['Point effectif unique à 8 bar.'],
};
