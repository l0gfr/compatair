const product = {
	"id": "schneider-unm-sts-580-15-500-xsdk",
	"slug": "schneider-unm-sts-580-15-500-xsdk",
	"brand": "Schneider",
	"model": "UNM STS 580-15-500 XSDK",
	"mpn": "1121580502",
	"tankLiters": 500,
	"maxPressureBar": 15,
	"fadCurve": [
	...
	"editorial": {
		"overview": "UNM STS 580-15-500 XSDK, référence 1121580502, associe une cuve de 500 L à un moteur de 4 kW. Le débit restitué publié est de 470 L/min à 14 bar. Sécheur frigorifique intégré. Version avec réduction du bruit publiée par le fabricant.",
		"verifiedFacts": [
			"Pression publiée : 15 bar ; débit aspiré : 580 L/min, distinct du débit restitué.",
			"Poids publié : 305 kg ; dimensions : 1 070 × 850 × 2 055 mm.",
	...
	"evidence": [
		{
			"id": "schneider-2025-1121580502",
			"sourceUrl": "https://www.schneider-airsystems.de/content/dam/brands/schneider/documents/catalogs-brochures/Schneider%20airsystems-Gesamtkatalog-2025-DE-SCREEN.pdf#page=49",
			"sourceLabel": "Schneider airsystems, catalogue 2025, p. 49, réf. 1121580502",
	...
	"notes": [
		...
		"Source : catalogue 2025, page 49, référence 1121580502."
	]
};
