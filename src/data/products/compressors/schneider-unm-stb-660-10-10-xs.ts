const product = {
	"id": "schneider-unm-stb-660-10-10-xs",
	"slug": "schneider-unm-stb-660-10-10-xs",
	"brand": "Schneider",
	"model": "UNM STB 660-10-10 XS",
	"mpn": "1122030301",
	"tankLiters": 10,
	"maxPressureBar": 10,
	"fadCurve": [
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/schneider-catalogue-2025-p52-1.webp",
	...
	"editorial": {
		"overview": "UNM STB 660-10-10 XS, référence 1122030301, associe une cuve de 10 L à un moteur de 4 kW. Le débit restitué publié est de 520 L/min à 9 bar. Version avec réduction du bruit publiée par le fabricant. Unité d’appoint destinée à étendre un réseau d’air comprimé existant.",
		"verifiedFacts": [
			"Pression publiée : 10 bar ; débit aspiré : 660 L/min, distinct du débit restitué.",
			"Poids publié : 133 kg ; dimensions : 920 × 700 × 820 mm.",
	...
	"specifications": [
		{
			...
			"value": "920 × 700 × 820 mm",
			"evidenceIds": [
				"schneider-2025-1122030301"
			]
		},
		{
	...
	"evidence": [
		{
			"id": "schneider-2025-1122030301",
			"sourceUrl": "https://www.schneider-airsystems.de/content/dam/brands/schneider/documents/catalogs-brochures/Schneider%20airsystems-Gesamtkatalog-2025-DE-SCREEN.pdf#page=52",
			"sourceLabel": "Schneider airsystems, catalogue 2025, p. 52, réf. 1122030301",
	...
	"notes": [
		...
		"Source : catalogue 2025, page 52, référence 1122030301."
	]
};
