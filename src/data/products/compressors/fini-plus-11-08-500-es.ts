const product = {
	"id": "fini-plus-11-08-500-es",
	"slug": "fini-plus-11-08-500-es",
	"brand": "Fini",
	"model": "PLUS 11-08-500 ES",
	"mpn": "V83NL92FNM801",
	"tankLiters": 500,
	"maxPressureBar": 8,
	"fadCurve": [
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/fini-plus-11-08-500-es.webp",
		"alt": "Repères techniques Fini PLUS 11-08-500 ES, référence V83NL92FNM801",
	...
	"editorial": {
		"overview": "Fini PLUS 11-08-500 ES, référence V83NL92FNM801 : cuve de 500 L, pression maximale publiée de 8 bar. Le point documenté le plus élevé en pression fournit 1 650 L/min à 8 bar. Sécheur intégré (version ES).",
		"verifiedFacts": [
			"Débit restitué publié : 1 650 L/min à 8 bar.",
			"Vis lubrifiée, vitesse fixe. Puissance moteur publiée : 11 kW.",
			"Masse nette publiée : 380 kg."
		],
		"limitations": [
	...
	"evidence": [
		{
			"id": "fini-v83nl92fnm801-20260926",
			"sourceUrl": "https://finicompressors.com/wp-content/uploads/Catalogo-Micro-Plus_Fini_IT_04-2024_9990394.pdf#page=17",
			"sourceLabel": "Fini, catalogue MICRO / PLUS, édition 04-2024, p. 17, réf. V83NL92FNM801",
		...
		{
			"id": "fini-v83nl92fnm801-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"fini-v83nl92fnm801-20260926-lubrification"
		],
		"powerKw": [
			"fini-v83nl92fnm801-20260926"
		],
