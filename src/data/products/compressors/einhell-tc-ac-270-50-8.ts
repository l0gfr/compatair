const product = {
		...
		fieldSources: { fadCurve: ['einhell-4007360-official'], ean: ['einhell-4007360-official'], noiseDb: ['einhell-4007360-official'], maxPressureBar: ['einhell-4007360-official'] }, notes: ['Le niveau sonore publié mesure la pression acoustique au poste d’écoute (LpA).'],
	};
