const product = {
	"id": "lacair-twinair-28-100-t",
	"slug": "lacair-twinair-28-100-t",
	"brand": "Lacair",
	"model": "TwinAir 28/100 T",
	"mpn": "463300",
	"tankLiters": 100,
	"maxPressureBar": 11,
	"fadCurve": [
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/lacair-twinair-28-100-t.webp",
		"alt": "Repères techniques Lacair TwinAir 28/100 T, référence 463300",
	...
	"editorial": {
		"overview": "Lacair TwinAir 28/100 T, référence 463300 : cuve de 100 L, pression maximale publiée de 11 bar. Le point documenté le plus élevé en pression fournit 330 L/min à 6 bar.",
		"verifiedFacts": [
			"Débit restitué publié : 330 L/min à 6 bar.",
			"Pistons lubrifiés. Puissance moteur publiée : 3 kW.",
			"Débit aspiré : 465 L/min, distinct du débit restitué.",
	...
	"evidence": [
		{
			"id": "lacair-463300-20260926",
			"sourceUrl": "https://s3.eu-west-1.amazonaws.com/s37.lacme.com/crm/Catalogues/LACME%20-%20Catalogue%20Lacair%202026.pdf#page=26",
			"sourceLabel": "Lacair / Lacmé, catalogue 2026, p. 26, réf. 463300",
		...
		{
			"id": "lacair-463300-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"lacair-463300-20260926-lubrification"
		],
		"intakeFlowLpm": [
			"lacair-463300-20260926"
		],
