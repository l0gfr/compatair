const product = {
		...
		evidence: [{ id: 'einhell-2024-catalog-270', sourceUrl: 'https://www.einhell.fr/fileadmin/corporate-media/services/catalogues/pdf-en/einhell-services-catalogue-power-tools-2024-en.pdf', sourceLabel: 'Catalogue officiel Einhell 2024', sourceType: 'manufacturer', retrievedAt: '2026-07-13', confidence: 'B' }], notes: [],
	};
