const product = {
	"id": "schneider-unm-sts-660-10-500",
	"slug": "schneider-unm-sts-660-10-500",
	"brand": "Schneider",
	"model": "UNM STS 660-10-500",
	"mpn": "1121580534",
	"tankLiters": 500,
	"maxPressureBar": 10,
	"fadCurve": [
	...
	"editorial": {
		"overview": "UNM STS 660-10-500, référence 1121580534, associe une cuve de 500 L à un moteur de 4 kW. Le débit restitué publié est de 520 L/min à 9 bar.",
		"verifiedFacts": [
			"Pression publiée : 10 bar ; débit aspiré : 660 L/min, distinct du débit restitué.",
			"Poids publié : 215 kg ; dimensions : 850 × 850 × 1 945 mm.",
	...
	"evidence": [
		{
			"id": "schneider-2025-1121580534",
			"sourceUrl": "https://www.schneider-airsystems.de/content/dam/brands/schneider/documents/catalogs-brochures/Schneider%20airsystems-Gesamtkatalog-2025-DE-SCREEN.pdf#page=46",
			"sourceLabel": "Schneider airsystems, catalogue 2025, p. 46, réf. 1121580534",
	...
	"notes": [
		...
		"Source : catalogue 2025, page 46, référence 1121580534."
	]
};
