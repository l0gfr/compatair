const product = {
	"id": "schneider-unm-stl-580-15-270-xs",
	"slug": "schneider-unm-stl-580-15-270-xs",
	"brand": "Schneider",
	"model": "UNM STL 580-15-270 XS",
	"mpn": "1121570209",
	"tankLiters": 270,
	"maxPressureBar": 15,
	"fadCurve": [
	...
	"editorial": {
		"overview": "UNM STL 580-15-270 XS, référence 1121570209, associe une cuve de 270 L à un moteur de 4 kW. Le débit restitué publié est de 470 L/min à 14 bar. Version avec réduction du bruit publiée par le fabricant.",
		"verifiedFacts": [
			"Pression publiée : 15 bar ; débit aspiré : 580 L/min, distinct du débit restitué.",
			"Poids publié : 227 kg ; dimensions : 1 620 × 600 × 1 315 mm.",
	...
	"evidence": [
		{
			"id": "schneider-2025-1121570209",
			"sourceUrl": "https://www.schneider-airsystems.de/content/dam/brands/schneider/documents/catalogs-brochures/Schneider%20airsystems-Gesamtkatalog-2025-DE-SCREEN.pdf#page=51",
			"sourceLabel": "Schneider airsystems, catalogue 2025, p. 51, réf. 1121570209",
	...
	"notes": [
		...
		"Source : catalogue 2025, page 51, référence 1121570209."
	]
};
