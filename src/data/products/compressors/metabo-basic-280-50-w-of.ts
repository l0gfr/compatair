const product = {
	...
	image: { src: '/images/products/metabo-basic-280-50-w-of.png', alt: 'Compresseur Metabo Basic 280-50 W OF', sourceUrl: 'https://www.metabo.com/com/en/products/tools/compressed-air/compressors/mobile-workshop-compressors/basic-280-50-w-of-compressor/601529000', sourceLabel: 'Visuel officiel Metabo' },
	...
	fieldSources: { fadCurve: ['metabo-601529000-official'], intakeFlowLpm: ['metabo-601529000-official'], oilType: ['metabo-601529000-official'], powerKw: ['metabo-601529000-official'] }, notes: ['Point effectif unique à 6,4 bar.'],
};
