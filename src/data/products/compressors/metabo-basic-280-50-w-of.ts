const product = {
	...
	image: { src: '/images/products/metabo-basic-280-50-w-of.webp', alt: 'Compresseur Metabo Basic 280-50 W OF', sourceUrl: 'https://www.metabo.com/sk/sk/stroje/stlaceny-vzduch/kompresory/mobilne-kompresory/basic-280-50-w-of-601529000-kompresor.html', sourceLabel: 'Visuel officiel Metabo' },
	...
	evidence: [{ id: 'metabo-601529000-official', sourceUrl: 'https://www.metabo.com/sk/sk/stroje/stlaceny-vzduch/kompresory/mobilne-kompresory/basic-280-50-w-of-601529000-kompresor.html', sourceLabel: 'Metabo, fiche officielle Basic 280-50 W OF', sourceType: 'manufacturer', retrievedAt: '2026-09-25', confidence: 'A', notes: 'Débit effectif publié à 80 % de la pression maximale.' }],
