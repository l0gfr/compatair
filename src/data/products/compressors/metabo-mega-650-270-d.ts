const product = {
	...
	image: { src: '/images/products/metabo-mega-650-270-d.png', alt: 'Compresseur Metabo Mega 650-270 D', sourceUrl: 'https://www.metabo.com/com/en/tools/compressed-air/compressors/mobile-workshop-compressors/mega-650-270-d-compressor/601543000', sourceLabel: 'Visuel officiel Metabo' },
	...
	fieldSources: { fadCurve: ['metabo-601543000-official'], intakeFlowLpm: ['metabo-601543000-official'], powerKw: ['metabo-601543000-official'], weightKg: ['metabo-601543000-official'] }, notes: ['Point effectif unique à 8,8 bar.'],
};
