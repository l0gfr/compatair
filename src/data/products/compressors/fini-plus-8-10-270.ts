const product = {
	"id": "fini-plus-8-10-270",
	"slug": "fini-plus-8-10-270",
	"brand": "Fini",
	"model": "PLUS 8-10-270",
	"mpn": "V91NH92FNM701",
	"tankLiters": 270,
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/fini-plus-8-10-270.webp",
		"alt": "Repères techniques Fini PLUS 8-10-270, référence V91NH92FNM701",
	...
	"editorial": {
		"overview": "Fini PLUS 8-10-270, référence V91NH92FNM701 : cuve de 270 L, pression maximale publiée de 10 bar. Le point documenté le plus élevé en pression fournit 1 000 L/min à 10 bar. Version sans sécheur intégré.",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "fini-v91nh92fnm701-20260926",
			"sourceUrl": "https://finicompressors.com/wp-content/uploads/Catalogo-Micro-Plus_Fini_IT_04-2024_9990394.pdf#page=17",
			"sourceLabel": "Fini, catalogue MICRO / PLUS, édition 04-2024, p. 17, réf. V91NH92FNM701",
		...
		{
			"id": "fini-v91nh92fnm701-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"fini-v91nh92fnm701-20260926-lubrification"
		],
		"powerKw": [
			"fini-v91nh92fnm701-20260926"
		],
