const product = {
	"id": "fini-plus-15-10-500",
	"slug": "fini-plus-15-10-500",
	"brand": "Fini",
	"model": "PLUS 15-10-500",
	"mpn": "V83NQ92FNM701",
	"tankLiters": 500,
	"maxPressureBar": 10,
	"fadCurve": [
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/fini-plus-15-10-500.webp",
		"alt": "Repères techniques Fini PLUS 15-10-500, référence V83NQ92FNM701",
	...
	"editorial": {
		"overview": "Fini PLUS 15-10-500, référence V83NQ92FNM701 : cuve de 500 L, pression maximale publiée de 10 bar. Le point documenté le plus élevé en pression fournit 1 850 L/min à 10 bar. Version sans sécheur intégré.",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "fini-v83nq92fnm701-20260926",
			"sourceUrl": "https://finicompressors.com/wp-content/uploads/Catalogo-Micro-Plus_Fini_IT_04-2024_9990394.pdf#page=18",
			"sourceLabel": "Fini, catalogue MICRO / PLUS, édition 04-2024, p. 18, réf. V83NQ92FNM701",
		...
		{
			"id": "fini-v83nq92fnm701-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"fini-v83nq92fnm701-20260926-lubrification"
		],
		"powerKw": [
			"fini-v83nq92fnm701-20260926"
		],
