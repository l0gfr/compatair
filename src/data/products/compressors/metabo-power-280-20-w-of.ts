const product = {
	...
	image: { src: '/images/products/metabo-power-280-20-w-of.webp', alt: 'Compresseur Metabo Power 280-20 W OF', sourceUrl: 'https://www.metabo.com/no/no/maskiner/trykkluft/kompressorer/kompressorer-for-byggeplassen/power-280-20-w-of-kompressor/601545000', sourceLabel: 'Visuel officiel Metabo' },
	...
	fieldSources: { fadCurve: ['metabo-601545000-official'], ean: ['metabo-601545000-official'], noiseDb: ['metabo-601545000-official'], weightKg: ['metabo-601545000-official'], maxPressureBar: ['metabo-601545000-official'] }, notes: ['Point effectif unique à 8 bar.'],
};
