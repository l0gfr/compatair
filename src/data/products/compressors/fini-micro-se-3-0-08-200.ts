const product = {
	"id": "fini-micro-se-3-0-08-200",
	"slug": "fini-micro-se-3-0-08-200",
	"brand": "Fini",
	"model": "MICRO SE 3.0-08-200",
	"mpn": "V77JS72FNM701",
	"tankLiters": 200,
	"maxPressureBar": 8,
	"fadCurve": [
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/fini-micro-se-3-0-08-200.webp",
		"alt": "Repères techniques Fini MICRO SE 3.0-08-200, référence V77JS72FNM701",
	...
	"editorial": {
		"overview": "Fini MICRO SE 3.0-08-200, référence V77JS72FNM701 : cuve de 200 L, pression maximale publiée de 8 bar. Le point documenté le plus élevé en pression fournit 430 L/min à 8 bar. Version sans sécheur intégré.",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "fini-v77js72fnm701-20260926",
			"sourceUrl": "https://finicompressors.com/wp-content/uploads/Catalogo-Micro-Plus_Fini_IT_04-2024_9990394.pdf#page=16",
			"sourceLabel": "Fini, catalogue MICRO / PLUS, édition 04-2024, p. 16, réf. V77JS72FNM701",
		...
		{
			"id": "fini-v77js72fnm701-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"fini-v77js72fnm701-20260926-lubrification"
		],
		"powerKw": [
			"fini-v77js72fnm701-20260926"
		],
