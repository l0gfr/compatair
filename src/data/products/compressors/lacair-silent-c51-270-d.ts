const product = {
	"id": "lacair-silent-c51-270-d",
	"slug": "lacair-silent-c51-270-d",
	"brand": "Lacair",
	"model": "Silent C51/270 D",
	"mpn": "464859",
	"tankLiters": 270,
	"maxPressureBar": 10,
	"fadCurve": [
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/lacair-silent-c51-270-d.webp",
		"alt": "Repères techniques Lacair Silent C51/270 D, référence 464859",
	...
	"editorial": {
		"overview": "Lacair Silent C51/270 D, référence 464859 : cuve de 270 L, pression maximale publiée de 10 bar. Le point documenté le plus élevé en pression fournit 718 L/min à 7 bar.",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "lacair-464859-20260926",
			"sourceUrl": "https://s3.eu-west-1.amazonaws.com/s37.lacme.com/crm/Catalogues/LACME%20-%20Catalogue%20Lacair%202026.pdf#page=40",
			"sourceLabel": "Lacair / Lacmé, catalogue 2026, p. 40, réf. 464859",
		...
		{
			"id": "lacair-464859-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"lacair-464859-20260926-lubrification"
		],
		"intakeFlowLpm": [
			"lacair-464859-20260926"
		],
