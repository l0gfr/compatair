const product = {
	"id": "lacair-silent-c51-270-sc-et",
	"slug": "lacair-silent-c51-270-sc-et",
	"brand": "Lacair",
	"model": "Silent C51/270 SC-ET",
	"mpn": "464877",
	"tankLiters": 270,
	"maxPressureBar": 10,
	"fadCurve": [
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/lacair-silent-c51-270-sc-et.webp",
		"alt": "Repères techniques Lacair Silent C51/270 SC-ET, référence 464877",
	...
	"editorial": {
		"overview": "Lacair Silent C51/270 SC-ET, référence 464877 : cuve de 270 L, pression maximale publiée de 10 bar. Le point documenté le plus élevé en pression fournit 718 L/min à 7 bar. Sécheur frigorifique intégré (version SC).",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "lacair-464877-20260926",
			"sourceUrl": "https://s3.eu-west-1.amazonaws.com/s37.lacme.com/crm/Catalogues/LACME%20-%20Catalogue%20Lacair%202026.pdf#page=41",
			"sourceLabel": "Lacair / Lacmé, catalogue 2026, p. 41, réf. 464877",
		...
		{
			"id": "lacair-464877-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"lacair-464877-20260926-lubrification"
		],
		"intakeFlowLpm": [
			"lacair-464877-20260926"
		],
