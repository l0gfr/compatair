const product = {
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/fini-plus-22-10.webp",
		"alt": "Repères techniques Fini PLUS 22-10, référence V60QE92FNM760",
	...
	"editorial": {
		"overview": "Fini PLUS 22-10, référence V60QE92FNM760 : configuration sans cuve intégrée, pression maximale publiée de 10 bar. Le point documenté le plus élevé en pression fournit 3 000 L/min à 10 bar. Version sans sécheur intégré.",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "fini-v60qe92fnm760-20260926",
			"sourceUrl": "https://finicompressors.com/wp-content/uploads/Catalogo-Micro-Plus_Fini_IT_04-2024_9990394.pdf#page=18",
			"sourceLabel": "Fini, catalogue MICRO / PLUS, édition 04-2024, p. 18, réf. V60QE92FNM760",
		...
		{
			"id": "fini-v60qe92fnm760-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"fini-v60qe92fnm760-20260926-lubrification"
		],
		"powerKw": [
			"fini-v60qe92fnm760-20260926"
		],
