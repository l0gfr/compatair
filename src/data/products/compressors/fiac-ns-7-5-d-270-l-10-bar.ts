const product = {
	"id": "fiac-ns-7-5-d-270-l-10-bar",
	"slug": "fiac-ns-7-5-d-270-l-10-bar",
	"brand": "FIAC",
	"model": "NS 7.5 D 270 L 10 bar",
	"mpn": "4152044221",
	"tankLiters": 270,
	"maxPressureBar": 10,
	"fadCurve": [
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/fiac-ns-7-5-d-270-l-10-bar.webp",
		"alt": "Repères techniques FIAC NS 7.5 D 270 L 10 bar, référence 4152044221",
	...
	"editorial": {
		"overview": "FIAC NS 7.5 D 270 L 10 bar, référence 4152044221 : cuve de 270 L, pression maximale publiée de 10 bar. Le point documenté le plus élevé en pression fournit 770 L/min à 10 bar. Sécheur intégré (version D).",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "fiac-4152044221-20260926",
			"sourceUrl": "https://web.fiac.it/content/dam/brands/fiac/website/documents/Fiac_Cat%20S226-R1-062026%20-%20screen__compressed.pdf#page=20",
			"sourceLabel": "FIAC, catalogue S226 R1, juin 2026, p. 20, réf. 4152044221",
		...
		{
			"id": "fiac-4152044221-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"fiac-4152044221-20260926-lubrification"
		],
		"powerKw": [
			"fiac-4152044221-20260926"
		],
