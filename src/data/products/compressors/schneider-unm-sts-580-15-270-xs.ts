const product = {
	"id": "schneider-unm-sts-580-15-270-xs",
	"slug": "schneider-unm-sts-580-15-270-xs",
	"brand": "Schneider",
	"model": "UNM STS 580-15-270 XS",
	"mpn": "1121570240",
	"tankLiters": 270,
	"maxPressureBar": 15,
	"fadCurve": [
	...
	"editorial": {
		"overview": "UNM STS 580-15-270 XS, référence 1121570240, associe une cuve de 270 L à un moteur de 4 kW. Le débit restitué publié est de 470 L/min à 14 bar. Version avec réduction du bruit publiée par le fabricant.",
		"verifiedFacts": [
			"Pression publiée : 15 bar ; débit aspiré : 580 L/min, distinct du débit restitué.",
			"Poids publié : 216 kg ; dimensions : 775 × 740 × 1 905 mm.",
	...
	"specifications": [
		{
			...
			"value": "775 × 740 × 1 905 mm",
			"evidenceIds": [
				"schneider-2025-1121570240"
			]
		},
		{
	...
	"evidence": [
		{
			"id": "schneider-2025-1121570240",
			"sourceUrl": "https://www.schneider-airsystems.de/content/dam/brands/schneider/documents/catalogs-brochures/Schneider%20airsystems-Gesamtkatalog-2025-DE-SCREEN.pdf#page=47",
			"sourceLabel": "Schneider airsystems, catalogue 2025, p. 47, réf. 1121570240",
	...
	"notes": [
		...
		"Source : catalogue 2025, page 47, référence 1121570240."
	]
};
