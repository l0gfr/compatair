const product = {
	...
	"editorial": {
		"overview": "UNM STS 780-15-500 C, référence 1121580540, associe une cuve de 500 L à un moteur de 5,5 kW. Le débit restitué publié est de 570 L/min à 14 bar. Démarreur étoile-triangle prémonté (version C).",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "schneider-2025-1121580540",
			"sourceUrl": "https://www.schneider-airsystems.de/content/dam/brands/schneider/documents/catalogs-brochures/Schneider%20airsystems-Gesamtkatalog-2025-DE-SCREEN.pdf#page=46",
			"sourceLabel": "Schneider airsystems, catalogue 2025, p. 46, réf. 1121580540",
	...
	"notes": [
		...
		"Source : catalogue 2025, page 46, référence 1121580540."
	]
};
