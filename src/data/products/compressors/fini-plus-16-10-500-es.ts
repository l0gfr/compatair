const product = {
	"id": "fini-plus-16-10-500-es",
	"slug": "fini-plus-16-10-500-es",
	"brand": "Fini",
	"model": "PLUS 16-10-500 ES",
	"mpn": "V83NY92FNM801",
	"tankLiters": 500,
	"maxPressureBar": 10,
	"fadCurve": [
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/fini-plus-16-10-500-es.webp",
		"alt": "Repères techniques Fini PLUS 16-10-500 ES, référence V83NY92FNM801",
	...
	"editorial": {
		"overview": "Fini PLUS 16-10-500 ES, référence V83NY92FNM801 : cuve de 500 L, pression maximale publiée de 10 bar. Le point documenté le plus élevé en pression fournit 2 050 L/min à 10 bar. Sécheur intégré (version ES).",
		"verifiedFacts": [
			"Débit restitué publié : 2 050 L/min à 10 bar.",
	...
	"evidence": [
		{
			"id": "fini-v83ny92fnm801-20260926",
			"sourceUrl": "https://finicompressors.com/wp-content/uploads/Catalogo-Micro-Plus_Fini_IT_04-2024_9990394.pdf#page=18",
			"sourceLabel": "Fini, catalogue MICRO / PLUS, édition 04-2024, p. 18, réf. V83NY92FNM801",
		...
		{
			"id": "fini-v83ny92fnm801-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"fini-v83ny92fnm801-20260926-lubrification"
		],
		"powerKw": [
			"fini-v83ny92fnm801-20260926"
		],
