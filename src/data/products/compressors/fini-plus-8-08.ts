const product = {
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/fini-plus-8-08.webp",
		"alt": "Repères techniques Fini PLUS 8-08, référence V60NG92FNM760",
	...
	"editorial": {
		"overview": "Fini PLUS 8-08, référence V60NG92FNM760 : configuration sans cuve intégrée, pression maximale publiée de 8 bar. Le point documenté le plus élevé en pression fournit 1 250 L/min à 8 bar. Version sans sécheur intégré.",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "fini-v60ng92fnm760-20260926",
			"sourceUrl": "https://finicompressors.com/wp-content/uploads/Catalogo-Micro-Plus_Fini_IT_04-2024_9990394.pdf#page=17",
			"sourceLabel": "Fini, catalogue MICRO / PLUS, édition 04-2024, p. 17, réf. V60NG92FNM760",
		...
		{
			"id": "fini-v60ng92fnm760-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"fini-v60ng92fnm760-20260926-lubrification"
		],
		"powerKw": [
			"fini-v60ng92fnm760-20260926"
		],
