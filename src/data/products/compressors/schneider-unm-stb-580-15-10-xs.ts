const product = {
	...
	"editorial": {
		"overview": "UNM STB 580-15-10 XS, référence 1122030302, associe une cuve de 10 L à un moteur de 4 kW. Le débit restitué publié est de 470 L/min à 14 bar. Version avec réduction du bruit publiée par le fabricant. Unité d’appoint destinée à étendre un réseau d’air comprimé existant.",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "schneider-2025-1122030302",
			"sourceUrl": "https://www.schneider-airsystems.de/content/dam/brands/schneider/documents/catalogs-brochures/Schneider%20airsystems-Gesamtkatalog-2025-DE-SCREEN.pdf#page=52",
			"sourceLabel": "Schneider airsystems, catalogue 2025, p. 52, réf. 1122030302",
	...
	"notes": [
		...
		"Source : catalogue 2025, page 52, référence 1122030302."
	]
};
