const product = {
	"id": "schneider-unm-sts-1000-15-500-xdkc",
	"slug": "schneider-unm-sts-1000-15-500-xdkc",
	"brand": "Schneider",
	"model": "UNM STS 1000-15-500 XDKC",
	"mpn": "1121580528",
	"tankLiters": 500,
	"maxPressureBar": 15,
	"fadCurve": [
	...
	"editorial": {
		"overview": "UNM STS 1000-15-500 XDKC, référence 1121580528, associe une cuve de 500 L à un moteur de 7,5 kW. Le débit restitué publié est de 790 L/min à 14 bar. Démarreur étoile-triangle prémonté (version C). Sécheur frigorifique intégré.",
		"verifiedFacts": [
			"Pression publiée : 15 bar ; débit aspiré : 1 000 L/min, distinct du débit restitué.",
			"Poids publié : 343 kg ; dimensions : 1 145 × 850 × 2 020 mm.",
	...
	"specifications": [
		{
			...
			"value": "1 145 × 850 × 2 020 mm",
			"evidenceIds": [
				"schneider-2025-1121580528"
			]
		},
		{
	...
	"evidence": [
		{
			"id": "schneider-2025-1121580528",
			"sourceUrl": "https://www.schneider-airsystems.de/content/dam/brands/schneider/documents/catalogs-brochures/Schneider%20airsystems-Gesamtkatalog-2025-DE-SCREEN.pdf#page=48",
			"sourceLabel": "Schneider airsystems, catalogue 2025, p. 48, réf. 1121580528",
	...
	"notes": [
		...
		"Source : catalogue 2025, page 48, référence 1121580528."
	]
};
