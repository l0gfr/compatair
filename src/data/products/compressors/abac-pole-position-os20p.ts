const product = {
		...
		evidence: [{ id: 'abac-1129740297-official', sourceUrl: 'https://shop.abacaircompressors.com/fr-FR/products/1129740297/pole-position-os20p', sourceLabel: 'ABAC France, fiche produit officielle', sourceType: 'manufacturer', retrievedAt: '2026-07-13', confidence: 'C', notes: 'La fiche publie un volume engendré, pas un FAD à la pression de travail.' }], notes: ['Résultat suspendu tant qu’un débit restitué à la pression de travail n’est pas documenté.'],
	};
