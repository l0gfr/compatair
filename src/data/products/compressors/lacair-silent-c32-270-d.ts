const product = {
	"id": "lacair-silent-c32-270-d",
	"slug": "lacair-silent-c32-270-d",
	"brand": "Lacair",
	"model": "Silent C32/270 D",
	"mpn": "464760",
	"tankLiters": 270,
	"maxPressureBar": 10,
	"fadCurve": [
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/lacair-silent-c32-270-d.webp",
		"alt": "Repères techniques Lacair Silent C32/270 D, référence 464760",
	...
	"editorial": {
		"overview": "Lacair Silent C32/270 D, référence 464760 : cuve de 270 L, pression maximale publiée de 10 bar. Le point documenté le plus élevé en pression fournit 375 L/min à 7 bar.",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "lacair-464760-20260926",
			"sourceUrl": "https://s3.eu-west-1.amazonaws.com/s37.lacme.com/crm/Catalogues/LACME%20-%20Catalogue%20Lacair%202026.pdf#page=40",
			"sourceLabel": "Lacair / Lacmé, catalogue 2026, p. 40, réf. 464760",
		...
		{
			"id": "lacair-464760-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"lacair-464760-20260926-lubrification"
		],
		"intakeFlowLpm": [
			"lacair-464760-20260926"
		],
