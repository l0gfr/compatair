const product = {
	"id": "fini-plus-15-15-500-es",
	"slug": "fini-plus-15-15-500-es",
	"brand": "Fini",
	"model": "PLUS 15-15-500 ES",
	"mpn": "V83NR92FNM601",
	"tankLiters": 500,
	"maxPressureBar": 15,
	"fadCurve": [
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/fini-plus-15-15-500-es.webp",
		"alt": "Repères techniques Fini PLUS 15-15-500 ES, référence V83NR92FNM601",
	...
	"editorial": {
		"overview": "Fini PLUS 15-15-500 ES, référence V83NR92FNM601 : cuve de 500 L, pression maximale publiée de 15 bar. Le point documenté le plus élevé en pression fournit 1 300 L/min à 15 bar. Sécheur intégré (version ES).",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "fini-v83nr92fnm601-20260926",
			"sourceUrl": "https://finicompressors.com/wp-content/uploads/Catalogo-Micro-Plus_Fini_IT_04-2024_9990394.pdf#page=18",
			"sourceLabel": "Fini, catalogue MICRO / PLUS, édition 04-2024, p. 18, réf. V83NR92FNM601",
		...
		{
			"id": "fini-v83nr92fnm601-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"fini-v83nr92fnm601-20260926-lubrification"
		],
		"powerKw": [
			"fini-v83nr92fnm601-20260926"
		],
