const product = {
	"id": "lacair-silent-c33-270-sc-d",
	"slug": "lacair-silent-c33-270-sc-d",
	"brand": "Lacair",
	"model": "Silent C33/270 SC-D",
	"mpn": "464783",
	"tankLiters": 270,
	"maxPressureBar": 13,
	"fadCurve": [
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/lacair-silent-c33-270-sc-d.webp",
		"alt": "Repères techniques Lacair Silent C33/270 SC-D, référence 464783",
	...
	"editorial": {
		"overview": "Lacair Silent C33/270 SC-D, référence 464783 : cuve de 270 L, pression maximale publiée de 13 bar. Le point documenté le plus élevé en pression fournit 410 L/min à 7 bar. Sécheur frigorifique intégré (version SC).",
		"verifiedFacts": [
			"Débit restitué publié : 410 L/min à 7 bar.",
			"Pistons lubrifiés. Puissance moteur publiée : 4 kW.",
			"Débit aspiré : 540 L/min, distinct du débit restitué.",
			"Masse nette publiée : 275 kg.",
	...
	"evidence": [
		{
			"id": "lacair-464783-20260926",
			"sourceUrl": "https://s3.eu-west-1.amazonaws.com/s37.lacme.com/crm/Catalogues/LACME%20-%20Catalogue%20Lacair%202026.pdf#page=41",
			"sourceLabel": "Lacair / Lacmé, catalogue 2026, p. 41, réf. 464783",
		...
		{
			"id": "lacair-464783-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"lacair-464783-20260926-lubrification"
		],
		"intakeFlowLpm": [
			"lacair-464783-20260926"
		],
