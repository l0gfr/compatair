const product = {
	...
	fieldSources: { fadCurve: ['metabo-601544000-official'], ean: ['metabo-601544000-official'], oilType: ['metabo-601544000-official'], weightKg: ['metabo-601544000-official'], maxPressureBar: ['metabo-601544000-official'] }, notes: ['Point effectif unique à 8 bar.'],
};
