const product = {
	"id": "fini-micro-4-0-10",
	"slug": "fini-micro-4-0-10",
	"brand": "Fini",
	"model": "MICRO 4.0-10",
	"mpn": "V51JP92FNMA60",
	"tankLiters": 0,
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/fini-micro-4-0-10.webp",
		"alt": "Repères techniques Fini MICRO 4.0-10, référence V51JP92FNMA60",
	...
	"editorial": {
		"overview": "Fini MICRO 4.0-10, référence V51JP92FNMA60 : configuration sans cuve intégrée, pression maximale publiée de 10 bar. Le point documenté le plus élevé en pression fournit 485 L/min à 10 bar. Version sans sécheur intégré.",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "fini-v51jp92fnma60-20260926",
			"sourceUrl": "https://finicompressors.com/wp-content/uploads/Catalogo-Micro-Plus_Fini_IT_04-2024_9990394.pdf#page=16",
			"sourceLabel": "Fini, catalogue MICRO / PLUS, édition 04-2024, p. 16, réf. V51JP92FNMA60",
		...
		{
			"id": "fini-v51jp92fnma60-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"fini-v51jp92fnma60-20260926-lubrification"
		],
		"powerKw": [
			"fini-v51jp92fnma60-20260926"
		],
