const product = {
		...
		fieldSources: { fadCurve: ['einhell-4020385-official'], ean: ['einhell-4020385-official'], maxPressureBar: ['einhell-4020385-official'] }, notes: ['Batterie et chargeur non inclus selon la fiche constructeur.'],
	};
