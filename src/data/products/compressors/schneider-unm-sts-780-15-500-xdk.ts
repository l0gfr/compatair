const product = {
	"id": "schneider-unm-sts-780-15-500-xdk",
	"slug": "schneider-unm-sts-780-15-500-xdk",
	"brand": "Schneider",
	"model": "UNM STS 780-15-500 XDK",
	"mpn": "1121580504",
	"tankLiters": 500,
	"maxPressureBar": 15,
	"fadCurve": [
	...
	"editorial": {
		"overview": "UNM STS 780-15-500 XDK, référence 1121580504, associe une cuve de 500 L à un moteur de 5,5 kW. Le débit restitué publié est de 570 L/min à 14 bar. Sécheur frigorifique intégré.",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "schneider-2025-1121580504",
			"sourceUrl": "https://www.schneider-airsystems.de/content/dam/brands/schneider/documents/catalogs-brochures/Schneider%20airsystems-Gesamtkatalog-2025-DE-SCREEN.pdf#page=48",
			"sourceLabel": "Schneider airsystems, catalogue 2025, p. 48, réf. 1121580504",
	...
	"notes": [
		...
		"Source : catalogue 2025, page 48, référence 1121580504."
	]
};
