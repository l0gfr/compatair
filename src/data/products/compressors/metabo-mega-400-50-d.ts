const product = {
	...
	image: { src: '/images/products/metabo-mega-400-50-d.webp', alt: 'Compresseur Metabo Mega 400-50 D', sourceUrl: 'https://de.metabo.com/de/maschinen/druckluft/kompressoren/mobile-werkstatt-kompressoren/mega-400-50-d-601537000-kompressor.html', sourceLabel: 'Visuel officiel Metabo' },
	...
	fieldSources: { fadCurve: ['metabo-601537000-official'], phase: ['metabo-601537000-official'], ean: ['metabo-601537000-official'], weightKg: ['metabo-601537000-official'], maxPressureBar: ['metabo-601537000-official'] }, notes: ['Point effectif unique à 8 bar.'],
};
