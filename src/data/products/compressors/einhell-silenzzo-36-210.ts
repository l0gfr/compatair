const product = {
		...
		fieldSources: { fadCurve: ['einhell-4020380-official'], ean: ['einhell-4020380-official'], maxPressureBar: ['einhell-4020380-official'] }, notes: ['Deux batteries 18 V nécessaires et non incluses selon la fiche constructeur.'],
	};
