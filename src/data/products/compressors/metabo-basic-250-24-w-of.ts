const product = {
	...
	image: { src: '/images/products/metabo-basic-250-24-w-of.png', alt: 'Compresseur Metabo Basic 250-24 W OF', sourceUrl: 'https://www.metabo.com/com/en/products/tools/compressed-air/compressors/mobile-workshop-compressors/basic-250-24-w-of-compressor/601532000', sourceLabel: 'Visuel officiel Metabo' },
	...
	fieldSources: { fadCurve: ['metabo-601532000-official'], intakeFlowLpm: ['metabo-601532000-official'], oilType: ['metabo-601532000-official'], noiseDb: ['metabo-601532000-official'] }, notes: ['Point effectif unique à 6,4 bar.'],
};
