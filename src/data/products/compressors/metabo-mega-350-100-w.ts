const product = {
		...
		evidence: [{ id: 'metabo-601538000-official', sourceUrl: 'https://fr.metabo.com/fr/machines/air-comprime/compresseurs/compresseurs-d-atelier-mobiles/mega-350-100-w-601538000-compresseur.html', sourceLabel: 'Metabo France, fiche produit officielle', sourceType: 'manufacturer', retrievedAt: '2026-07-13', confidence: 'A', notes: 'Débit effectif annoncé à 80 % de la pression maximale.' }],
		fieldSources: { mpn: ['metabo-601538000-official'], ean: ['metabo-601538000-official'], tankLiters: ['metabo-601538000-official'], maxPressureBar: ['metabo-601538000-official'], fadCurve: ['metabo-601538000-official'], intakeFlowLpm: ['metabo-601538000-official'], oilType: ['metabo-601538000-official'], noiseDb: ['metabo-601538000-official'] }, notes: [],
	};
