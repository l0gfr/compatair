const product = {
	"id": "fini-micro-se-2-2-10-200-m",
	"slug": "fini-micro-se-2-2-10-200-m",
	"brand": "Fini",
	"model": "MICRO SE 2.2-10-200 M",
	"mpn": "V77JT60FNM501",
	"tankLiters": 200,
	"maxPressureBar": 10,
	"fadCurve": [
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/fini-micro-se-2-2-10-200-m.webp",
		"alt": "Repères techniques Fini MICRO SE 2.2-10-200 M, référence V77JT60FNM501",
	...
	"editorial": {
		"overview": "Fini MICRO SE 2.2-10-200 M, référence V77JT60FNM501 : cuve de 200 L, pression maximale publiée de 10 bar. Le point documenté le plus élevé en pression fournit 240 L/min à 10 bar. Version sans sécheur intégré.",
		"verifiedFacts": [
			"Débit restitué publié : 240 L/min à 10 bar.",
			"Vis lubrifiée, vitesse fixe. Puissance moteur publiée : 2,2 kW.",
			"Masse nette publiée : 148 kg."
		],
		"limitations": [
	...
	"evidence": [
		{
			"id": "fini-v77jt60fnm501-20260926",
			"sourceUrl": "https://finicompressors.com/wp-content/uploads/Catalogo-Micro-Plus_Fini_IT_04-2024_9990394.pdf#page=16",
			"sourceLabel": "Fini, catalogue MICRO / PLUS, édition 04-2024, p. 16, réf. V77JT60FNM501",
		...
		{
			"id": "fini-v77jt60fnm501-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"fini-v77jt60fnm501-20260926-lubrification"
		],
		"powerKw": [
			"fini-v77jt60fnm501-20260926"
		],
