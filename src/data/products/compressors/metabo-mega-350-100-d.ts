const product = {
	...
	image: { src: '/images/products/metabo-mega-350-100-d.webp', alt: 'Compresseur Metabo Mega 350-100 D', sourceUrl: 'https://www.metabo.com/com/en/tools/compressed-air/compressors/mobile-workshop-compressors/mega-350-100-d-compressor/601539000', sourceLabel: 'Visuel officiel Metabo' },
	...
	fieldSources: { fadCurve: ['metabo-601539000-official'], phase: ['metabo-601539000-official'], ean: ['metabo-601539000-official'], noiseDb: ['metabo-601539000-official'], maxPressureBar: ['metabo-601539000-official'] }, notes: ['Point effectif unique à 8 bar.'],
};
