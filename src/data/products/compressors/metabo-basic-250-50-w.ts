const product = {
		...
		fieldSources: { fadCurve: ['metabo-601534000-official'], ean: ['metabo-601534000-official'], noiseDb: ['metabo-601534000-official'], maxPressureBar: ['metabo-601534000-official'] }, notes: ['Point effectif unique à 6,4 bar.'],
	};
