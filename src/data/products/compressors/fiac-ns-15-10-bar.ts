const product = {
	"id": "fiac-ns-15-10-bar",
	"slug": "fiac-ns-15-10-bar",
	"brand": "FIAC",
	"model": "NS 15 10 bar",
	"mpn": "4152040491",
	"tankLiters": 0,
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/fiac-ns-15-10-bar.webp",
		"alt": "Repères techniques FIAC NS 15 10 bar, référence 4152040491",
	...
	"editorial": {
		"overview": "FIAC NS 15 10 bar, référence 4152040491 : configuration sans cuve intégrée, pression maximale publiée de 10 bar. Le point documenté le plus élevé en pression fournit 1 410 L/min à 10 bar. Version sans sécheur intégré.",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "fiac-4152040491-20260926",
			"sourceUrl": "https://web.fiac.it/content/dam/brands/fiac/website/documents/Fiac_Cat%20S226-R1-062026%20-%20screen__compressed.pdf#page=18",
			"sourceLabel": "FIAC, catalogue S226 R1, juin 2026, p. 18, réf. 4152040491",
		...
		{
			"id": "fiac-4152040491-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"fiac-4152040491-20260926-lubrification"
		],
		"powerKw": [
			"fiac-4152040491-20260926"
		],
