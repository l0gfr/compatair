const product = {
	"id": "schneider-unm-sts-660-10-270-xs",
	"slug": "schneider-unm-sts-660-10-270-xs",
	"brand": "Schneider",
	"model": "UNM STS 660-10-270 XS",
	"mpn": "1121570241",
	"tankLiters": 270,
	"maxPressureBar": 10,
	"fadCurve": [
	...
	"editorial": {
		"overview": "UNM STS 660-10-270 XS, référence 1121570241, associe une cuve de 270 L à un moteur de 4 kW. Le débit restitué publié est de 520 L/min à 9 bar. Version avec réduction du bruit publiée par le fabricant.",
		"verifiedFacts": [
			"Pression publiée : 10 bar ; débit aspiré : 660 L/min, distinct du débit restitué.",
			"Poids publié : 209 kg ; dimensions : 775 × 740 × 1 905 mm.",
	...
	"evidence": [
		{
			"id": "schneider-2025-1121570241",
			"sourceUrl": "https://www.schneider-airsystems.de/content/dam/brands/schneider/documents/catalogs-brochures/Schneider%20airsystems-Gesamtkatalog-2025-DE-SCREEN.pdf#page=47",
			"sourceLabel": "Schneider airsystems, catalogue 2025, p. 47, réf. 1121570241",
	...
	"notes": [
		...
		"Source : catalogue 2025, page 47, référence 1121570241."
	]
};
