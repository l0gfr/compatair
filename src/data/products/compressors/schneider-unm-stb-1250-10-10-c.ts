const product = {
	...
	"editorial": {
		"overview": "UNM STB 1250-10-10 C, référence 1122030308, associe une cuve de 10 L à un moteur de 7,5 kW. Le débit restitué publié est de 980 L/min à 9 bar. Démarreur étoile-triangle prémonté (version C). Unité d’appoint destinée à étendre un réseau d’air comprimé existant.",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "schneider-2025-1122030308",
			"sourceUrl": "https://www.schneider-airsystems.de/content/dam/brands/schneider/documents/catalogs-brochures/Schneider%20airsystems-Gesamtkatalog-2025-DE-SCREEN.pdf#page=52",
			"sourceLabel": "Schneider airsystems, catalogue 2025, p. 52, réf. 1122030308",
	...
	"notes": [
		...
		"Source : catalogue 2025, page 52, référence 1122030308."
	]
};
