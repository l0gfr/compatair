const product = {
	...
	fieldSources: { fadCurve: ['einhell-4020430-official'], voltage: ['einhell-4020430-official'], ean: ['einhell-4020430-official'], weightKg: ['einhell-4020430-official'], maxPressureBar: ['einhell-4020430-official'] }, notes: ['Profil multipoint constructeur.'],
};
