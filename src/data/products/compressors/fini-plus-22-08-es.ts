const product = {
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/fini-plus-22-08-es.webp",
		"alt": "Repères techniques Fini PLUS 22-08 ES, référence V60QD92FNM860",
	...
	"editorial": {
		"overview": "Fini PLUS 22-08 ES, référence V60QD92FNM860 : configuration sans cuve intégrée, pression maximale publiée de 8 bar. Le point documenté le plus élevé en pression fournit 3 350 L/min à 8 bar. Sécheur intégré (version ES).",
		"verifiedFacts": [
			"Débit restitué publié : 3 350 L/min à 8 bar.",
	...
	"evidence": [
		{
			"id": "fini-v60qd92fnm860-20260926",
			"sourceUrl": "https://finicompressors.com/wp-content/uploads/Catalogo-Micro-Plus_Fini_IT_04-2024_9990394.pdf#page=18",
			"sourceLabel": "Fini, catalogue MICRO / PLUS, édition 04-2024, p. 18, réf. V60QD92FNM860",
		...
		{
			"id": "fini-v60qd92fnm860-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"fini-v60qd92fnm860-20260926-lubrification"
		],
		"powerKw": [
			"fini-v60qd92fnm860-20260926"
		],
