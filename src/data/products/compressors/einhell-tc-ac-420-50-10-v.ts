const product = {
		...
		fieldSources: { fadCurve: ['einhell-4010495-official'], ean: ['einhell-4010495-official'], noiseDb: ['einhell-4010495-official'], maxPressureBar: ['einhell-4010495-official'] }, notes: ['Le niveau sonore publié mesure la pression acoustique au poste d’écoute (LpA).'],
	};
