const product = {
		...
		fieldSources: { fadCurve: ['einhell-4007332-official'], ean: ['einhell-4007332-official'], noiseDb: ['einhell-4007332-official'] }, notes: ['Durée de fonctionnement de 15 minutes (code S2 du fabricant), non convertie en pourcentage de fonctionnement.'],
	};
