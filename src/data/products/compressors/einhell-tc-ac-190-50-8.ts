const product = {
		...
		editorial: { overview: 'Le TC-AC 190/50/8 associe une cuve de 50 litres à un groupe lubrifié. Son débit restitué publié tombe à 55 L/min à 7 bar, loin des 165 L/min aspirés.', verifiedFacts: ['La fiche publie 110 L/min à 0 bar, 75 L/min à 4 bar et 55 L/min à 7 bar.', 'Einhell indique 8 bar maximum, 1,5 kW, 26,4 kg et une durée de fonctionnement publiée de 15 minutes (S2).'], limitations: ['La durée S2 de 15 minutes n’est pas convertie en pourcentage de temps de fonctionnement.', 'Aucun débit restitué n’est documenté à la pression maximale de 8 bar.'] },
		...
		fieldSources: { fadCurve: ['einhell-4007332-official'], ean: ['einhell-4007332-official'], noiseDb: ['einhell-4007332-official'], maxPressureBar: ['einhell-4007332-official'] }, notes: ['Durée de fonctionnement de 15 minutes (code S2 du fabricant), non convertie en pourcentage de fonctionnement.'],
	};
