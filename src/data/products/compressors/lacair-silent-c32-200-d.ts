const product = {
	"id": "lacair-silent-c32-200-d",
	"slug": "lacair-silent-c32-200-d",
	"brand": "Lacair",
	"model": "Silent C32/200 D",
	"mpn": "464755",
	"tankLiters": 200,
	"maxPressureBar": 10,
	"fadCurve": [
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/lacair-silent-c32-200-d.webp",
		"alt": "Repères techniques Lacair Silent C32/200 D, référence 464755",
	...
	"editorial": {
		"overview": "Lacair Silent C32/200 D, référence 464755 : cuve de 200 L, pression maximale publiée de 10 bar. Le point documenté le plus élevé en pression fournit 375 L/min à 7 bar.",
		"verifiedFacts": [
	...
	"specifications": [
		{
			...
			"evidenceIds": [
				"lacair-464755-20260926"
			]
		},
		{
			"label": "Dimensions publiées",
			"value": "144 x 60 x 129 cm",
			"evidenceIds": [
				"lacair-464755-20260926"
			]
		}
	...
	"evidence": [
		{
			"id": "lacair-464755-20260926",
			"sourceUrl": "https://s3.eu-west-1.amazonaws.com/s37.lacme.com/crm/Catalogues/LACME%20-%20Catalogue%20Lacair%202026.pdf#page=40",
			"sourceLabel": "Lacair / Lacmé, catalogue 2026, p. 40, réf. 464755",
		...
		{
			"id": "lacair-464755-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"lacair-464755-20260926-lubrification"
		],
		"intakeFlowLpm": [
			"lacair-464755-20260926"
		],
