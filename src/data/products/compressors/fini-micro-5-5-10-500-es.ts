const product = {
	"id": "fini-micro-5-5-10-500-es",
	"slug": "fini-micro-5-5-10-500-es",
	"brand": "Fini",
	"model": "MICRO 5.5-10-500 ES",
	"mpn": "V83JO92FNM801",
	"tankLiters": 500,
	"maxPressureBar": 10,
	"fadCurve": [
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/fini-micro-5-5-10-500-es.webp",
		"alt": "Repères techniques Fini MICRO 5.5-10-500 ES, référence V83JO92FNM801",
	...
	"editorial": {
		"overview": "Fini MICRO 5.5-10-500 ES, référence V83JO92FNM801 : cuve de 500 L, pression maximale publiée de 10 bar. Le point documenté le plus élevé en pression fournit 650 L/min à 10 bar. Sécheur intégré (version ES).",
		"verifiedFacts": [
			"Débit restitué publié : 650 L/min à 10 bar.",
			"Vis lubrifiée, vitesse fixe. Puissance moteur publiée : 5,5 kW.",
			"Masse nette publiée : 304 kg."
		],
		"limitations": [
	...
	"evidence": [
		{
			"id": "fini-v83jo92fnm801-20260926",
			"sourceUrl": "https://finicompressors.com/wp-content/uploads/Catalogo-Micro-Plus_Fini_IT_04-2024_9990394.pdf#page=16",
			"sourceLabel": "Fini, catalogue MICRO / PLUS, édition 04-2024, p. 16, réf. V83JO92FNM801",
		...
		{
			"id": "fini-v83jo92fnm801-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"fini-v83jo92fnm801-20260926-lubrification"
		],
		"powerKw": [
			"fini-v83jo92fnm801-20260926"
		],
