const product = {
	"id": "fini-micro-se-4-0-10-200-es",
	"slug": "fini-micro-se-4-0-10-200-es",
	"brand": "Fini",
	"model": "MICRO SE 4.0-10-200 ES",
	"mpn": "V77JP72FNM801",
	"tankLiters": 200,
	"maxPressureBar": 10,
	"fadCurve": [
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/fini-micro-se-4-0-10-200-es.webp",
		"alt": "Repères techniques Fini MICRO SE 4.0-10-200 ES, référence V77JP72FNM801",
	...
	"editorial": {
		"overview": "Fini MICRO SE 4.0-10-200 ES, référence V77JP72FNM801 : cuve de 200 L, pression maximale publiée de 10 bar. Le point documenté le plus élevé en pression fournit 485 L/min à 10 bar. Sécheur intégré (version ES).",
		"verifiedFacts": [
			"Débit restitué publié : 485 L/min à 10 bar.",
			"Vis lubrifiée, vitesse fixe. Puissance moteur publiée : 4 kW.",
			"Masse nette publiée : 179 kg."
		],
		"limitations": [
	...
	"evidence": [
		{
			"id": "fini-v77jp72fnm801-20260926",
			"sourceUrl": "https://finicompressors.com/wp-content/uploads/Catalogo-Micro-Plus_Fini_IT_04-2024_9990394.pdf#page=16",
			"sourceLabel": "Fini, catalogue MICRO / PLUS, édition 04-2024, p. 16, réf. V77JP72FNM801",
		...
		{
			"id": "fini-v77jp72fnm801-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"fini-v77jp72fnm801-20260926-lubrification"
		],
		"powerKw": [
			"fini-v77jp72fnm801-20260926"
		],
