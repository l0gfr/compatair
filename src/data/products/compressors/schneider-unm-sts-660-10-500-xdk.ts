const product = {
	"id": "schneider-unm-sts-660-10-500-xdk",
	"slug": "schneider-unm-sts-660-10-500-xdk",
	"brand": "Schneider",
	"model": "UNM STS 660-10-500 XDK",
	"mpn": "1121580535",
	"tankLiters": 500,
	"maxPressureBar": 10,
	"fadCurve": [
	...
	"editorial": {
		"overview": "UNM STS 660-10-500 XDK, référence 1121580535, associe une cuve de 500 L à un moteur de 4 kW. Le débit restitué publié est de 520 L/min à 9 bar. Sécheur frigorifique intégré.",
		"verifiedFacts": [
			"Pression publiée : 10 bar ; débit aspiré : 660 L/min, distinct du débit restitué.",
			"Poids publié : 251 kg ; dimensions : 1 070 × 850 × 1 945 mm.",
	...
	"evidence": [
		{
			"id": "schneider-2025-1121580535",
			"sourceUrl": "https://www.schneider-airsystems.de/content/dam/brands/schneider/documents/catalogs-brochures/Schneider%20airsystems-Gesamtkatalog-2025-DE-SCREEN.pdf#page=48",
			"sourceLabel": "Schneider airsystems, catalogue 2025, p. 48, réf. 1121580535",
	...
	"notes": [
		...
		"Source : catalogue 2025, page 48, référence 1121580535."
	]
};
