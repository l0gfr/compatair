const product = {
		...
		evidence: [{ id: 'einhell-4020660-official', sourceUrl: 'https://www.einhell.fr/p/4020660', sourceLabel: 'Einhell France, fiche produit officielle', sourceType: 'manufacturer', retrievedAt: '2026-07-13', confidence: 'B' }], notes: ['Aucune valeur publiée à 6,3 ou 7 bar dans la fiche consultée.'],
	};
