const product = {
	"id": "lacair-silent-c32-d",
	"slug": "lacair-silent-c32-d",
	"brand": "Lacair",
	"model": "Silent C32 D",
	"mpn": "464750",
	"tankLiters": 2,
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/lacair-silent-c32-d.webp",
		"alt": "Repères techniques Lacair Silent C32 D, référence 464750",
	...
	"editorial": {
		"overview": "Lacair Silent C32 D, référence 464750 : cuve de 2 L, pression maximale publiée de 10 bar. Le point documenté le plus élevé en pression fournit 375 L/min à 7 bar.",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "lacair-464750-20260926",
			"sourceUrl": "https://s3.eu-west-1.amazonaws.com/s37.lacme.com/crm/Catalogues/LACME%20-%20Catalogue%20Lacair%202026.pdf#page=39",
			"sourceLabel": "Lacair / Lacmé, catalogue 2026, p. 39, réf. 464750",
		...
		{
			"id": "lacair-464750-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"lacair-464750-20260926-lubrification"
		],
		"intakeFlowLpm": [
			"lacair-464750-20260926"
		],
