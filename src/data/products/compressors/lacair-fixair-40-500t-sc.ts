const product = {
	"id": "lacair-fixair-40-500t-sc",
	"slug": "lacair-fixair-40-500t-sc",
	"brand": "Lacair",
	"model": "FixAir 40/500T-SC",
	"mpn": "465250",
	"tankLiters": 500,
	"maxPressureBar": 12,
	"fadCurve": [
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/lacair-fixair-40-500t-sc.webp",
		"alt": "Repères techniques Lacair FixAir 40/500T-SC, référence 465250",
	...
	"editorial": {
		"overview": "Lacair FixAir 40/500T-SC, référence 465250 : cuve de 500 L, pression maximale publiée de 12 bar. Le point documenté le plus élevé en pression fournit 600 L/min à 6 bar. Sécheur frigorifique intégré (version SC).",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "lacair-465250-20260926",
			"sourceUrl": "https://s3.eu-west-1.amazonaws.com/s37.lacme.com/crm/Catalogues/LACME%20-%20Catalogue%20Lacair%202026.pdf#page=35",
			"sourceLabel": "Lacair / Lacmé, catalogue 2026, p. 35, réf. 465250",
		...
		{
			"id": "lacair-465250-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"lacair-465250-20260926-lubrification"
		],
		"intakeFlowLpm": [
			"lacair-465250-20260926"
		],
