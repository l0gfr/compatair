const product = {
	"id": "fini-micro-5-5-08-270-es",
	"slug": "fini-micro-5-5-08-270-es",
	"brand": "Fini",
	"model": "MICRO 5.5-08-270 ES",
	"mpn": "V91JW92FNM801",
	"tankLiters": 270,
	"maxPressureBar": 8,
	"fadCurve": [
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/fini-micro-5-5-08-270-es.webp",
		"alt": "Repères techniques Fini MICRO 5.5-08-270 ES, référence V91JW92FNM801",
	...
	"editorial": {
		"overview": "Fini MICRO 5.5-08-270 ES, référence V91JW92FNM801 : cuve de 270 L, pression maximale publiée de 8 bar. Le point documenté le plus élevé en pression fournit 720 L/min à 8 bar. Sécheur intégré (version ES).",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "fini-v91jw92fnm801-20260926",
			"sourceUrl": "https://finicompressors.com/wp-content/uploads/Catalogo-Micro-Plus_Fini_IT_04-2024_9990394.pdf#page=16",
			"sourceLabel": "Fini, catalogue MICRO / PLUS, édition 04-2024, p. 16, réf. V91JW92FNM801",
		...
		{
			"id": "fini-v91jw92fnm801-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"fini-v91jw92fnm801-20260926-lubrification"
		],
		"powerKw": [
			"fini-v91jw92fnm801-20260926"
		],
