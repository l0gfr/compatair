const product = {
	"id": "schneider-unm-stl-580-15-270",
	"slug": "schneider-unm-stl-580-15-270",
	"brand": "Schneider",
	"model": "UNM STL 580-15-270",
	"mpn": "1121570222",
	"tankLiters": 270,
	"maxPressureBar": 15,
	"fadCurve": [
	...
	"editorial": {
		"overview": "UNM STL 580-15-270, référence 1121570222, associe une cuve de 270 L à un moteur de 4 kW. Le débit restitué publié est de 470 L/min à 14 bar.",
		"verifiedFacts": [
			"Pression publiée : 15 bar ; débit aspiré : 580 L/min, distinct du débit restitué.",
			"Poids publié : 188 kg ; dimensions : 1 620 × 515 × 1 205 mm.",
	...
	"evidence": [
		{
			"id": "schneider-2025-1121570222",
			"sourceUrl": "https://www.schneider-airsystems.de/content/dam/brands/schneider/documents/catalogs-brochures/Schneider%20airsystems-Gesamtkatalog-2025-DE-SCREEN.pdf#page=50",
			"sourceLabel": "Schneider airsystems, catalogue 2025, p. 50, réf. 1121570222",
	...
	"notes": [
		...
		"Source : catalogue 2025, page 50, référence 1121570222."
	]
};
