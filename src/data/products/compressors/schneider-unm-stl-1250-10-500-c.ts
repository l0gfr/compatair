const product = {
	"id": "schneider-unm-stl-1250-10-500-c",
	"slug": "schneider-unm-stl-1250-10-500-c",
	"brand": "Schneider",
	"model": "UNM STL 1250-10-500 C",
	"mpn": "1121580517",
	"tankLiters": 500,
	"maxPressureBar": 10,
	"fadCurve": [
	...
	"editorial": {
		"overview": "UNM STL 1250-10-500 C, référence 1121580517, associe une cuve de 500 L à un moteur de 7,5 kW. Le débit restitué publié est de 980 L/min à 9 bar. Démarreur étoile-triangle prémonté (version C).",
		"verifiedFacts": [
			"Pression publiée : 10 bar ; débit aspiré : 1 250 L/min, distinct du débit restitué.",
			"Poids publié : 304 kg ; dimensions : 1 950 × 625 × 1 380 mm.",
	...
	"evidence": [
		{
			"id": "schneider-2025-1121580517",
			"sourceUrl": "https://www.schneider-airsystems.de/content/dam/brands/schneider/documents/catalogs-brochures/Schneider%20airsystems-Gesamtkatalog-2025-DE-SCREEN.pdf#page=50",
			"sourceLabel": "Schneider airsystems, catalogue 2025, p. 50, réf. 1121580517",
	...
	"notes": [
		...
		"Source : catalogue 2025, page 50, référence 1121580517."
	]
};
