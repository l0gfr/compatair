const product = {
	...
	image: { src: '/images/products/metabo-mega-700-90-d.webp', alt: 'Compresseur Metabo Mega 700-90 D', sourceUrl: 'https://www.metabo.com/no/no/maskiner/trykkluft/kompressorer/mobile-verksted-kompressorer/mega-700-90-d-kompressor/601542000', sourceLabel: 'Visuel officiel Metabo' },
	...
	fieldSources: { fadCurve: ['metabo-601542000-official'], ean: ['metabo-601542000-official'], powerKw: ['metabo-601542000-official'], weightKg: ['metabo-601542000-official'], maxPressureBar: ['metabo-601542000-official'] }, notes: ['Point effectif unique à 8,8 bar.'],
};
