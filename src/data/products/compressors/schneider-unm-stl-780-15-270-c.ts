const product = {
	"id": "schneider-unm-stl-780-15-270-c",
	"slug": "schneider-unm-stl-780-15-270-c",
	"brand": "Schneider",
	"model": "UNM STL 780-15-270 C",
	"mpn": "1121570226",
	"tankLiters": 270,
	"maxPressureBar": 15,
	"fadCurve": [
	...
	"editorial": {
		"overview": "UNM STL 780-15-270 C, référence 1121570226, associe une cuve de 270 L à un moteur de 5,5 kW. Le débit restitué publié est de 640 L/min à 14 bar. Démarreur étoile-triangle prémonté (version C).",
		"verifiedFacts": [
			"Pression publiée : 15 bar ; débit aspiré : 780 L/min, distinct du débit restitué.",
			"Poids publié : 224 kg ; dimensions : 1 620 × 555 × 1 220 mm.",
			"Cuve : 270 L ; puissance moteur : 5,5 kW ; rotation : 830 tr/min.",
	...
	"evidence": [
		{
			"id": "schneider-2025-1121570226",
			"sourceUrl": "https://www.schneider-airsystems.de/content/dam/brands/schneider/documents/catalogs-brochures/Schneider%20airsystems-Gesamtkatalog-2025-DE-SCREEN.pdf#page=50",
			"sourceLabel": "Schneider airsystems, catalogue 2025, p. 50, réf. 1121570226",
	...
	"notes": [
		...
		"Source : catalogue 2025, page 50, référence 1121570226."
	]
};
