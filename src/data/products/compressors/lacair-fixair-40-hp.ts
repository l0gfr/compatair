const product = {
	"id": "lacair-fixair-40-hp",
	"slug": "lacair-fixair-40-hp",
	"brand": "Lacair",
	"model": "Fixair 40 - HP",
	"mpn": "465241",
	"tankLiters": 0,
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/lacair-fixair-40-hp.webp",
		"alt": "Repères techniques Lacair Fixair 40 - HP, référence 465241",
	...
	"editorial": {
		"overview": "Lacair Fixair 40 - HP, référence 465241 : configuration sans cuve intégrée, pression maximale publiée de 14 bar. Le point documenté le plus élevé en pression fournit 600 L/min à 6 bar. Platine sans cuve.",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "lacair-465241-20260926",
			"sourceUrl": "https://s3.eu-west-1.amazonaws.com/s37.lacme.com/crm/Catalogues/LACME%20-%20Catalogue%20Lacair%202026.pdf#page=33",
			"sourceLabel": "Lacair / Lacmé, catalogue 2026, p. 33, réf. 465241",
		...
		{
			"id": "lacair-465241-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"lacair-465241-20260926-lubrification"
		],
		"intakeFlowLpm": [
			"lacair-465241-20260926"
		],
