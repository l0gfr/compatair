const product = {
	"id": "schneider-unm-sts-1000-10-270-xdkc",
	"slug": "schneider-unm-sts-1000-10-270-xdkc",
	"brand": "Schneider",
	"model": "UNM STS 1000-10-270 XDKC",
	"mpn": "1121570229",
	"tankLiters": 270,
	"maxPressureBar": 10,
	"fadCurve": [
	...
	"editorial": {
		"overview": "UNM STS 1000-10-270 XDKC, référence 1121570229, associe une cuve de 270 L à un moteur de 5,5 kW. Le débit restitué publié est de 785 L/min à 9 bar. Démarreur étoile-triangle prémonté (version C). Sécheur frigorifique intégré.",
		"verifiedFacts": [
			"Pression publiée : 10 bar ; débit aspiré : 1 070 L/min, distinct du débit restitué.",
			"Poids publié : 241 kg ; dimensions : 1 020 × 705 × 1 800 mm.",
			"Cuve : 270 L ; puissance moteur : 5,5 kW ; rotation : 1 260 tr/min.",
	...
	"specifications": [
		{
			...
			"value": "1 020 × 705 × 1 800 mm",
			"evidenceIds": [
				"schneider-2025-1121570229"
			]
		},
		{
	...
	"evidence": [
		{
			"id": "schneider-2025-1121570229",
			"sourceUrl": "https://www.schneider-airsystems.de/content/dam/brands/schneider/documents/catalogs-brochures/Schneider%20airsystems-Gesamtkatalog-2025-DE-SCREEN.pdf#page=48",
			"sourceLabel": "Schneider airsystems, catalogue 2025, p. 48, réf. 1121570229",
	...
	"notes": [
		...
		"Source : catalogue 2025, page 48, référence 1121570229."
	]
};
