const product = {
	...
	"editorial": {
		"overview": "UNM 220-9-25 WSOF, référence 1129741354, associe une cuve de 24 L à un moteur de 1,5 kW. Le catalogue donne 95 L/min de remplissage sans pression associée, ce qui ne suffit pas à valider un outil. Version avec réduction du bruit publiée par le fabricant.",
		"verifiedFacts": [
			"Pression publiée : 9 bar ; débit aspiré : 230 L/min, distinct du débit restitué.",
			"Poids publié : 24 kg ; dimensions : 616 × 300 × 574 mm.",
			"Cuve : 24 L ; puissance moteur : 1,5 kW ; rotation : 1 420 tr/min.",
		...
		"limitations": [
			...
			"La désignation contient « 25 », mais la colonne cuve du catalogue indique 24 litres : cette dernière valeur est retenue."
		]
	},
	"specifications": [
		{
			"label": "Dimensions largeur × profondeur × hauteur",
			"value": "616 × 300 × 574 mm",
			"evidenceIds": [
				"schneider-2025-1129741354"
			]
		},
		{
	...
	"evidence": [
		{
			"id": "schneider-2025-1129741354",
			"sourceUrl": "https://www.schneider-airsystems.de/content/dam/brands/schneider/documents/catalogs-brochures/Schneider%20airsystems-Gesamtkatalog-2025-DE-SCREEN.pdf#page=41",
			"sourceLabel": "Schneider airsystems, catalogue 2025, p. 41, réf. 1129741354",
	...
	"notes": [
		...
		"Source : catalogue 2025, page 41, référence 1129741354."
	],
	"voltage": "230 V"
};
