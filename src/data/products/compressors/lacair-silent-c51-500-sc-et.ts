const product = {
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/lacair-silent-c51-500-sc-et.webp",
		"alt": "Repères techniques Lacair Silent C51/500 SC-ET, référence 464876",
	...
	"editorial": {
		"overview": "Lacair Silent C51/500 SC-ET, référence 464876 : cuve de 500 L, pression maximale publiée de 10 bar. Le point documenté le plus élevé en pression fournit 718 L/min à 7 bar. Sécheur frigorifique intégré (version SC).",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "lacair-464876-20260926",
			"sourceUrl": "https://s3.eu-west-1.amazonaws.com/s37.lacme.com/crm/Catalogues/LACME%20-%20Catalogue%20Lacair%202026.pdf#page=41",
			"sourceLabel": "Lacair / Lacmé, catalogue 2026, p. 41, réf. 464876",
		...
		{
			"id": "lacair-464876-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"lacair-464876-20260926-lubrification"
		],
		"intakeFlowLpm": [
			"lacair-464876-20260926"
		],
