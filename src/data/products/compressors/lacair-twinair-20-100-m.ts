const product = {
	"id": "lacair-twinair-20-100-m",
	"slug": "lacair-twinair-20-100-m",
	"brand": "Lacair",
	"model": "TwinAir 20/100 M",
	"mpn": "462100",
	"tankLiters": 100,
	"maxPressureBar": 11,
	"fadCurve": [
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/lacair-twinair-20-100-m.webp",
		"alt": "Repères techniques Lacair TwinAir 20/100 M, référence 462100",
	...
	"editorial": {
		"overview": "Lacair TwinAir 20/100 M, référence 462100 : cuve de 100 L, pression maximale publiée de 11 bar. Le point documenté le plus élevé en pression fournit 240 L/min à 6 bar.",
		"verifiedFacts": [
			"Débit restitué publié : 240 L/min à 6 bar.",
			"Pistons lubrifiés. Puissance moteur publiée : 3 kW.",
			"Débit aspiré : 335 L/min, distinct du débit restitué.",
			"Masse nette publiée : 82,5 kg.",
	...
	"evidence": [
		{
			"id": "lacair-462100-20260926",
			"sourceUrl": "https://s3.eu-west-1.amazonaws.com/s37.lacme.com/crm/Catalogues/LACME%20-%20Catalogue%20Lacair%202026.pdf#page=25",
			"sourceLabel": "Lacair / Lacmé, catalogue 2026, p. 25, réf. 462100",
		...
		{
			"id": "lacair-462100-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"lacair-462100-20260926-lubrification"
		],
		"intakeFlowLpm": [
			"lacair-462100-20260926"
		],
