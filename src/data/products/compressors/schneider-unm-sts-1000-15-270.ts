const product = {
	...
	"editorial": {
		"overview": "UNM STS 1000-15-270, référence 1121570230, associe une cuve de 270 L à un moteur de 7,5 kW. Le débit restitué publié est de 790 L/min à 14 bar.",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "schneider-2025-1121570230",
			"sourceUrl": "https://www.schneider-airsystems.de/content/dam/brands/schneider/documents/catalogs-brochures/Schneider%20airsystems-Gesamtkatalog-2025-DE-SCREEN.pdf#page=46",
			"sourceLabel": "Schneider airsystems, catalogue 2025, p. 46, réf. 1121570230",
	...
	"notes": [
		...
		"Source : catalogue 2025, page 46, référence 1121570230."
	]
};
