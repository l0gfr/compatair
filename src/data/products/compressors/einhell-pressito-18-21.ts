const product = {
	...
	image: { src: '/images/products/einhell-pressito-18-21.webp', alt: 'Compresseur sans fil Einhell PRESSITO 18/21', sourceUrl: 'https://www.einhell.fr/p/4020467-pressito-18-21/', sourceLabel: 'Visuel officiel Einhell' },
	...
	fieldSources: { fadCurve: ['einhell-4020467-official'], intakeFlowLpm: ['einhell-4020467-official'], weightKg: ['einhell-4020467-official'], maxPressureBar: ['einhell-4020467-official'] }, notes: ['Profil multipoint constructeur, sans estimation silencieuse.'],
};
