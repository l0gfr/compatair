const product = {
	"id": "fini-micro-5-5-08-270",
	"slug": "fini-micro-5-5-08-270",
	"brand": "Fini",
	"model": "MICRO 5.5-08-270",
	"mpn": "V91JW92FNM701",
	"tankLiters": 270,
	"maxPressureBar": 8,
	"fadCurve": [
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/fini-micro-5-5-08-270.webp",
		"alt": "Repères techniques Fini MICRO 5.5-08-270, référence V91JW92FNM701",
	...
	"editorial": {
		"overview": "Fini MICRO 5.5-08-270, référence V91JW92FNM701 : cuve de 270 L, pression maximale publiée de 8 bar. Le point documenté le plus élevé en pression fournit 720 L/min à 8 bar. Version sans sécheur intégré.",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "fini-v91jw92fnm701-20260926",
			"sourceUrl": "https://finicompressors.com/wp-content/uploads/Catalogo-Micro-Plus_Fini_IT_04-2024_9990394.pdf#page=16",
			"sourceLabel": "Fini, catalogue MICRO / PLUS, édition 04-2024, p. 16, réf. V91JW92FNM701",
		...
		{
			"id": "fini-v91jw92fnm701-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"fini-v91jw92fnm701-20260926-lubrification"
		],
		"powerKw": [
			"fini-v91jw92fnm701-20260926"
		],
