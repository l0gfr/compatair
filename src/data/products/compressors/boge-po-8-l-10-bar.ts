const product = {
	id: 'boge-po-8-l-10-bar',
	slug: 'boge-po-8-l-10-bar',
	brand: 'BOGE',
	model: 'PO 8 L',
	variant: { familyId: 'boge-po-l', label: '10 bar, 668 L/min', distinguishingAttributes: { pression: '10 bar', debitEffectif: '668 L/min', puissance: '5,5 kW' } },
	tankLiters: 0,
	maxPressureBar: 10,
	fadCurve: [{ pressureBar: 8, litersPerMinute: 668 }],
	oilType: 'oil-free',
	powerKw: 5.5,
	weightKg: 187,
	confidence: 'A',
	...
	editorial: {
		overview: 'Le PO 8 L en version 10 bar est un groupe compresseur fixe sans réservoir. BOGE publie 668 L/min de débit d’air effectif à 8 bar.',
		verifiedFacts: ['Le groupe comprime sans huile et développe une puissance moteur de 5,5 kW.', 'Le tableau actuel indique un poids maximal de 187 kg pour cette version 10 bar et distingue le débit effectif du débit aspiré.'],
