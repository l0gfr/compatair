const product = {
	"id": "fini-micro-5-5-13",
	"slug": "fini-micro-5-5-13",
	"brand": "Fini",
	"model": "MICRO 5.5-13",
	"mpn": "V51JM92FNM760",
	"tankLiters": 0,
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/fini-micro-5-5-13.webp",
		"alt": "Repères techniques Fini MICRO 5.5-13, référence V51JM92FNM760",
	...
	"editorial": {
		"overview": "Fini MICRO 5.5-13, référence V51JM92FNM760 : configuration sans cuve intégrée, pression maximale publiée de 13 bar. Le point documenté le plus élevé en pression fournit 485 L/min à 13 bar. Version sans sécheur intégré.",
		"verifiedFacts": [
			"Débit restitué publié : 485 L/min à 13 bar.",
	...
	"evidence": [
		{
			"id": "fini-v51jm92fnm760-20260926",
			"sourceUrl": "https://finicompressors.com/wp-content/uploads/Catalogo-Micro-Plus_Fini_IT_04-2024_9990394.pdf#page=16",
			"sourceLabel": "Fini, catalogue MICRO / PLUS, édition 04-2024, p. 16, réf. V51JM92FNM760",
		...
		{
			"id": "fini-v51jm92fnm760-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"fini-v51jm92fnm760-20260926-lubrification"
		],
		"powerKw": [
			"fini-v51jm92fnm760-20260926"
		],
