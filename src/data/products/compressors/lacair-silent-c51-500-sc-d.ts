const product = {
	"id": "lacair-silent-c51-500-sc-d",
	"slug": "lacair-silent-c51-500-sc-d",
	"brand": "Lacair",
	"model": "Silent C51/500 SC-D",
	"mpn": "464872",
	"tankLiters": 500,
	"maxPressureBar": 10,
	"fadCurve": [
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/lacair-silent-c51-500-sc-d.webp",
		"alt": "Repères techniques Lacair Silent C51/500 SC-D, référence 464872",
	...
	"editorial": {
		"overview": "Lacair Silent C51/500 SC-D, référence 464872 : cuve de 500 L, pression maximale publiée de 10 bar. Le point documenté le plus élevé en pression fournit 718 L/min à 7 bar. Sécheur frigorifique intégré (version SC).",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "lacair-464872-20260926",
			"sourceUrl": "https://s3.eu-west-1.amazonaws.com/s37.lacme.com/crm/Catalogues/LACME%20-%20Catalogue%20Lacair%202026.pdf#page=41",
			"sourceLabel": "Lacair / Lacmé, catalogue 2026, p. 41, réf. 464872",
		...
		{
			"id": "lacair-464872-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"lacair-464872-20260926-lubrification"
		],
		"intakeFlowLpm": [
			"lacair-464872-20260926"
		],
