const product = {
	"id": "fini-micro-se-4-0-10",
	"slug": "fini-micro-se-4-0-10",
	"brand": "Fini",
	"model": "MICRO SE 4.0-10",
	"mpn": "V51JP72FNM760",
	"tankLiters": 0,
	"maxPressureBar": 10,
	"fadCurve": [
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/fini-micro-se-4-0-10.webp",
		"alt": "Repères techniques Fini MICRO SE 4.0-10, référence V51JP72FNM760",
	...
	"editorial": {
		"overview": "Fini MICRO SE 4.0-10, référence V51JP72FNM760 : configuration sans cuve intégrée, pression maximale publiée de 10 bar. Le point documenté le plus élevé en pression fournit 485 L/min à 10 bar. Version sans sécheur intégré.",
		"verifiedFacts": [
			"Débit restitué publié : 485 L/min à 10 bar.",
			"Vis lubrifiée, vitesse fixe. Puissance moteur publiée : 4 kW.",
			"Masse nette publiée : 108 kg."
		],
		"limitations": [
	...
	"evidence": [
		{
			"id": "fini-v51jp72fnm760-20260926",
			"sourceUrl": "https://finicompressors.com/wp-content/uploads/Catalogo-Micro-Plus_Fini_IT_04-2024_9990394.pdf#page=16",
			"sourceLabel": "Fini, catalogue MICRO / PLUS, édition 04-2024, p. 16, réf. V51JP72FNM760",
		...
		{
			"id": "fini-v51jp72fnm760-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"fini-v51jp72fnm760-20260926-lubrification"
		],
		"powerKw": [
			"fini-v51jp72fnm760-20260926"
		],
