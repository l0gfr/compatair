const product = {
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/fini-plus-8-15.webp",
		"alt": "Repères techniques Fini PLUS 8-15, référence V60NI92FNM960",
	...
	"editorial": {
		"overview": "Fini PLUS 8-15, référence V60NI92FNM960 : configuration sans cuve intégrée, pression maximale publiée de 15 bar. Le point documenté le plus élevé en pression fournit 670 L/min à 15 bar. Version sans sécheur intégré.",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "fini-v60ni92fnm960-20260926",
			"sourceUrl": "https://finicompressors.com/wp-content/uploads/Catalogo-Micro-Plus_Fini_IT_04-2024_9990394.pdf#page=17",
			"sourceLabel": "Fini, catalogue MICRO / PLUS, édition 04-2024, p. 17, réf. V60NI92FNM960",
		...
		{
			"id": "fini-v60ni92fnm960-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"fini-v60ni92fnm960-20260926-lubrification"
		],
		"powerKw": [
			"fini-v60ni92fnm960-20260926"
		],
