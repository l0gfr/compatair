const product = {
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/fini-plus-15-15.webp",
		"alt": "Repères techniques Fini PLUS 15-15, référence V60NR92FNM960",
	...
	"editorial": {
		"overview": "Fini PLUS 15-15, référence V60NR92FNM960 : configuration sans cuve intégrée, pression maximale publiée de 15 bar. Le point documenté le plus élevé en pression fournit 1 300 L/min à 15 bar. Version sans sécheur intégré.",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "fini-v60nr92fnm960-20260926",
			"sourceUrl": "https://finicompressors.com/wp-content/uploads/Catalogo-Micro-Plus_Fini_IT_04-2024_9990394.pdf#page=18",
			"sourceLabel": "Fini, catalogue MICRO / PLUS, édition 04-2024, p. 18, réf. V60NR92FNM960",
		...
		{
			"id": "fini-v60nr92fnm960-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"fini-v60nr92fnm960-20260926-lubrification"
		],
		"powerKw": [
			"fini-v60nr92fnm960-20260926"
		],
