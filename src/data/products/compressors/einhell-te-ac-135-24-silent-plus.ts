const product = {
		...
		evidence: [{ id: 'einhell-2024-catalog-135', sourceUrl: 'https://www.einhell.fr/fileadmin/corporate-media/services/catalogues/pdf-en/einhell-services-catalogue-power-tools-2024-en.pdf', sourceLabel: 'Catalogue officiel Einhell 2024', sourceType: 'manufacturer', retrievedAt: '2026-07-13', confidence: 'B' }],
		fieldSources: { mpn: ['einhell-2024-catalog-135'], ean: ['einhell-2024-catalog-135'], tankLiters: ['einhell-2024-catalog-135'], maxPressureBar: ['einhell-2024-catalog-135'], fadCurve: ['einhell-2024-catalog-135'], intakeFlowLpm: ['einhell-2024-catalog-135'], dutyCycle: ['einhell-2024-catalog-135'], oilType: ['einhell-2024-catalog-135'], noiseDb: ['einhell-2024-catalog-135'] }, notes: [],
	};
