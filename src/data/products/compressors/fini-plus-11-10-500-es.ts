const product = {
	"id": "fini-plus-11-10-500-es",
	"slug": "fini-plus-11-10-500-es",
	"brand": "Fini",
	"model": "PLUS 11-10-500 ES",
	"mpn": "V83NM92FNM801",
	"tankLiters": 500,
	"maxPressureBar": 10,
	"fadCurve": [
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/fini-plus-11-10-500-es.webp",
		"alt": "Repères techniques Fini PLUS 11-10-500 ES, référence V83NM92FNM801",
	...
	"editorial": {
		"overview": "Fini PLUS 11-10-500 ES, référence V83NM92FNM801 : cuve de 500 L, pression maximale publiée de 10 bar. Le point documenté le plus élevé en pression fournit 1 500 L/min à 10 bar. Sécheur intégré (version ES).",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "fini-v83nm92fnm801-20260926",
			"sourceUrl": "https://finicompressors.com/wp-content/uploads/Catalogo-Micro-Plus_Fini_IT_04-2024_9990394.pdf#page=17",
			"sourceLabel": "Fini, catalogue MICRO / PLUS, édition 04-2024, p. 17, réf. V83NM92FNM801",
		...
		{
			"id": "fini-v83nm92fnm801-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"fini-v83nm92fnm801-20260926-lubrification"
		],
		"powerKw": [
			"fini-v83nm92fnm801-20260926"
		],
