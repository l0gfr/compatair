const product = {
	"id": "schneider-unm-sts-1250-10-270-xdk",
	"slug": "schneider-unm-sts-1250-10-270-xdk",
	"brand": "Schneider",
	"model": "UNM STS 1250-10-270 XDK",
	"mpn": "1121570206",
	"tankLiters": 270,
	"maxPressureBar": 10,
	"fadCurve": [
	...
	"editorial": {
		"overview": "UNM STS 1250-10-270 XDK, référence 1121570206, associe une cuve de 270 L à un moteur de 7,5 kW. Le débit restitué publié est de 980 L/min à 9 bar. Sécheur frigorifique intégré.",
		"verifiedFacts": [
		...
		"limitations": [
			...
			"Divergence fabricant : la boutique affiche 11 bar tandis que le catalogue indique 10 bar. Le débit à 9 bar reste rattaché uniquement au catalogue."
		]
	},
	"specifications": [
		{
	...
	"evidence": [
		{
			"id": "schneider-2025-1121570206",
			"sourceUrl": "https://www.schneider-airsystems.de/content/dam/brands/schneider/documents/catalogs-brochures/Schneider%20airsystems-Gesamtkatalog-2025-DE-SCREEN.pdf#page=48",
			"sourceLabel": "Schneider airsystems, catalogue 2025, p. 48, réf. 1121570206",
	...
	"notes": [
		...
		"Source : catalogue 2025, page 48, référence 1121570206."
	]
};
