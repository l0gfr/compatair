const product = {
	"id": "schneider-unm-stl-1000-15-500-c",
	"slug": "schneider-unm-stl-1000-15-500-c",
	"brand": "Schneider",
	"model": "UNM STL 1000-15-500 C",
	"mpn": "1121580515",
	"tankLiters": 500,
	"maxPressureBar": 15,
	"fadCurve": [
	...
	"editorial": {
		"overview": "UNM STL 1000-15-500 C, référence 1121580515, associe une cuve de 500 L à un moteur de 7,5 kW. Le débit restitué publié est de 790 L/min à 14 bar. Démarreur étoile-triangle prémonté (version C).",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "schneider-2025-1121580515",
			"sourceUrl": "https://www.schneider-airsystems.de/content/dam/brands/schneider/documents/catalogs-brochures/Schneider%20airsystems-Gesamtkatalog-2025-DE-SCREEN.pdf#page=50",
			"sourceLabel": "Schneider airsystems, catalogue 2025, p. 50, réf. 1121580515",
	...
	"notes": [
		...
		"Source : catalogue 2025, page 50, référence 1121580515."
	]
};
