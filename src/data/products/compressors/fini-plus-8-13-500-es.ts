const product = {
	"id": "fini-plus-8-13-500-es",
	"slug": "fini-plus-8-13-500-es",
	"brand": "Fini",
	"model": "PLUS 8-13-500 ES",
	"mpn": "V83NI92FNM801",
	"tankLiters": 500,
	"maxPressureBar": 13,
	"fadCurve": [
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/fini-plus-8-13-500-es.webp",
		"alt": "Repères techniques Fini PLUS 8-13-500 ES, référence V83NI92FNM801",
	...
	"editorial": {
		"overview": "Fini PLUS 8-13-500 ES, référence V83NI92FNM801 : cuve de 500 L, pression maximale publiée de 13 bar. Le point documenté le plus élevé en pression fournit 750 L/min à 13 bar. Sécheur intégré (version ES).",
		"verifiedFacts": [
			"Débit restitué publié : 750 L/min à 13 bar.",
	...
	"evidence": [
		{
			"id": "fini-v83ni92fnm801-20260926",
			"sourceUrl": "https://finicompressors.com/wp-content/uploads/Catalogo-Micro-Plus_Fini_IT_04-2024_9990394.pdf#page=17",
			"sourceLabel": "Fini, catalogue MICRO / PLUS, édition 04-2024, p. 17, réf. V83NI92FNM801",
		...
		{
			"id": "fini-v83ni92fnm801-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"fini-v83ni92fnm801-20260926-lubrification"
		],
		"powerKw": [
			"fini-v83ni92fnm801-20260926"
		],
