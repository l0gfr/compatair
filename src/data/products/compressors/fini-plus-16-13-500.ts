const product = {
	"id": "fini-plus-16-13-500",
	"slug": "fini-plus-16-13-500",
	"brand": "Fini",
	"model": "PLUS 16-13-500",
	"mpn": "V83NW92FNM701",
	"tankLiters": 500,
	"maxPressureBar": 13,
	"fadCurve": [
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/fini-plus-16-13-500.webp",
		"alt": "Repères techniques Fini PLUS 16-13-500, référence V83NW92FNM701",
	...
	"editorial": {
		"overview": "Fini PLUS 16-13-500, référence V83NW92FNM701 : cuve de 500 L, pression maximale publiée de 13 bar. Le point documenté le plus élevé en pression fournit 1 750 L/min à 13 bar. Version sans sécheur intégré.",
		"verifiedFacts": [
			"Débit restitué publié : 1 750 L/min à 13 bar.",
			"Vis lubrifiée, vitesse fixe. Puissance moteur publiée : 15 kW.",
			"Masse nette publiée : 410 kg."
		],
		"limitations": [
	...
	"evidence": [
		{
			"id": "fini-v83nw92fnm701-20260926",
			"sourceUrl": "https://finicompressors.com/wp-content/uploads/Catalogo-Micro-Plus_Fini_IT_04-2024_9990394.pdf#page=18",
			"sourceLabel": "Fini, catalogue MICRO / PLUS, édition 04-2024, p. 18, réf. V83NW92FNM701",
		...
		{
			"id": "fini-v83nw92fnm701-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"fini-v83nw92fnm701-20260926-lubrification"
		],
		"powerKw": [
			"fini-v83nw92fnm701-20260926"
		],
