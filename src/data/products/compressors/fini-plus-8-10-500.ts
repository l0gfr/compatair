const product = {
	"id": "fini-plus-8-10-500",
	"slug": "fini-plus-8-10-500",
	"brand": "Fini",
	"model": "PLUS 8-10-500",
	"mpn": "V83NH92FNM701",
	"tankLiters": 500,
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/fini-plus-8-10-500.webp",
		"alt": "Repères techniques Fini PLUS 8-10-500, référence V83NH92FNM701",
	...
	"editorial": {
		"overview": "Fini PLUS 8-10-500, référence V83NH92FNM701 : cuve de 500 L, pression maximale publiée de 10 bar. Le point documenté le plus élevé en pression fournit 1 000 L/min à 10 bar. Version sans sécheur intégré.",
		"verifiedFacts": [
			"Débit restitué publié : 1 000 L/min à 10 bar.",
			"Vis lubrifiée, vitesse fixe. Puissance moteur publiée : 7,5 kW.",
			"Masse nette publiée : 334 kg."
		],
		"limitations": [
	...
	"evidence": [
		{
			"id": "fini-v83nh92fnm701-20260926",
			"sourceUrl": "https://finicompressors.com/wp-content/uploads/Catalogo-Micro-Plus_Fini_IT_04-2024_9990394.pdf#page=17",
			"sourceLabel": "Fini, catalogue MICRO / PLUS, édition 04-2024, p. 17, réf. V83NH92FNM701",
		...
		{
			"id": "fini-v83nh92fnm701-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"fini-v83nh92fnm701-20260926-lubrification"
		],
		"powerKw": [
			"fini-v83nh92fnm701-20260926"
		],
