const product = {
	"id": "fini-micro-se-2-2-08-200-es",
	"slug": "fini-micro-se-2-2-08-200-es",
	"brand": "Fini",
	"model": "MICRO SE 2.2-08-200 ES",
	"mpn": "V77JU72FNM801",
	"tankLiters": 200,
	"maxPressureBar": 8,
	"fadCurve": [
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/fini-micro-se-2-2-08-200-es.webp",
		"alt": "Repères techniques Fini MICRO SE 2.2-08-200 ES, référence V77JU72FNM801",
	...
	"editorial": {
		"overview": "Fini MICRO SE 2.2-08-200 ES, référence V77JU72FNM801 : cuve de 200 L, pression maximale publiée de 8 bar. Le point documenté le plus élevé en pression fournit 325 L/min à 8 bar. Sécheur intégré (version ES).",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "fini-v77ju72fnm801-20260926",
			"sourceUrl": "https://finicompressors.com/wp-content/uploads/Catalogo-Micro-Plus_Fini_IT_04-2024_9990394.pdf#page=16",
			"sourceLabel": "Fini, catalogue MICRO / PLUS, édition 04-2024, p. 16, réf. V77JU72FNM801",
		...
		{
			"id": "fini-v77ju72fnm801-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"fini-v77ju72fnm801-20260926-lubrification"
		],
		"powerKw": [
			"fini-v77ju72fnm801-20260926"
		],
