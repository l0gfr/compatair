const product = {
	"id": "schneider-unm-sts-580-15-500",
	"slug": "schneider-unm-sts-580-15-500",
	"brand": "Schneider",
	"model": "UNM STS 580-15-500",
	"mpn": "1121580531",
	"tankLiters": 500,
	"maxPressureBar": 15,
	"fadCurve": [
	...
	"editorial": {
		"overview": "UNM STS 580-15-500, référence 1121580531, associe une cuve de 500 L à un moteur de 4 kW. Le débit restitué publié est de 470 L/min à 14 bar.",
		"verifiedFacts": [
			"Pression publiée : 15 bar ; débit aspiré : 580 L/min, distinct du débit restitué.",
			"Poids publié : 230 kg ; dimensions : 850 × 850 × 1 945 mm.",
	...
	"specifications": [
		{
			...
			"value": "850 × 850 × 1 945 mm",
			"evidenceIds": [
				"schneider-2025-1121580531"
			]
		},
		{
	...
	"evidence": [
		{
			"id": "schneider-2025-1121580531",
			"sourceUrl": "https://www.schneider-airsystems.de/content/dam/brands/schneider/documents/catalogs-brochures/Schneider%20airsystems-Gesamtkatalog-2025-DE-SCREEN.pdf#page=46",
			"sourceLabel": "Schneider airsystems, catalogue 2025, p. 46, réf. 1121580531",
	...
	"notes": [
		...
		"Source : catalogue 2025, page 46, référence 1121580531."
	]
};
