const product = {
	id: 'boge-po-3-l-10-bar',
	slug: 'boge-po-3-l-10-bar',
	brand: 'BOGE',
	model: 'PO 3 L',
	variant: { familyId: 'boge-po-l', label: '10 bar, 246 L/min', distinguishingAttributes: { pression: '10 bar', debitEffectif: '246 L/min', puissance: '2,2 kW' } },
	tankLiters: 0,
	maxPressureBar: 10,
	fadCurve: [{ pressureBar: 8, litersPerMinute: 246 }],
	oilType: 'oil-free',
	powerKw: 2.2,
	weightKg: 164,
	confidence: 'A',
	...
	editorial: {
		overview: 'Le PO 3 L en version 10 bar est un groupe compresseur fixe sans réservoir. BOGE publie 246 L/min de débit d’air effectif à 8 bar.',
		verifiedFacts: ['Le groupe comprime sans huile et développe une puissance moteur de 2,2 kW.', 'Le tableau actuel indique un poids maximal de 164 kg pour cette version 10 bar et distingue le débit effectif du débit aspiré.'],
	...
	notes: ['Point de débit restitué : 246 L/min à 8 bar, car BOGE mesure le débit effectif à 80 % des 10 bar maximaux.'],
};
