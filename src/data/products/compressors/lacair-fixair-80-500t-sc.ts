const product = {
	...
	"status": "unknown",
	"image": {
		"src": "/images/products/lacair-fixair-80-500t-sc.webp",
		"alt": "Repères techniques Lacair FixAir 80/500T-SC, référence 465850",
	...
	"editorial": {
		"overview": "Lacair FixAir 80/500T-SC, référence 465850 : cuve de 500 L, pression maximale publiée de 12 bar. Le point documenté le plus élevé en pression fournit 1 165 L/min à 6 bar. Sécheur frigorifique intégré (version SC).",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "lacair-465850-20260926",
			"sourceUrl": "https://s3.eu-west-1.amazonaws.com/s37.lacme.com/crm/Catalogues/LACME%20-%20Catalogue%20Lacair%202026.pdf#page=35",
			"sourceLabel": "Lacair / Lacmé, catalogue 2026, p. 35, réf. 465850",
		...
		{
			"id": "lacair-465850-20260926-lubrification",
	...
	"fieldSources": {
		...
		"oilType": [
			"lacair-465850-20260926-lubrification"
		],
		"intakeFlowLpm": [
			"lacair-465850-20260926"
		],
