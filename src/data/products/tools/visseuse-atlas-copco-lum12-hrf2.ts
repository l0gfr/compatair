...
const product = {
  "id": "atlas-copco-8431026931",
  "slug": "visseuse-atlas-copco-lum12-hrf2",
  "categoryId": "visseuse",
  "category": "Visseuse pneumatique",
  "label": "Visseuse pneumatique Atlas Copco LUM12 HRF2",
  "brand": "Atlas Copco",
  "model": "LUM12 HRF2",
  "mpn": "8431026931",
  "variant": {
  ...
  "image": {
    "src": "/images/products/atlas-copco-8431026931-technical.webp",
    "alt": "Atlas Copco LUM12 HRF2, référence 8431026931 : 360 L/min à vide, référence 6,3 bar",
    "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/lum12-hrf2-sku8431026931",
    "sourceLabel": "Repères techniques CompatAir d’après Atlas Copco"
  },
  "editorial": {
    "overview": "Atlas Copco LUM12 HRF2, référence 8431026931, demande 360 L/min à vide selon la fiche fabricant. Le dimensionnement utilise la pression de référence de 6,3 bar documentée dans le catalogue Industrial Tools and Solutions UK. Vitesse à vide : 1650 tr/min. Couple maximal de la plage : 2,5 Nm.",
    "verifiedFacts": [
      "Vitesse à vide : 1650 tr/min.",
      "Couple maximal de la plage : 2,5 Nm.",
      "Couple minimal de la plage : 0,6 Nm.",
  ...
  "specifications": [
    {
      ...
      "value": "1650 tr/min",
      "evidenceIds": [
        "atlas-copco-8431026931-fiche-fabricant"
      ]
    },
    {
    ...
    },
    {
      ...
      "value": "6,3 bar",
      "evidenceIds": [
        "atlas-copco-8431026931-catalogue-uk"
      ]
    }
  ],
  "evidence": [
    {
      "id": "atlas-copco-8431026931-fiche-fabricant",
      "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/lum12-hrf2-sku8431026931",
      "sourceLabel": "Atlas Copco, LUM12 HRF2, 8431026931",
    ...
    {
      "id": "atlas-copco-8431026931-catalogue-uk",
      ...
      "retrievedAt": "2026-09-26",
      "confidence": "A",
      "notes": "Référence 8431026931 présente au tableau. Conditions générales : air détendu à la pression atmosphérique, pression de travail 6,3 bar sauf exception. Le millésime de cette édition n’est pas affirmé."
    }
  ],
  "fieldSources": {
    "mpn": [
