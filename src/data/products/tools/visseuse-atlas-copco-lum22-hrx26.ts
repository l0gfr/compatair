...
const product = {
  "id": "atlas-copco-8431026939",
  "slug": "visseuse-atlas-copco-lum22-hrx26",
  "categoryId": "visseuse",
  "category": "Visseuse pneumatique",
  "label": "Visseuse pneumatique Atlas Copco LUM22 HRX26",
  "brand": "Atlas Copco",
  "model": "LUM22 HRX26",
  "mpn": "8431026939",
  "variant": {
    ...
    "distinguishingAttributes": {
      ...
      "Couple maximal de la plage": "26 Nm",
      "Couple minimal de la plage": "3 Nm",
      "Couple maximal sur assemblage élastique": "26 Nm",
      "Couple minimal sur assemblage élastique": "3 Nm",
      "Masse": "1,2 kg",
      "Longueur": "233 mm",
      "Dimension de sortie": "Special design",
  ...
  "image": {
    "src": "/images/products/atlas-copco-8431026939-technical.webp",
    "alt": "Atlas Copco LUM22 HRX26, référence 8431026939 : 540 L/min à vide, référence 6,3 bar",
    "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/lum22-hrx26-sku8431026939",
    "sourceLabel": "Repères techniques CompatAir d’après Atlas Copco"
  },
  "editorial": {
    "overview": "Atlas Copco LUM22 HRX26, référence 8431026939, demande 540 L/min à vide selon la fiche fabricant. Le dimensionnement utilise la pression de référence de 6,3 bar documentée dans le catalogue Industrial Tools and Solutions UK. Vitesse à vide : 220 tr/min. Couple maximal de la plage : 26 Nm.",
    "verifiedFacts": [
      "Vitesse à vide : 220 tr/min.",
      "Couple maximal de la plage : 26 Nm.",
      "Couple minimal de la plage : 3 Nm.",
  ...
  "specifications": [
    {
      ...
      "value": "220 tr/min",
      "evidenceIds": [
        "atlas-copco-8431026939-fiche-fabricant"
      ]
    },
    {
    ...
    },
    {
      ...
      "value": "6,3 bar",
      "evidenceIds": [
        "atlas-copco-8431026939-catalogue-uk"
      ]
    }
  ],
  "evidence": [
    {
      "id": "atlas-copco-8431026939-fiche-fabricant",
      "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/lum22-hrx26-sku8431026939",
      "sourceLabel": "Atlas Copco, LUM22 HRX26, 8431026939",
    ...
    {
      "id": "atlas-copco-8431026939-catalogue-uk",
      ...
      "retrievedAt": "2026-09-26",
      "confidence": "A",
      "notes": "Référence 8431026939 présente au tableau. Conditions générales : air détendu à la pression atmosphérique, pression de travail 6,3 bar sauf exception. Le millésime de cette édition n’est pas affirmé."
    }
  ],
  "fieldSources": {
    "mpn": [
