const product = {
	...
	"label": "Meuleuse pneumatique Fuji FG-3H-5F 1-4 N",
	"brand": "Fuji",
	"model": "FG-3H-5F 1-4 N",
	"mpn": "5412052831",
	"distributorSkus": [],
	"identifierAliases": [],
	"variant": {
		"familyId": "fuji-449527",
		"label": "FG-3H-5F 1-4 N",
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/fuji-fg-3h-5f-1-4-n-technical.webp",
		"alt": "Repères techniques Fuji FG-3H-5F 1-4 N : 552 L/min en charge, pression de travail 6,3 bar",
		"sourceUrl": "https://www.fujitools.com/en/products/5412052831",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche et la notice Fuji"
	},
	"editorial": {
		"overview": "Fuji FG-3H-5F 1-4 N, référence 5412052831, présente une consommation en charge de 9,2 L/s, soit 552 L/min. La notice liée à cette fiche indique une pression de travail de 6,3 bar. Puissance maximale de l’outil : 52 W. Capacité de la pince (mm) : 6.35.",
		"verifiedFacts": [
			"Puissance maximale de l’outil : 52 W.",
			"Capacité de la pince (mm) : 6.35.",
			"Distance du bord à l’axe : 24 mm.",
	...
	"evidence": [
		{
			"id": "fuji-5412052831-official",
			"sourceUrl": "https://www.fujitools.com/en/products/5412052831",
			"sourceLabel": "Fuji, fiche officielle FG-3H-5F 1-4 N, réf. 5412052831",
		...
		{
			"id": "fuji-5412052831-pressure-notice",
	...
	"fieldSources": {
		...
		"workingPressureBar": [
			"fuji-5412052831-pressure-notice"
		],
		"connectorSize": [
			"fuji-5412052831-official"
		],
