const product = {
	...
	"label": "Meuleuse pneumatique Fuji FA-3CK-2",
	"brand": "Fuji",
	"model": "FA-3CK-2",
	"mpn": "5412071111",
	"distributorSkus": [],
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/fuji-fa-3ck-2-technical.webp",
		"alt": "Repères techniques Fuji FA-3CK-2 : 1 260 L/min en charge, pression de travail 6,3 bar",
		"sourceUrl": "https://www.fujitools.com/en/products/5412071111",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche et la notice Fuji"
	},
	"editorial": {
		"overview": "Fuji FA-3CK-2, référence 5412071111, présente une consommation en charge de 21 L/s, soit 1 260 L/min. La notice liée à cette fiche indique une pression de travail de 6,3 bar. Vitesse à vide : 13500 tr/min. Puissance maximale de l’outil : 290 W.",
		"verifiedFacts": [
			"Vitesse à vide : 13500 tr/min.",
			"Puissance maximale de l’outil : 290 W.",
			"Filetage de sortie : M8.",
	...
	"evidence": [
		{
			"id": "fuji-5412071111-official",
			"sourceUrl": "https://www.fujitools.com/en/products/5412071111",
			"sourceLabel": "Fuji, fiche officielle FA-3CK-2, réf. 5412071111",
		...
		{
			"id": "fuji-5412071111-pressure-notice",
	...
	"fieldSources": {
		...
		"workingPressureBar": [
			"fuji-5412071111-pressure-notice"
		],
		"connectorSize": [
			"fuji-5412071111-official"
		],
