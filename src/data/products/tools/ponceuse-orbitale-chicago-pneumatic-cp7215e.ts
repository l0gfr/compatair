const product = {
	"id": "chicago-pneumatic-cp7215e",
	"slug": "ponceuse-orbitale-chicago-pneumatic-cp7215e",
	"categoryId": "ponceuse-orbitale",
	"category": "Ponceuse orbitale pneumatique",
	"label": "Ponceuse orbitale pneumatique Chicago Pneumatic CP7215E",
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/chicago-pneumatic-cp7215e.webp",
		"alt": "Repères techniques CP7215E : 456 L/min en charge, 6,3 bar, flexible 10 mm",
		"sourceUrl": "https://tools.cp.com/en/products/sanders/cp7215e-sku8941272151",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche Chicago Pneumatic"
	},
	"editorial": {
		"overview": "CP7215E, référence fabricant 8941272151, demande 456 L/min en charge (7,6 L/s). La fiche Chicago Pneumatic indique une pression dynamique maximale de 6,3 bar, retenue comme point de comparaison. Vitesse à vide : 12000 tr/min.",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "cp-8941272151-official",
			"sourceUrl": "https://tools.cp.com/en/products/sanders/cp7215e-sku8941272151",
			"sourceLabel": "Chicago Pneumatic, fiche officielle CP7215E, réf. 8941272151",
