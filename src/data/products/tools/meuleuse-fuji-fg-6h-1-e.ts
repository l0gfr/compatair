const product = {
	"id": "fuji-fg-6h-1-e",
	"slug": "meuleuse-fuji-fg-6h-1-e",
	"categoryId": "meuleuse",
	"category": "Meuleuse pneumatique",
	"label": "Meuleuse pneumatique Fuji FG-6H-1 E",
	"brand": "Fuji",
	"model": "FG-6H-1 E",
	"mpn": "5412052941",
	"distributorSkus": [],
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/fuji-fg-6h-1-e-technical.webp",
		"alt": "Repères techniques Fuji FG-6H-1 E : 1 200 L/min en charge, pression de travail 6,3 bar",
		"sourceUrl": "https://www.fujitools.com/en/products/5412052941",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche et la notice Fuji"
	},
	"editorial": {
		"overview": "Fuji FG-6H-1 E, référence 5412052941, présente une consommation en charge de 20 L/s, soit 1 200 L/min. La notice liée à cette fiche indique une pression de travail de 6,3 bar. Vitesse à vide : 6300 tr/min. Puissance maximale de l’outil : 1040 W.",
		"verifiedFacts": [
			"Vitesse à vide : 6300 tr/min.",
			"Puissance maximale de l’outil : 1040 W.",
			"Filetage de sortie : 5/8-11 UNC.",
	...
	"evidence": [
		{
			"id": "fuji-5412052941-official",
			"sourceUrl": "https://www.fujitools.com/en/products/5412052941",
			"sourceLabel": "Fuji, fiche officielle FG-6H-1 E, réf. 5412052941",
		...
		{
			"id": "fuji-5412052941-pressure-notice",
	...
	"fieldSources": {
		...
		"workingPressureBar": [
			"fuji-5412052941-pressure-notice"
		],
		"connectorSize": [
			"fuji-5412052941-official"
		],
