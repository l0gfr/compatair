const product = {
	"id": "chicago-pneumatic-cp7782-sp6",
	"slug": "cle-a-chocs-chicago-pneumatic-cp7782-sp6",
	"categoryId": "cle-a-chocs",
	"category": "Clé à chocs",
	"label": "Clé à chocs Chicago Pneumatic CP7782-SP6",
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/chicago-pneumatic-cp7782-sp6.webp",
		"alt": "Repères techniques CP7782-SP6 : 1 140 L/min en charge, 6,3 bar, flexible 13 mm",
		"sourceUrl": "https://tools.cp.com/en/products/impactwrenches/cp7782-sp6-sku8941077821",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche Chicago Pneumatic"
	},
	"editorial": {
		"overview": "CP7782-SP6, référence fabricant 8941077821, demande 1 140 L/min en charge (19 L/s). La fiche Chicago Pneumatic indique une pression dynamique maximale de 6,3 bar, retenue comme point de comparaison. Vitesse à vide : 5200 tr/min.",
		"verifiedFacts": [
			"Vitesse à vide : 5200 tr/min.",
			"Couple maximal en marche arrière : 2600 Nm.",
			"Couple de travail maximal en marche avant : 2000 Nm.",
	...
	"evidence": [
		{
			"id": "cp-8941077821-official",
			"sourceUrl": "https://tools.cp.com/en/products/impactwrenches/cp7782-sp6-sku8941077821",
			"sourceLabel": "Chicago Pneumatic, fiche officielle CP7782-SP6, réf. 8941077821",
