const product = {
	"id": "fuji-frd-5s-1",
	"slug": "perceuse-fuji-frd-5s-1",
	"categoryId": "perceuse",
	"category": "Perceuse pneumatique",
	"label": "Perceuse pneumatique Fuji FRD-5S-1",
	"brand": "Fuji",
	"model": "FRD-5S-1",
	"mpn": "5412072177",
	"distributorSkus": [],
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/fuji-frd-5s-1-technical.webp",
		"alt": "Repères techniques Fuji FRD-5S-1 : 600 L/min en charge, pression de travail 6,3 bar",
		"sourceUrl": "https://www.fujitools.com/en/products/5412072177",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche et la notice Fuji"
	},
	"editorial": {
		"overview": "Fuji FRD-5S-1, référence 5412072177, présente une consommation en charge de 10 L/s, soit 600 L/min. La notice liée à cette fiche indique une pression de travail de 6,3 bar. Vitesse à vide : 3200 tr/min. Puissance maximale de l’outil : 180 W.",
		"verifiedFacts": [
			"Vitesse à vide : 3200 tr/min.",
			"Puissance maximale de l’outil : 180 W.",
			"Capacité maximale du mandrin (mm) : 6.5.",
	...
	"evidence": [
		{
			"id": "fuji-5412072177-official",
			"sourceUrl": "https://www.fujitools.com/en/products/5412072177",
			"sourceLabel": "Fuji, fiche officielle FRD-5S-1, réf. 5412072177",
		...
		{
			"id": "fuji-5412072177-pressure-notice",
	...
	"fieldSources": {
		...
		"workingPressureBar": [
			"fuji-5412072177-pressure-notice"
		],
		"connectorSize": [
			"fuji-5412072177-official"
		],
