...
const product = {
  "id": "atlas-copco-8426110113",
  "slug": "marteau-a-river-atlas-copco-rrn11p-02",
  "categoryId": "marteau-a-river",
  "category": "Marteau à river pneumatique",
  "label": "Marteau à river pneumatique Atlas Copco RRN11P-02",
  "brand": "Atlas Copco",
  "model": "RRN11P-02",
  "mpn": "8426110113",
  "variant": {
  ...
  "image": {
    "src": "/images/products/atlas-copco-8426110113-technical.webp",
    "alt": "Atlas Copco RRN11P-02, référence 8426110113 : 204 L/min publiée, référence 6,3 bar",
    "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/material-removal-tools/riveting-systems/rrn11p-02-sku8426110113",
    "sourceLabel": "Repères techniques CompatAir d’après Atlas Copco"
  },
  "editorial": {
    "overview": "Atlas Copco RRN11P-02, référence 8426110113, demande 204 L/min publiée selon la fiche fabricant. Le dimensionnement utilise la pression de référence de 6,3 bar documentée dans le catalogue Industrial Tools and Solutions UK. Masse : 1,2 kg. Diamètre du piston : 15 mm.",
    "verifiedFacts": [
      "Masse : 1,2 kg.",
      "Diamètre du piston : 15 mm.",
      "Course du piston : 40 mm.",
  ...
  "specifications": [
    {
      ...
      "value": "1,2 kg",
      "evidenceIds": [
        "atlas-copco-8426110113-fiche-fabricant"
      ]
    },
    {
    ...
    },
    {
      ...
      "value": "6,3 bar",
      "evidenceIds": [
        "atlas-copco-8426110113-catalogue-uk"
      ]
    }
  ],
  "evidence": [
    {
      "id": "atlas-copco-8426110113-fiche-fabricant",
      "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/material-removal-tools/riveting-systems/rrn11p-02-sku8426110113",
      "sourceLabel": "Atlas Copco, RRN11P-02, 8426110113",
    ...
    {
      "id": "atlas-copco-8426110113-catalogue-uk",
      ...
      "retrievedAt": "2026-09-26",
      "confidence": "A",
      "notes": "Référence 8426110113 présente au tableau. Conditions générales : air détendu à la pression atmosphérique, pression de travail 6,3 bar sauf exception. Le millésime de cette édition n’est pas affirmé."
    }
  ],
  "fieldSources": {
    "mpn": [
