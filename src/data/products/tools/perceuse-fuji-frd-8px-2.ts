const product = {
	"id": "fuji-frd-8px-2",
	"slug": "perceuse-fuji-frd-8px-2",
	"categoryId": "perceuse",
	"category": "Perceuse pneumatique",
	"label": "Perceuse pneumatique Fuji FRD-8PX-2",
	"brand": "Fuji",
	"model": "FRD-8PX-2",
	"mpn": "5412072237",
	"distributorSkus": [],
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/fuji-frd-8px-2-technical.webp",
		"alt": "Repères techniques Fuji FRD-8PX-2 : 780 L/min en charge, pression de travail 6,3 bar",
		"sourceUrl": "https://www.fujitools.com/en/products/5412072237",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche et la notice Fuji"
	},
	"editorial": {
		"overview": "Fuji FRD-8PX-2, référence 5412072237, présente une consommation en charge de 13 L/s, soit 780 L/min. La notice liée à cette fiche indique une pression de travail de 6,3 bar. Vitesse à vide : 1300 tr/min. Puissance maximale de l’outil : 440 W.",
		"verifiedFacts": [
			"Vitesse à vide : 1300 tr/min.",
			"Puissance maximale de l’outil : 440 W.",
			"Capacité maximale du mandrin (mm) : 10.",
	...
	"evidence": [
		{
			"id": "fuji-5412072237-official",
			"sourceUrl": "https://www.fujitools.com/en/products/5412072237",
			"sourceLabel": "Fuji, fiche officielle FRD-8PX-2, réf. 5412072237",
		...
		{
			"id": "fuji-5412072237-pressure-notice",
	...
	"fieldSources": {
		...
		"workingPressureBar": [
			"fuji-5412072237-pressure-notice"
		],
		"connectorSize": [
			"fuji-5412072237-official"
		],
