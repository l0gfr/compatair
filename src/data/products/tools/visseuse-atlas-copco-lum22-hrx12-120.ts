...
const product = {
  "id": "atlas-copco-8431028028",
  "slug": "visseuse-atlas-copco-lum22-hrx12-120",
  "categoryId": "visseuse",
  "category": "Visseuse pneumatique",
  "label": "Visseuse pneumatique Atlas Copco LUM22 HRX12-120",
  "brand": "Atlas Copco",
  "model": "LUM22 HRX12-120",
  "mpn": "8431028028",
  "variant": {
    "familyId": "atlas-copco-6696296459",
    "label": "LUM22 HRX12-120",
    "distinguishingAttributes": {
      "Vitesse à vide": "120 tr/min",
  ...
  "image": {
    "src": "/images/products/atlas-copco-8431028028-technical.webp",
    "alt": "Atlas Copco LUM22 HRX12-120, référence 8431028028 : 540 L/min à vide, référence 6,3 bar",
    "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/lum22-hrx12-120-sku8431028028",
    "sourceLabel": "Repères techniques CompatAir d’après Atlas Copco"
  },
  "editorial": {
    "overview": "Atlas Copco LUM22 HRX12-120, référence 8431028028, demande 540 L/min à vide selon la fiche fabricant. Le dimensionnement utilise la pression de référence de 6,3 bar documentée dans le catalogue Industrial Tools and Solutions UK. Vitesse à vide : 120 tr/min. Couple maximal de la plage : 12,5 Nm.",
    "verifiedFacts": [
      "Vitesse à vide : 120 tr/min.",
      "Couple maximal de la plage : 12,5 Nm.",
      "Couple minimal de la plage : 3,5 Nm.",
  ...
  "specifications": [
    {
      ...
      "value": "120 tr/min",
      "evidenceIds": [
        "atlas-copco-8431028028-fiche-fabricant"
      ]
    },
    {
    ...
    },
    {
      ...
      "value": "6,3 bar",
      "evidenceIds": [
        "atlas-copco-8431028028-catalogue-uk"
      ]
    }
  ],
  "evidence": [
    {
      "id": "atlas-copco-8431028028-fiche-fabricant",
      "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/lum22-hrx12-120-sku8431028028",
      "sourceLabel": "Atlas Copco, LUM22 HRX12-120, 8431028028",
    ...
    {
      "id": "atlas-copco-8431028028-catalogue-uk",
      ...
      "retrievedAt": "2026-09-26",
      "confidence": "A",
      "notes": "Référence 8431028028 présente au tableau. Conditions générales : air détendu à la pression atmosphérique, pression de travail 6,3 bar sauf exception. Le millésime de cette édition n’est pas affirmé."
    }
  ],
  "fieldSources": {
    "mpn": [
