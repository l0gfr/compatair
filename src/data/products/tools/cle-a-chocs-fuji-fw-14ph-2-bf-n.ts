const product = {
	"id": "fuji-fw-14ph-2-bf-n",
	"slug": "cle-a-chocs-fuji-fw-14ph-2-bf-n",
	"categoryId": "cle-a-chocs",
	"category": "Clé à chocs",
	"label": "Clé à chocs Fuji FW-14PH-2 BF N",
	"brand": "Fuji",
	"model": "FW-14PH-2 BF N",
	"mpn": "5412053541",
	"distributorSkus": [],
	"identifierAliases": [],
	"variant": {
		"familyId": "fuji-449578",
		"label": "FW-14PH-2 BF N",
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/fuji-fw-14ph-2-bf-n-technical.webp",
		"alt": "Repères techniques Fuji FW-14PH-2 BF N : 594 L/min en charge, pression de travail 6,3 bar",
		"sourceUrl": "https://www.fujitools.com/en/products/5412053541",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche et la notice Fuji"
	},
	"editorial": {
		"overview": "Fuji FW-14PH-2 BF N, référence 5412053541, présente une consommation en charge de 9,9 L/s, soit 594 L/min. La notice liée à cette fiche indique une pression de travail de 6,3 bar. Vitesse à vide : 7500 tr/min. Carré d’entraînement (pouces) : 1/2.",
		"verifiedFacts": [
			"Vitesse à vide : 7500 tr/min.",
			"Carré d’entraînement (pouces) : 1/2.",
			"Forme de la poignée : Pistol.",
	...
	"evidence": [
		{
			"id": "fuji-5412053541-official",
			"sourceUrl": "https://www.fujitools.com/en/products/5412053541",
			"sourceLabel": "Fuji, fiche officielle FW-14PH-2 BF N, réf. 5412053541",
		...
		{
			"id": "fuji-5412053541-pressure-notice",
	...
	"fieldSources": {
		...
		"workingPressureBar": [
			"fuji-5412053541-pressure-notice"
		],
		"connectorSize": [
			"fuji-5412053541-official"
		],
