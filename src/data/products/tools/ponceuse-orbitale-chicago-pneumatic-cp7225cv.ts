const product = {
	...
	"label": "Ponceuse orbitale pneumatique Chicago Pneumatic CP7225CV",
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/chicago-pneumatic-cp7225cv-catalogue-2026.webp",
		"alt": "Repères techniques CP7225CV : 456 L/min en charge à 6,3 bar",
	...
	"editorial": {
		"overview": "CP7225CV, référence 8941072253, demande 456 L/min en charge à 6,3 bar selon le catalogue Chicago Pneumatic v6.08.2026, page 171. Vitesse à vide : 12 000 tr/min. Puissance de l’outil : 210 W.",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "cp-catalog-202608-8941072253",
			"sourceUrl": "https://tools.cp.com/content/dam/pim/itba/cp/literature/catalogs/General-Industry_catalog_CP_EN.pdf#page=171",
			"sourceLabel": "Chicago Pneumatic, catalogue v6.08.2026, p. 171, réf. 8941072253",
	...
	"notes": [
		...
		"Source versionnée : catalogue v6.08.2026, page 171, référence 8941072253."
	],
