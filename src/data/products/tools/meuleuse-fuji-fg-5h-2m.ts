const product = {
	"id": "fuji-fg-5h-2m",
	"slug": "meuleuse-fuji-fg-5h-2m",
	"categoryId": "meuleuse",
	"category": "Meuleuse pneumatique",
	"label": "Meuleuse pneumatique Fuji FG-5H-2M",
	"brand": "Fuji",
	"model": "FG-5H-2M",
	"mpn": "5412052870",
	"distributorSkus": [],
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/fuji-fg-5h-2m-technical.webp",
		"alt": "Repères techniques Fuji FG-5H-2M : 960 L/min en charge, pression de travail 6,3 bar",
		"sourceUrl": "https://www.fujitools.com/en/products/5412052870",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche et la notice Fuji"
	},
	"editorial": {
		"overview": "Fuji FG-5H-2M, référence 5412052870, présente une consommation en charge de 16 L/s, soit 960 L/min. La notice liée à cette fiche indique une pression de travail de 6,3 bar. Vitesse à vide : 7600 tr/min. Puissance maximale de l’outil : 960 W.",
		"verifiedFacts": [
			"Vitesse à vide : 7600 tr/min.",
			"Puissance maximale de l’outil : 960 W.",
			"Filetage de sortie : 5/8-11 UNF.",
	...
	"evidence": [
		{
			"id": "fuji-5412052870-official",
			"sourceUrl": "https://www.fujitools.com/en/products/5412052870",
			"sourceLabel": "Fuji, fiche officielle FG-5H-2M, réf. 5412052870",
		...
		{
			"id": "fuji-5412052870-pressure-notice",
	...
	"fieldSources": {
		...
		"workingPressureBar": [
			"fuji-5412052870-pressure-notice"
		],
		"connectorSize": [
			"fuji-5412052870-official"
		],
