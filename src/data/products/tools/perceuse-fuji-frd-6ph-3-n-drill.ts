const product = {
	"id": "fuji-frd-6ph-3-n-drill",
	"slug": "perceuse-fuji-frd-6ph-3-n-drill",
	"categoryId": "perceuse",
	"category": "Perceuse pneumatique",
	"label": "Perceuse pneumatique Fuji FRD-6PH-3 N DRILL",
	"brand": "Fuji",
	"model": "FRD-6PH-3 N DRILL",
	"mpn": "5412078455",
	"distributorSkus": [],
	"identifierAliases": [],
	"variant": {
		"familyId": "fuji-449439",
		"label": "FRD-6PH-3 N DRILL",
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/fuji-frd-6ph-3-n-drill-technical.webp",
		"alt": "Repères techniques Fuji FRD-6PH-3 N DRILL : 600 L/min en charge, pression de travail 6,3 bar",
		"sourceUrl": "https://www.fujitools.com/en/products/5412078455",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche et la notice Fuji"
	},
	"editorial": {
		"overview": "Fuji FRD-6PH-3 N DRILL, référence 5412078455, présente une consommation en charge de 10 L/s, soit 600 L/min. La notice liée à cette fiche indique une pression de travail de 6,3 bar. Vitesse à vide : 2800 tr/min. Puissance maximale de l’outil : 340 W.",
		"verifiedFacts": [
			"Vitesse à vide : 2800 tr/min.",
			"Puissance maximale de l’outil : 340 W.",
			"Capacité maximale du mandrin (mm) : 6.5.",
			"Montage du mandrin : Jacobs Taper 1.",
			"Entrée 1/4 pouce NPT ; flexible de 10 mm de diamètre intérieur sur 5 m."
		],
		"limitations": [
	...
	"evidence": [
		{
			"id": "fuji-5412078455-official",
			"sourceUrl": "https://www.fujitools.com/en/products/5412078455",
			"sourceLabel": "Fuji, fiche officielle FRD-6PH-3 N DRILL, réf. 5412078455",
		...
		{
			"id": "fuji-5412078455-pressure-notice",
	...
	"fieldSources": {
		...
		"workingPressureBar": [
			"fuji-5412078455-pressure-notice"
		],
		"connectorSize": [
			"fuji-5412078455-official"
		],
