const product = {
	...
	"label": "Meuleuse pneumatique Fuji FG-3H-5 1/4 E",
	"brand": "Fuji",
	"model": "FG-3H-5 1/4 E",
	"mpn": "5412052829",
	"distributorSkus": [],
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/fuji-fg-3h-5-1-4-e-technical.webp",
		"alt": "Repères techniques Fuji FG-3H-5 1/4 E : 552 L/min en charge, pression de travail 6,3 bar",
		"sourceUrl": "https://www.fujitools.com/en/products/5412052829",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche et la notice Fuji"
	},
	"editorial": {
		"overview": "Fuji FG-3H-5 1/4 E, référence 5412052829, présente une consommation en charge de 9,2 L/s, soit 552 L/min. La notice liée à cette fiche indique une pression de travail de 6,3 bar. Puissance maximale de l’outil : 52 W. Capacité de la pince (mm) : 6.35.",
		"verifiedFacts": [
			"Puissance maximale de l’outil : 52 W.",
			"Capacité de la pince (mm) : 6.35.",
			"Distance du bord à l’axe : 24 mm.",
	...
	"evidence": [
		{
			"id": "fuji-5412052829-official",
			"sourceUrl": "https://www.fujitools.com/en/products/5412052829",
			"sourceLabel": "Fuji, fiche officielle FG-3H-5 1/4 E, réf. 5412052829",
		...
		{
			"id": "fuji-5412052829-pressure-notice",
	...
	"fieldSources": {
		...
		"workingPressureBar": [
			"fuji-5412052829-pressure-notice"
		],
		"connectorSize": [
			"fuji-5412052829-official"
		],
