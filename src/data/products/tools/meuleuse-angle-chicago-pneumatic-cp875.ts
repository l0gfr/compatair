const product = {
	id: 'chicago-pneumatic-cp875', slug: 'meuleuse-angle-chicago-pneumatic-cp875', categoryId: 'meuleuse', category: 'Meuleuse d’angle', label: 'Meuleuse d’angle pneumatique Chicago Pneumatic CP875', brand: 'Chicago Pneumatic', model: 'CP875', mpn: 'T023995',
	...
	image: { src: '/images/products/chicago-pneumatic-cp875.webp', alt: 'Meuleuse pneumatique Chicago Pneumatic CP875', sourceUrl: 'https://tools.cp.com/en/products/grinders/cp875-skuT023995', sourceLabel: 'Visuel officiel Chicago Pneumatic' },
