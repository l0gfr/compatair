...
const product = {
  "id": "atlas-copco-8431027800",
  "slug": "visseuse-atlas-copco-ltv009-r025-q",
  "categoryId": "visseuse",
  "category": "Visseuse pneumatique",
  "label": "Visseuse pneumatique Atlas Copco LTV009 R025-Q",
  "brand": "Atlas Copco",
  "model": "LTV009 R025-Q",
  "mpn": "8431027800",
  "variant": {
  ...
  "image": {
    "src": "/images/products/atlas-copco-8431027800-technical.webp",
    "alt": "Atlas Copco LTV009 R025-Q, référence 8431027800 : 360 L/min à vide, référence 6,3 bar",
    "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/ltv009-r025-q-sku8431027800",
    "sourceLabel": "Repères techniques CompatAir d’après Atlas Copco"
  },
  "editorial": {
    "overview": "Atlas Copco LTV009 R025-Q, référence 8431027800, demande 360 L/min à vide selon la fiche fabricant. Le dimensionnement utilise la pression de référence de 6,3 bar documentée dans le catalogue Industrial Tools and Solutions UK. Vitesse à vide : 1650 tr/min. Couple maximal de la plage : 2,5 Nm.",
    "verifiedFacts": [
      "Vitesse à vide : 1650 tr/min.",
      "Couple maximal de la plage : 2,5 Nm.",
      "Couple minimal de la plage : 0,6 Nm.",
  ...
  "specifications": [
    {
      ...
      "value": "1650 tr/min",
      "evidenceIds": [
        "atlas-copco-8431027800-fiche-fabricant"
      ]
    },
    {
    ...
    },
    {
      ...
      "value": "6,3 bar",
      "evidenceIds": [
        "atlas-copco-8431027800-catalogue-uk"
      ]
    }
  ],
  "evidence": [
    {
      "id": "atlas-copco-8431027800-fiche-fabricant",
      "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/ltv009-r025-q-sku8431027800",
      "sourceLabel": "Atlas Copco, LTV009 R025-Q, 8431027800",
    ...
    {
      "id": "atlas-copco-8431027800-catalogue-uk",
      ...
      "retrievedAt": "2026-09-26",
      "confidence": "A",
      "notes": "Référence 8431027800 présente au tableau. Conditions générales : air détendu à la pression atmosphérique, pression de travail 6,3 bar sauf exception. Le millésime de cette édition n’est pas affirmé."
    }
  ],
  "fieldSources": {
    "mpn": [
