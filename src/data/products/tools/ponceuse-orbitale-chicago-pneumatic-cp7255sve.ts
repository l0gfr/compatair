const product = {
	"id": "chicago-pneumatic-cp7255sve",
	"slug": "ponceuse-orbitale-chicago-pneumatic-cp7255sve",
	"categoryId": "ponceuse-orbitale",
	"category": "Ponceuse orbitale pneumatique",
	"label": "Ponceuse orbitale pneumatique Chicago Pneumatic CP7255SVE",
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/chicago-pneumatic-cp7255sve-catalogue-2026.webp",
		"alt": "Repères techniques CP7255SVE : 456 L/min en charge à 6,3 bar",
	...
	"editorial": {
		"overview": "CP7255SVE, référence 8941272552, demande 456 L/min en charge à 6,3 bar selon le catalogue Chicago Pneumatic v6.08.2026, page 172. Vitesse à vide : 12 000 tr/min. Puissance de l’outil : 210 W.",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "cp-catalog-202608-8941272552",
			"sourceUrl": "https://tools.cp.com/content/dam/pim/itba/cp/literature/catalogs/General-Industry_catalog_CP_EN.pdf#page=172",
			"sourceLabel": "Chicago Pneumatic, catalogue v6.08.2026, p. 172, réf. 8941272552",
	...
	"notes": [
		...
		"Source versionnée : catalogue v6.08.2026, page 172, référence 8941272552."
	],
