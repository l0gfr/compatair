...
const product = {
  "id": "atlas-copco-8431080347",
  "slug": "boulonneuse-atlas-copco-lmp61-h900-25",
  "categoryId": "boulonneuse",
  "category": "Boulonneuse pneumatique",
  "label": "Boulonneuse pneumatique Atlas Copco LMP61 H900-25",
  "brand": "Atlas Copco",
  "model": "LMP61 H900-25",
  "mpn": "8431080347",
  "variant": {
  ...
  "image": {
    "src": "/images/products/atlas-copco-8431080347-technical.webp",
    "alt": "Atlas Copco LMP61 H900-25, référence 8431080347 : 1 200 L/min à vide, référence 6,3 bar",
    "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/bolt-tightening-solutions/continuous-rotation/lmp61-h900-25-sku8431080347",
    "sourceLabel": "Repères techniques CompatAir d’après Atlas Copco"
  },
  "editorial": {
    "overview": "Atlas Copco LMP61 H900-25, référence 8431080347, demande 1 200 L/min à vide selon la fiche fabricant. Le dimensionnement utilise la pression de référence de 6,3 bar documentée dans le catalogue Industrial Tools and Solutions UK. Vitesse à vide : 260 tr/min. Couple maximal de la plage : 900 Nm.",
    "verifiedFacts": [
      "Vitesse à vide : 260 tr/min.",
      "Couple maximal de la plage : 900 Nm.",
      "Couple minimal de la plage : 500 Nm.",
  ...
  "specifications": [
    {
      ...
      "value": "260 tr/min",
      "evidenceIds": [
        "atlas-copco-8431080347-fiche-fabricant"
      ]
    },
    {
    ...
    },
    {
      ...
      "value": "6,3 bar",
      "evidenceIds": [
        "atlas-copco-8431080347-catalogue-uk"
      ]
    }
  ],
  "evidence": [
    {
      "id": "atlas-copco-8431080347-fiche-fabricant",
      "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/bolt-tightening-solutions/continuous-rotation/lmp61-h900-25-sku8431080347",
      "sourceLabel": "Atlas Copco, LMP61 H900-25, 8431080347",
    ...
    {
      "id": "atlas-copco-8431080347-catalogue-uk",
      ...
      "retrievedAt": "2026-09-26",
      "confidence": "A",
      "notes": "Référence 8431080347 présente au tableau. Conditions générales : air détendu à la pression atmosphérique, pression de travail 6,3 bar sauf exception. Le millésime de cette édition n’est pas affirmé."
    }
  ],
  "fieldSources": {
    "mpn": [
