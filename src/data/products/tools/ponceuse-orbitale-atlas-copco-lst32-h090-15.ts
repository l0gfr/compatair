...
const product = {
  "id": "atlas-copco-8423036255",
  "slug": "ponceuse-orbitale-atlas-copco-lst32-h090-15",
  "categoryId": "ponceuse-orbitale",
  "category": "Ponceuse orbitale pneumatique",
  "label": "Ponceuse orbitale pneumatique Atlas Copco LST32 H090-15",
  "brand": "Atlas Copco",
  "model": "LST32 H090-15",
  "mpn": "8423036255",
  "variant": {
    ...
    "distinguishingAttributes": {
      ...
      "Hauteur au-dessus de la broche": "121 mm",
  ...
  "image": {
    "src": "/images/products/atlas-copco-8423036255-technical.webp",
    "alt": "Atlas Copco LST32 H090-15, référence 8423036255 : 450 L/min à vide, référence 6,3 bar",
    "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/material-removal-tools/surface-sanding-and-polishing/lst32-h090-15-sku8423036255",
    "sourceLabel": "Repères techniques CompatAir d’après Atlas Copco"
  },
  "editorial": {
    "overview": "Atlas Copco LST32 H090-15, référence 8423036255, demande 450 L/min à vide selon la fiche fabricant. Le dimensionnement utilise la pression de référence de 6,3 bar documentée dans le catalogue Industrial Tools and Solutions UK. Vitesse maximale à vide : 9000 tr/min. Puissance maximale : 0,3 kW.",
    "verifiedFacts": [
      "Vitesse maximale à vide : 9000 tr/min.",
      "Puissance maximale : 0,3 kW.",
      "Masse : 1,4 kg.",
  ...
  "specifications": [
    {
      ...
      "value": "9000 tr/min",
      "evidenceIds": [
        "atlas-copco-8423036255-fiche-fabricant"
      ]
    },
    {
    ...
    },
    {
      ...
      "value": "6,3 bar",
      "evidenceIds": [
        "atlas-copco-8423036255-catalogue-uk"
      ]
    }
  ],
  "evidence": [
    {
      "id": "atlas-copco-8423036255-fiche-fabricant",
      "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/material-removal-tools/surface-sanding-and-polishing/lst32-h090-15-sku8423036255",
      "sourceLabel": "Atlas Copco, LST32 H090-15, 8423036255",
    ...
    {
      "id": "atlas-copco-8423036255-catalogue-uk",
      ...
      "retrievedAt": "2026-09-26",
      "confidence": "A",
      "notes": "Référence 8423036255 présente au tableau. Conditions générales : air détendu à la pression atmosphérique, pression de travail 6,3 bar sauf exception. Le millésime de cette édition n’est pas affirmé."
    }
  ],
  "fieldSources": {
    "mpn": [
