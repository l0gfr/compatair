const product = {
	"id": "chicago-pneumatic-cp5510-50hsv",
	"slug": "ponceuse-orbitale-chicago-pneumatic-cp5510-50hsv",
	"categoryId": "ponceuse-orbitale",
	"category": "Ponceuse orbitale pneumatique",
	"label": "Ponceuse orbitale pneumatique Chicago Pneumatic CP5510-50HSV",
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/chicago-pneumatic-cp5510-50hsv-catalogue-2026.webp",
		"alt": "Repères techniques CP5510-50HSV : 660 L/min en charge à 6,3 bar",
	...
	"editorial": {
		"overview": "CP5510-50HSV, référence 6151700850, demande 660 L/min en charge à 6,3 bar selon le catalogue Chicago Pneumatic v6.08.2026, page 176. Vitesse à vide : 10 000 tr/min. Puissance de l’outil : 375 W.",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "cp-catalog-202608-6151700850",
			"sourceUrl": "https://tools.cp.com/content/dam/pim/itba/cp/literature/catalogs/General-Industry_catalog_CP_EN.pdf#page=176",
			"sourceLabel": "Chicago Pneumatic, catalogue v6.08.2026, p. 176, réf. 6151700850",
	...
	"notes": [
		...
		"Source versionnée : catalogue v6.08.2026, page 176, référence 6151700850."
	],
