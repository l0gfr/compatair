const product = {
	...
	"label": "Ponceuse vibrante pneumatique Chicago Pneumatic CP5506-R6",
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/chicago-pneumatic-cp5506-r6-catalogue-2026.webp",
		"alt": "Repères techniques CP5506-R6 : 660 L/min en charge à 6,3 bar",
	...
	"editorial": {
		"overview": "CP5506-R6, référence 6151700660, demande 660 L/min en charge à 6,3 bar selon le catalogue Chicago Pneumatic v6.08.2026, page 177. Vitesse à vide : 8 000 tr/min. Puissance de l’outil : 375 W.",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "cp-catalog-202608-6151700660",
			"sourceUrl": "https://tools.cp.com/content/dam/pim/itba/cp/literature/catalogs/General-Industry_catalog_CP_EN.pdf#page=177",
			"sourceLabel": "Chicago Pneumatic, catalogue v6.08.2026, p. 177, réf. 6151700660",
	...
	"notes": [
		...
		"Source versionnée : catalogue v6.08.2026, page 177, référence 6151700660."
	],
