const product = {
	"id": "fuji-fg-13x-20-1-8-n",
	"slug": "meuleuse-fuji-fg-13x-20-1-8-n",
	"categoryId": "meuleuse",
	"category": "Meuleuse pneumatique",
	"label": "Meuleuse pneumatique Fuji FG-13X-20 1-8 N",
	"brand": "Fuji",
	"model": "FG-13X-20 1-8 N",
	"mpn": "5412052750",
	"distributorSkus": [],
	"identifierAliases": [],
	"variant": {
		"familyId": "fuji-449441",
		"label": "FG-13X-20 1-8 N",
	...
	"connectorSize": "Entrée 1/4 pouce NPT, flexible intérieur 6,3 mm sur 5 m",
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/fuji-fg-13x-20-1-8-n-technical.webp",
		"alt": "Repères techniques Fuji FG-13X-20 1-8 N : 210 L/min en charge, pression de travail 6,3 bar",
		"sourceUrl": "https://www.fujitools.com/en/products/5412052750",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche et la notice Fuji"
	},
	"editorial": {
		"overview": "Fuji FG-13X-20 1-8 N, référence 5412052750, présente une consommation en charge de 3,5 L/s, soit 210 L/min. La notice liée à cette fiche indique une pression de travail de 6,3 bar. Vitesse à vide : 30000 tr/min. Puissance maximale de l’outil : 140 W.",
		"verifiedFacts": [
			"Vitesse à vide : 30000 tr/min.",
			"Puissance maximale de l’outil : 140 W.",
			"Capacité de la pince (mm) : 3.175.",
			"Distance du bord à l’axe : 15.3 mm.",
			"Entrée 1/4 pouce NPT ; flexible de 6,3 mm de diamètre intérieur sur 5 m."
		],
		"limitations": [
	...
	"evidence": [
		{
			"id": "fuji-5412052750-official",
			"sourceUrl": "https://www.fujitools.com/en/products/5412052750",
			"sourceLabel": "Fuji, fiche officielle FG-13X-20 1-8 N, réf. 5412052750",
		...
		{
			"id": "fuji-5412052750-pressure-notice",
	...
	"fieldSources": {
		...
		"workingPressureBar": [
			"fuji-5412052750-pressure-notice"
		],
		"connectorSize": [
			"fuji-5412052750-official"
		],
