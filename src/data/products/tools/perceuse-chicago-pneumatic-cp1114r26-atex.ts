const product = {
	...
	"label": "Perceuse pneumatique Chicago Pneumatic CP1114R26 ATEX",
	"brand": "Chicago Pneumatic",
	"model": "CP1114R26 ATEX",
	"mpn": "6151580390",
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/chicago-pneumatic-cp1114r26-atex.webp",
		"alt": "Repères techniques CP1114R26 ATEX : 720 L/min en charge, 6,3 bar, flexible 10 mm",
		"sourceUrl": "https://tools.cp.com/en/products/drills/cp1114r26-atex-sku6151580390",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche Chicago Pneumatic"
	},
	"editorial": {
		"overview": "CP1114R26 ATEX, référence fabricant 6151580390, demande 720 L/min en charge (12 L/s). La fiche Chicago Pneumatic indique une pression dynamique maximale de 6,3 bar, retenue comme point de comparaison. Vitesse à vide : 2600 tr/min.",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "cp-6151580390-official",
			"sourceUrl": "https://tools.cp.com/en/products/drills/cp1114r26-atex-sku6151580390",
			"sourceLabel": "Chicago Pneumatic, fiche officielle CP1114R26 ATEX, réf. 6151580390",
