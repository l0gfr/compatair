...
const product = {
  "id": "atlas-copco-8421060805",
  "slug": "perceuse-atlas-copco-lbb37-h015",
  "categoryId": "perceuse",
  "category": "Perceuse pneumatique",
  "label": "Perceuse pneumatique Atlas Copco LBB37 H015",
  "brand": "Atlas Copco",
  "model": "LBB37 H015",
  "mpn": "8421060805",
  "variant": {
  ...
  "image": {
    "src": "/images/products/atlas-copco-8421060805-technical.webp",
    "alt": "Atlas Copco LBB37 H015, référence 8421060805 : 1 230 L/min à vide, référence 6,3 bar",
    "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/drilling-solutions/lbb37-h015-sku8421060805",
    "sourceLabel": "Repères techniques CompatAir d’après Atlas Copco"
  },
  "editorial": {
    "overview": "Atlas Copco LBB37 H015, référence 8421060805, demande 1 230 L/min à vide selon la fiche fabricant. Le dimensionnement utilise la pression de référence de 6,3 bar documentée dans le catalogue Industrial Tools and Solutions UK. Vitesse à vide : 1500 tr/min. Puissance : 820 W.",
    "verifiedFacts": [
      "Vitesse à vide : 1500 tr/min.",
      "Puissance : 820 W.",
      "Masse : 1,5 kg.",
  ...
  "specifications": [
    {
      ...
      "value": "1500 tr/min",
      "evidenceIds": [
        "atlas-copco-8421060805-fiche-fabricant"
      ]
    },
    {
      "label": "Puissance",
    ...
    },
    {
      ...
      "value": "6,3 bar",
      "evidenceIds": [
        "atlas-copco-8421060805-catalogue-uk"
      ]
    }
  ],
  "evidence": [
    {
      "id": "atlas-copco-8421060805-fiche-fabricant",
      "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/drilling-solutions/lbb37-h015-sku8421060805",
      "sourceLabel": "Atlas Copco, LBB37 H015, 8421060805",
    ...
    {
      "id": "atlas-copco-8421060805-catalogue-uk",
      ...
      "retrievedAt": "2026-09-26",
      "confidence": "A",
      "notes": "Référence 8421060805 présente au tableau. Conditions générales : air détendu à la pression atmosphérique, pression de travail 6,3 bar sauf exception. Le millésime de cette édition n’est pas affirmé."
    }
  ],
  "fieldSources": {
    "mpn": [
