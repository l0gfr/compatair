const product = {
	"id": "fuji-fg-5h-2m-n",
	"slug": "meuleuse-fuji-fg-5h-2m-n",
	"categoryId": "meuleuse",
	"category": "Meuleuse pneumatique",
	"label": "Meuleuse pneumatique Fuji FG-5H-2M N",
	"brand": "Fuji",
	"model": "FG-5H-2M N",
	"mpn": "5412052871",
	"distributorSkus": [],
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/fuji-fg-5h-2m-n-technical.webp",
		"alt": "Repères techniques Fuji FG-5H-2M N : 960 L/min en charge, pression de travail 6,3 bar",
		"sourceUrl": "https://www.fujitools.com/en/products/5412052871",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche et la notice Fuji"
	},
	"editorial": {
		"overview": "Fuji FG-5H-2M N, référence 5412052871, présente une consommation en charge de 16 L/s, soit 960 L/min. La notice liée à cette fiche indique une pression de travail de 6,3 bar. Vitesse à vide : 7600 tr/min. Puissance maximale de l’outil : 960 W.",
		"verifiedFacts": [
			"Vitesse à vide : 7600 tr/min.",
			"Puissance maximale de l’outil : 960 W.",
			"Filetage de sortie : 5/8-11 UNF.",
	...
	"evidence": [
		{
			"id": "fuji-5412052871-official",
			"sourceUrl": "https://www.fujitools.com/en/products/5412052871",
			"sourceLabel": "Fuji, fiche officielle FG-5H-2M N, réf. 5412052871",
		...
		{
			"id": "fuji-5412052871-pressure-notice",
	...
	"fieldSources": {
		...
		"workingPressureBar": [
			"fuji-5412052871-pressure-notice"
		],
		"connectorSize": [
			"fuji-5412052871-official"
		],
