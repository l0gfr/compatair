const product = {
	"id": "fuji-fg-5hl-2",
	"slug": "meuleuse-fuji-fg-5hl-2",
	"categoryId": "meuleuse",
	"category": "Meuleuse pneumatique",
	"label": "Meuleuse pneumatique Fuji FG-5HL-2",
	"brand": "Fuji",
	"model": "FG-5HL-2",
	"mpn": "5412052874",
	"distributorSkus": [],
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/fuji-fg-5hl-2-technical.webp",
		"alt": "Repères techniques Fuji FG-5HL-2 : 960 L/min en charge, pression de travail 6,3 bar",
		"sourceUrl": "https://www.fujitools.com/en/products/5412052874",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche et la notice Fuji"
	},
	"editorial": {
		"overview": "Fuji FG-5HL-2, référence 5412052874, présente une consommation en charge de 16 L/s, soit 960 L/min. La notice liée à cette fiche indique une pression de travail de 6,3 bar. Vitesse à vide : 9000 tr/min. Puissance maximale de l’outil : 960 W.",
		"verifiedFacts": [
			"Vitesse à vide : 9000 tr/min.",
			"Puissance maximale de l’outil : 960 W.",
			"Filetage de sortie : W1/2-12.",
	...
	"evidence": [
		{
			"id": "fuji-5412052874-official",
			"sourceUrl": "https://www.fujitools.com/en/products/5412052874",
			"sourceLabel": "Fuji, fiche officielle FG-5HL-2, réf. 5412052874",
		...
		{
			"id": "fuji-5412052874-pressure-notice",
	...
	"fieldSources": {
		...
		"workingPressureBar": [
			"fuji-5412052874-pressure-notice"
		],
		"connectorSize": [
			"fuji-5412052874-official"
		],
