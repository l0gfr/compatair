...
const product = {
  "id": "atlas-copco-8431070432",
  "slug": "boulonneuse-atlas-copco-ltd38-r32f-rr",
  "categoryId": "boulonneuse",
  "category": "Boulonneuse pneumatique",
  "label": "Boulonneuse pneumatique Atlas Copco LTD38 R32F-RR",
  "brand": "Atlas Copco",
  "model": "LTD38 R32F-RR",
  "mpn": "8431070432",
  "variant": {
  ...
  "confidence": "A",
  "image": {
    "src": "/images/products/atlas-copco-8431070432-technical.webp",
    "alt": "Atlas Copco LTD38 R32F-RR, référence 8431070432 : 960 L/min à vide, référence 6,3 bar",
    "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/ltd38-r32f-rr-sku8431070432",
    "sourceLabel": "Repères techniques CompatAir d’après Atlas Copco"
  },
  "editorial": {
    "overview": "Atlas Copco LTD38 R32F-RR, référence 8431070432, demande 960 L/min à vide selon la fiche fabricant. Le dimensionnement utilise la pression de référence de 6,3 bar documentée dans le catalogue Industrial Tools and Solutions UK. Vitesse à vide : 560 tr/min. Couple maximal de la plage : 32 Nm.",
    "verifiedFacts": [
      "Vitesse à vide : 560 tr/min.",
      "Couple maximal de la plage : 32 Nm.",
      "Couple minimal de la plage : 18 Nm.",
  ...
  "specifications": [
    {
      ...
      "value": "560 tr/min",
      "evidenceIds": [
        "atlas-copco-8431070432-fiche-fabricant"
      ]
    },
    {
    ...
    },
    {
      ...
      "value": "6,3 bar",
      "evidenceIds": [
        "atlas-copco-8431070432-catalogue-uk"
      ]
    },
    {
  ...
  "evidence": [
    {
      "id": "atlas-copco-8431070432-fiche-fabricant",
      "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/ltd38-r32f-rr-sku8431070432",
      "sourceLabel": "Atlas Copco, LTD38 R32F-RR, 8431070432",
    ...
    {
      "id": "atlas-copco-8431070432-catalogue-uk",
      ...
      "retrievedAt": "2026-09-26",
      "confidence": "A",
      "notes": "Référence 8431070432 présente au tableau. Conditions générales : air détendu à la pression atmosphérique, pression de travail 6,3 bar sauf exception. Le millésime de cette édition n’est pas affirmé."
    }
  ],
  "fieldSources": {
    "mpn": [
