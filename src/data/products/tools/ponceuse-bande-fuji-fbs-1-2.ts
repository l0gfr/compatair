const product = {
	"id": "fuji-fbs-1-2",
	"slug": "ponceuse-bande-fuji-fbs-1-2",
	"categoryId": "ponceuse-bande",
	"category": "Ponceuse à bande pneumatique",
	"label": "Ponceuse à bande pneumatique Fuji FBS-1-2",
	"brand": "Fuji",
	"model": "FBS-1-2",
	"mpn": "5412052465",
	"distributorSkus": [],
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/fuji-fbs-1-2-technical.webp",
		"alt": "Repères techniques Fuji FBS-1-2 : 570 L/min en charge, pression de travail 6,3 bar",
		"sourceUrl": "https://www.fujitools.com/en/products/5412052465",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche et la notice Fuji"
	},
	"editorial": {
		"overview": "Fuji FBS-1-2, référence 5412052465, présente une consommation en charge de 9,5 L/s, soit 570 L/min. La notice liée à cette fiche indique une pression de travail de 6,3 bar. Vitesse à vide : 1200 tr/min. Puissance maximale de l’outil : 280 W.",
		"verifiedFacts": [
			"Vitesse à vide : 1200 tr/min.",
			"Puissance maximale de l’outil : 280 W.",
			"Dimensions de la bande (mm) : 20x520.",
	...
	"evidence": [
		{
			"id": "fuji-5412052465-official",
			"sourceUrl": "https://www.fujitools.com/en/products/5412052465",
			"sourceLabel": "Fuji, fiche officielle FBS-1-2, réf. 5412052465",
		...
		{
			"id": "fuji-5412052465-pressure-notice",
	...
	"fieldSources": {
		...
		"workingPressureBar": [
			"fuji-5412052465-pressure-notice"
		],
		"connectorSize": [
			"fuji-5412052465-official"
		],
