...
const product = {
  "id": "atlas-copco-8423012723",
  "slug": "meuleuse-atlas-copco-lsf29-s120-hd",
  "categoryId": "meuleuse",
  "category": "Meuleuse pneumatique",
  "label": "Meuleuse pneumatique Atlas Copco LSF29 S120-HD",
  "brand": "Atlas Copco",
  "model": "LSF29 S120-HD",
  "mpn": "8423012723",
  "variant": {
  ...
  "image": {
    "src": "/images/products/atlas-copco-8423012723-technical.webp",
    "alt": "Atlas Copco LSF29 S120-HD, référence 8423012723 : 1 020 L/min à puissance maximale, référence 6,3 bar",
    "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/material-removal-tools/precision-grinding/lsf29-s120-hd-sku8423012723",
    "sourceLabel": "Repères techniques CompatAir d’après Atlas Copco"
  },
  "editorial": {
    "overview": "Atlas Copco LSF29 S120-HD, référence 8423012723, demande 1 020 L/min à puissance maximale selon la fiche fabricant. Le dimensionnement utilise la pression de référence de 6,3 bar documentée dans le catalogue Industrial Tools and Solutions UK. Vitesse maximale à vide : 12000 tr/min. Puissance maximale : 0,7 kW.",
    "verifiedFacts": [
      "Vitesse maximale à vide : 12000 tr/min.",
      "Puissance maximale : 0,7 kW.",
      "Masse : 1,2 kg.",
  ...
  "specifications": [
    {
      ...
      "value": "12000 tr/min",
      "evidenceIds": [
        "atlas-copco-8423012723-fiche-fabricant"
      ]
    },
    {
    ...
    },
    {
      ...
      "value": "6,3 bar",
      "evidenceIds": [
        "atlas-copco-8423012723-catalogue-uk"
      ]
    }
  ],
  "evidence": [
    {
      "id": "atlas-copco-8423012723-fiche-fabricant",
      "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/material-removal-tools/precision-grinding/lsf29-s120-hd-sku8423012723",
      "sourceLabel": "Atlas Copco, LSF29 S120-HD, 8423012723",
    ...
    {
      "id": "atlas-copco-8423012723-catalogue-uk",
      ...
      "retrievedAt": "2026-09-26",
      "confidence": "A",
      "notes": "Référence 8423012723 présente au tableau. Conditions générales : air détendu à la pression atmosphérique, pression de travail 6,3 bar sauf exception. Le millésime de cette édition n’est pas affirmé."
    }
  ],
  "fieldSources": {
    "mpn": [
