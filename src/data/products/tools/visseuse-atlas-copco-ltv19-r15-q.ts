...
const product = {
  "id": "atlas-copco-8431027937",
  "slug": "visseuse-atlas-copco-ltv19-r15-q",
  "categoryId": "visseuse",
  "category": "Visseuse pneumatique",
  "label": "Visseuse pneumatique Atlas Copco LTV19 R15-Q",
  "brand": "Atlas Copco",
  "model": "LTV19 R15-Q",
  "mpn": "8431027937",
  "variant": {
  ...
  "image": {
    "src": "/images/products/atlas-copco-8431027937-technical.webp",
    "alt": "Atlas Copco LTV19 R15-Q, référence 8431027937 : 420 L/min à vide, référence 6,3 bar",
    "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/ltv19-r15-q-sku8431027937",
    "sourceLabel": "Repères techniques CompatAir d’après Atlas Copco"
  },
  "editorial": {
    "overview": "Atlas Copco LTV19 R15-Q, référence 8431027937, demande 420 L/min à vide selon la fiche fabricant. Le dimensionnement utilise la pression de référence de 6,3 bar documentée dans le catalogue Industrial Tools and Solutions UK. Vitesse à vide : 400 tr/min. Couple maximal de la plage : 15 Nm.",
    "verifiedFacts": [
      "Vitesse à vide : 400 tr/min.",
      "Couple maximal de la plage : 15 Nm.",
      "Couple minimal de la plage : 6 Nm.",
  ...
  "specifications": [
    {
      ...
      "value": "400 tr/min",
      "evidenceIds": [
        "atlas-copco-8431027937-fiche-fabricant"
      ]
    },
    {
    ...
    },
    {
      ...
      "value": "6,3 bar",
      "evidenceIds": [
        "atlas-copco-8431027937-catalogue-uk"
      ]
    }
  ],
  "evidence": [
    {
      "id": "atlas-copco-8431027937-fiche-fabricant",
      "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/ltv19-r15-q-sku8431027937",
      "sourceLabel": "Atlas Copco, LTV19 R15-Q, 8431027937",
    ...
    {
      "id": "atlas-copco-8431027937-catalogue-uk",
      ...
      "retrievedAt": "2026-09-26",
      "confidence": "A",
      "notes": "Référence 8431027937 présente au tableau. Conditions générales : air détendu à la pression atmosphérique, pression de travail 6,3 bar sauf exception. Le millésime de cette édition n’est pas affirmé."
    }
  ],
  "fieldSources": {
    "mpn": [
