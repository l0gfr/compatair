const product = {
	"id": "fuji-frd-8px-1",
	"slug": "perceuse-fuji-frd-8px-1",
	"categoryId": "perceuse",
	"category": "Perceuse pneumatique",
	"label": "Perceuse pneumatique Fuji FRD-8PX-1",
	"brand": "Fuji",
	"model": "FRD-8PX-1",
	"mpn": "5412072235",
	"distributorSkus": [],
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/fuji-frd-8px-1-technical.webp",
		"alt": "Repères techniques Fuji FRD-8PX-1 : 780 L/min en charge, pression de travail 6,3 bar",
		"sourceUrl": "https://www.fujitools.com/en/products/5412072235",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche et la notice Fuji"
	},
	"editorial": {
		"overview": "Fuji FRD-8PX-1, référence 5412072235, présente une consommation en charge de 13 L/s, soit 780 L/min. La notice liée à cette fiche indique une pression de travail de 6,3 bar. Vitesse à vide : 2600 tr/min. Puissance maximale de l’outil : 440 W.",
		"verifiedFacts": [
			"Vitesse à vide : 2600 tr/min.",
			"Puissance maximale de l’outil : 440 W.",
			"Capacité maximale du mandrin (mm) : 8.",
	...
	"evidence": [
		{
			"id": "fuji-5412072235-official",
			"sourceUrl": "https://www.fujitools.com/en/products/5412072235",
			"sourceLabel": "Fuji, fiche officielle FRD-8PX-1, réf. 5412072235",
		...
		{
			"id": "fuji-5412072235-pressure-notice",
	...
	"fieldSources": {
		...
		"workingPressureBar": [
			"fuji-5412072235-pressure-notice"
		],
		"connectorSize": [
			"fuji-5412072235-official"
		],
