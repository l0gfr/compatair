...
const product = {
  "id": "atlas-copco-8431027891",
  "slug": "visseuse-atlas-copco-twist22-pr6",
  "categoryId": "visseuse",
  "category": "Visseuse pneumatique",
  "label": "Visseuse pneumatique Atlas Copco TWIST22 PR6",
  "brand": "Atlas Copco",
  "model": "TWIST22 PR6",
  "mpn": "8431027891",
  "variant": {
    ...
    "distinguishingAttributes": {
      ...
      "Couple maximal de la plage": "6,5 Nm",
      "Couple minimal de la plage": "2,2 Nm",
      "Couple maximal sur assemblage élastique": "6,5 Nm",
      "Couple minimal sur assemblage élastique": "2,2 Nm",
      "Masse": "0,75 kg",
      "Longueur": "211 mm",
  ...
  "image": {
    "src": "/images/products/atlas-copco-8431027891-technical.webp",
    "alt": "Atlas Copco TWIST22 PR6, référence 8431027891 : 420 L/min à vide, référence 6,3 bar",
    "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/twist22-pr6-sku8431027891",
    "sourceLabel": "Repères techniques CompatAir d’après Atlas Copco"
  },
  "editorial": {
    "overview": "Atlas Copco TWIST22 PR6, référence 8431027891, demande 420 L/min à vide selon la fiche fabricant. Le dimensionnement utilise la pression de référence de 6,3 bar documentée dans le catalogue Industrial Tools and Solutions UK. Vitesse à vide : 1600 tr/min. Couple maximal de la plage : 6,5 Nm.",
    "verifiedFacts": [
      "Vitesse à vide : 1600 tr/min.",
      "Couple maximal de la plage : 6,5 Nm.",
      "Couple minimal de la plage : 2,2 Nm.",
  ...
  "specifications": [
    {
      ...
      "value": "1600 tr/min",
      "evidenceIds": [
        "atlas-copco-8431027891-fiche-fabricant"
      ]
    },
    {
    ...
    },
    {
      ...
      "value": "6,3 bar",
      "evidenceIds": [
        "atlas-copco-8431027891-catalogue-uk"
      ]
    }
  ],
  "evidence": [
    {
      "id": "atlas-copco-8431027891-fiche-fabricant",
      "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/twist22-pr6-sku8431027891",
      "sourceLabel": "Atlas Copco, TWIST22 PR6, 8431027891",
    ...
    {
      "id": "atlas-copco-8431027891-catalogue-uk",
      ...
      "retrievedAt": "2026-09-26",
      "confidence": "A",
      "notes": "Référence 8431027891 présente au tableau. Conditions générales : air détendu à la pression atmosphérique, pression de travail 6,3 bar sauf exception. Le millésime de cette édition n’est pas affirmé."
    }
  ],
  "fieldSources": {
    "mpn": [
