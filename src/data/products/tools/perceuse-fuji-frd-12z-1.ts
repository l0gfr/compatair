const product = {
	"id": "fuji-frd-12z-1",
	"slug": "perceuse-fuji-frd-12z-1",
	"categoryId": "perceuse",
	"category": "Perceuse pneumatique",
	"label": "Perceuse pneumatique Fuji FRD-12Z-1",
	"brand": "Fuji",
	"model": "FRD-12Z-1",
	"mpn": "5412072130",
	"distributorSkus": [],
	"identifierAliases": [],
	"variant": {
		"familyId": "fuji-449572",
		"label": "FRD-12Z-1",
		"distinguishingAttributes": {
			"Vitesse à vide": "1200 tr/min",
			"Puissance maximale de l’outil": "660 W",
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/fuji-frd-12z-1-technical.webp",
		"alt": "Repères techniques Fuji FRD-12Z-1 : 1 200 L/min en charge, pression de travail 6,3 bar",
		"sourceUrl": "https://www.fujitools.com/en/products/5412072130",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche et la notice Fuji"
	},
	"editorial": {
		"overview": "Fuji FRD-12Z-1, référence 5412072130, présente une consommation en charge de 20 L/s, soit 1 200 L/min. La notice liée à cette fiche indique une pression de travail de 6,3 bar. Vitesse à vide : 1200 tr/min. Puissance maximale de l’outil : 660 W.",
		"verifiedFacts": [
			"Vitesse à vide : 1200 tr/min.",
			"Puissance maximale de l’outil : 660 W.",
			"Capacité maximale du mandrin (mm) : 13.",
	...
	"evidence": [
		{
			"id": "fuji-5412072130-official",
			"sourceUrl": "https://www.fujitools.com/en/products/5412072130",
			"sourceLabel": "Fuji, fiche officielle FRD-12Z-1, réf. 5412072130",
		...
		{
			"id": "fuji-5412072130-pressure-notice",
	...
	"fieldSources": {
		...
		"workingPressureBar": [
			"fuji-5412072130-pressure-notice"
		],
		"connectorSize": [
			"fuji-5412072130-official"
		],
