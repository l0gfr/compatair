const product = {
	...
	"brand": "Lacmé",
	"model": "Visseuse IND 1700 tr/min",
	"mpn": "343214",
	"categoryId": "visseuse",
	"category": "visseuse",
	"label": "Lacmé Visseuse IND 1700 tr/min",
	...
	"confidence": "B",
	"image": {
		"src": "/images/products/lacme-visseuse-ind-1700-tr-min.webp",
		"alt": "Repères techniques Lacmé Visseuse IND 1700 tr/min, référence 343214",
	...
	"editorial": {
		"overview": "Lacmé Visseuse IND 1700 tr/min, référence 343214. Le tableau fabricant publie 340 L/min et une plage d’utilisation de 6 à 7 bar.",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "lacme-343214-20260926",
			"sourceUrl": "https://s3.eu-west-1.amazonaws.com/s37.lacme.com/crm/Catalogues/LACME%20-%20Catalogue%20Outillage%202026.pdf#page=26",
			"sourceLabel": "Lacmé, catalogue Outillage 2026, p. 26, réf. 343214",
