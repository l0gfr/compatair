const product = {
	"id": "fuji-fa-30-3-5-8",
	"slug": "meuleuse-fuji-fa-30-3-5-8",
	"categoryId": "meuleuse",
	"category": "Meuleuse pneumatique",
	"label": "Meuleuse pneumatique Fuji FA-30-3 5-8",
	"brand": "Fuji",
	"model": "FA-30-3 5-8",
	"mpn": "5412105272",
	"distributorSkus": [],
	...
	"variant": {
		...
		"distinguishingAttributes": {
			...
			"Puissance maximale de l’outil": "490 W",
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/fuji-fa-30-3-5-8-technical.webp",
		"alt": "Repères techniques Fuji FA-30-3 5-8 : 1 260 L/min en charge, pression de travail 6,3 bar",
		"sourceUrl": "https://www.fujitools.com/en/products/5412105272",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche et la notice Fuji"
	},
	"editorial": {
		"overview": "Fuji FA-30-3 5-8, référence 5412105272, présente une consommation en charge de 21 L/s, soit 1 260 L/min. La notice liée à cette fiche indique une pression de travail de 6,3 bar. Vitesse à vide : 13500 tr/min. Puissance maximale de l’outil : 490 W.",
		"verifiedFacts": [
			"Vitesse à vide : 13500 tr/min.",
			"Puissance maximale de l’outil : 490 W.",
			"Filetage de sortie : M8.",
	...
	"evidence": [
		{
			"id": "fuji-5412105272-official",
			"sourceUrl": "https://www.fujitools.com/en/products/5412105272",
			"sourceLabel": "Fuji, fiche officielle FA-30-3 5-8, réf. 5412105272",
		...
		{
			"id": "fuji-5412105272-pressure-notice",
	...
	"fieldSources": {
		...
		"workingPressureBar": [
			"fuji-5412105272-pressure-notice"
		],
		"connectorSize": [
			"fuji-5412105272-official"
		],
