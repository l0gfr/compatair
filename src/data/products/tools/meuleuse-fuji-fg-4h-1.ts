const product = {
	"id": "fuji-fg-4h-1",
	"slug": "meuleuse-fuji-fg-4h-1",
	"categoryId": "meuleuse",
	"category": "Meuleuse pneumatique",
	"label": "Meuleuse pneumatique Fuji FG-4H-1",
	"brand": "Fuji",
	"model": "FG-4H-1",
	"mpn": "5412052849",
	"distributorSkus": [],
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/fuji-fg-4h-1-technical.webp",
		"alt": "Repères techniques Fuji FG-4H-1 : 780 L/min en charge, pression de travail 6,3 bar",
		"sourceUrl": "https://www.fujitools.com/en/products/5412052849",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche et la notice Fuji"
	},
	"editorial": {
		"overview": "Fuji FG-4H-1, référence 5412052849, présente une consommation en charge de 13 L/s, soit 780 L/min. La notice liée à cette fiche indique une pression de travail de 6,3 bar. Vitesse à vide : 9500 tr/min. Puissance maximale de l’outil : 690 W.",
		"verifiedFacts": [
			"Vitesse à vide : 9500 tr/min.",
			"Puissance maximale de l’outil : 690 W.",
			"Filetage de sortie : W3/8-16.",
	...
	"evidence": [
		{
			"id": "fuji-5412052849-official",
			"sourceUrl": "https://www.fujitools.com/en/products/5412052849",
			"sourceLabel": "Fuji, fiche officielle FG-4H-1, réf. 5412052849",
		...
		{
			"id": "fuji-5412052849-pressure-notice",
	...
	"fieldSources": {
		...
		"workingPressureBar": [
			"fuji-5412052849-pressure-notice"
		],
		"connectorSize": [
			"fuji-5412052849-official"
		],
