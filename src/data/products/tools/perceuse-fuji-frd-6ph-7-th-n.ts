const product = {
	"id": "fuji-frd-6ph-7-th-n",
	"slug": "perceuse-fuji-frd-6ph-7-th-n",
	"categoryId": "perceuse",
	"category": "Perceuse pneumatique",
	"label": "Perceuse pneumatique Fuji FRD-6PH-7 TH N",
	"brand": "Fuji",
	"model": "FRD-6PH-7 TH N",
	"mpn": "5412104352",
	"distributorSkus": [],
	"identifierAliases": [],
	"variant": {
		"familyId": "fuji-449439",
		"label": "FRD-6PH-7 TH N",
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/fuji-frd-6ph-7-th-n-technical.webp",
		"alt": "Repères techniques Fuji FRD-6PH-7 TH N : 600 L/min en charge, pression de travail 6,3 bar",
		"sourceUrl": "https://www.fujitools.com/en/products/5412104352",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche et la notice Fuji"
	},
	"editorial": {
		"overview": "Fuji FRD-6PH-7 TH N, référence 5412104352, présente une consommation en charge de 10 L/s, soit 600 L/min. La notice liée à cette fiche indique une pression de travail de 6,3 bar. Vitesse à vide : 600 tr/min. Puissance maximale de l’outil : 320 W.",
		"verifiedFacts": [
			"Vitesse à vide : 600 tr/min.",
			"Puissance maximale de l’outil : 320 W.",
			"Capacité maximale du mandrin (mm) : 13.",
	...
	"evidence": [
		{
			"id": "fuji-5412104352-official",
			"sourceUrl": "https://www.fujitools.com/en/products/5412104352",
			"sourceLabel": "Fuji, fiche officielle FRD-6PH-7 TH N, réf. 5412104352",
		...
		{
			"id": "fuji-5412104352-pressure-notice",
	...
	"fieldSources": {
		...
		"workingPressureBar": [
			"fuji-5412104352-pressure-notice"
		],
		"connectorSize": [
			"fuji-5412104352-official"
		],
