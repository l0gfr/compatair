...
const product = {
  "id": "atlas-copco-8431027890",
  "slug": "visseuse-atlas-copco-twist22-pr7",
  "categoryId": "visseuse",
  "category": "Visseuse pneumatique",
  "label": "Visseuse pneumatique Atlas Copco TWIST22 PR7",
  "brand": "Atlas Copco",
  "model": "TWIST22 PR7",
  "mpn": "8431027890",
  "variant": {
    ...
    "distinguishingAttributes": {
      ...
      "Couple maximal de la plage": "7,5 Nm",
      "Couple minimal de la plage": "1,5 Nm",
      "Couple maximal sur assemblage élastique": "7,5 Nm",
  ...
  "image": {
    "src": "/images/products/atlas-copco-8431027890-technical.webp",
    "alt": "Atlas Copco TWIST22 PR7, référence 8431027890 : 420 L/min à vide, référence 6,3 bar",
    "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/twist22-pr7-sku8431027890",
    "sourceLabel": "Repères techniques CompatAir d’après Atlas Copco"
  },
  "editorial": {
    "overview": "Atlas Copco TWIST22 PR7, référence 8431027890, demande 420 L/min à vide selon la fiche fabricant. Le dimensionnement utilise la pression de référence de 6,3 bar documentée dans le catalogue Industrial Tools and Solutions UK. Vitesse à vide : 1100 tr/min. Couple maximal de la plage : 7,5 Nm.",
    "verifiedFacts": [
      "Vitesse à vide : 1100 tr/min.",
      "Couple maximal de la plage : 7,5 Nm.",
      "Couple minimal de la plage : 1,5 Nm.",
  ...
  "specifications": [
    {
      ...
      "value": "1100 tr/min",
      "evidenceIds": [
        "atlas-copco-8431027890-fiche-fabricant"
      ]
    },
    {
    ...
    },
    {
      ...
      "value": "6,3 bar",
      "evidenceIds": [
        "atlas-copco-8431027890-catalogue-uk"
      ]
    }
  ],
  "evidence": [
    {
      "id": "atlas-copco-8431027890-fiche-fabricant",
      "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/twist22-pr7-sku8431027890",
      "sourceLabel": "Atlas Copco, TWIST22 PR7, 8431027890",
    ...
    {
      "id": "atlas-copco-8431027890-catalogue-uk",
      ...
      "retrievedAt": "2026-09-26",
      "confidence": "A",
      "notes": "Référence 8431027890 présente au tableau. Conditions générales : air détendu à la pression atmosphérique, pression de travail 6,3 bar sauf exception. Le millésime de cette édition n’est pas affirmé."
    }
  ],
  "fieldSources": {
    "mpn": [
