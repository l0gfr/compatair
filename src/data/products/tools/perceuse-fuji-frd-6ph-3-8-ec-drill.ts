const product = {
	"id": "fuji-frd-6ph-3-8-ec-drill",
	"slug": "perceuse-fuji-frd-6ph-3-8-ec-drill",
	"categoryId": "perceuse",
	"category": "Perceuse pneumatique",
	"label": "Perceuse pneumatique Fuji FRD-6PH-3 8 EC DRILL",
	"brand": "Fuji",
	"model": "FRD-6PH-3 8 EC DRILL",
	"mpn": "5412103799",
	"distributorSkus": [],
	"identifierAliases": [],
	"variant": {
		"familyId": "fuji-449439",
		"label": "FRD-6PH-3 8 EC DRILL",
		"distinguishingAttributes": {
			"Vitesse à vide": "2800 tr/min",
			"Puissance maximale de l’outil": "340 W",
			"Capacité maximale du mandrin (mm)": "8",
			"Montage du mandrin": "Jacobs Taper 1",
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/fuji-frd-6ph-3-8-ec-drill-technical.webp",
		"alt": "Repères techniques Fuji FRD-6PH-3 8 EC DRILL : 600 L/min en charge, pression de travail 6,3 bar",
		"sourceUrl": "https://www.fujitools.com/en/products/5412103799",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche et la notice Fuji"
	},
	"editorial": {
		"overview": "Fuji FRD-6PH-3 8 EC DRILL, référence 5412103799, présente une consommation en charge de 10 L/s, soit 600 L/min. La notice liée à cette fiche indique une pression de référence des performances de 6,3 bar. Vitesse à vide : 2800 tr/min. Puissance maximale de l’outil : 340 W.",
		"verifiedFacts": [
			"Vitesse à vide : 2800 tr/min.",
			"Puissance maximale de l’outil : 340 W.",
			"Capacité maximale du mandrin (mm) : 8.",
	...
	"evidence": [
		{
			"id": "fuji-5412103799-official",
			"sourceUrl": "https://www.fujitools.com/en/products/5412103799",
			"sourceLabel": "Fuji, fiche officielle FRD-6PH-3 8 EC DRILL, réf. 5412103799",
		...
		{
			"id": "fuji-5412103799-pressure-notice",
			"sourceUrl": "https://files.fujitools.com/documentation-files-mv/9502000551_03.pdf#page=1",
			"sourceLabel": "Fuji, notice 9502000551, révision 03, page 1",
			"sourceType": "manual",
			"sourceRole": "primary",
			"retrievedAt": "2026-09-25",
			"confidence": "A",
	...
	"fieldSources": {
		...
		"workingPressureBar": [
			"fuji-5412103799-pressure-notice"
		],
		"connectorSize": [
			"fuji-5412103799-official"
		],
