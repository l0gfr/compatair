const product = {
	"id": "fuji-fa-20x-1f-n-ec",
	"slug": "meuleuse-fuji-fa-20x-1f-n-ec",
	"categoryId": "meuleuse",
	"category": "Meuleuse pneumatique",
	"label": "Meuleuse pneumatique Fuji FA-20X-1F N EC",
	"brand": "Fuji",
	"model": "FA-20X-1F N EC",
	"mpn": "5412104845",
	"distributorSkus": [],
	"identifierAliases": [],
	"variant": {
		"familyId": "fuji-449511",
		"label": "FA-20X-1F N EC",
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/fuji-fa-20x-1f-n-ec-technical.webp",
		"alt": "Repères techniques Fuji FA-20X-1F N EC : 1 260 L/min en charge, pression de travail 6,3 bar",
		"sourceUrl": "https://www.fujitools.com/en/products/5412104845",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche et la notice Fuji"
	},
	"editorial": {
		"overview": "Fuji FA-20X-1F N EC, référence 5412104845, présente une consommation en charge de 21 L/s, soit 1 260 L/min. La notice liée à cette fiche indique une pression de travail de 6,3 bar. Vitesse à vide : 15000 tr/min. Puissance maximale de l’outil : 265 W.",
		"verifiedFacts": [
			"Vitesse à vide : 15000 tr/min.",
			"Puissance maximale de l’outil : 265 W.",
			"Filetage de sortie : 1/4-28 UNF.",
	...
	"evidence": [
		{
			"id": "fuji-5412104845-official",
			"sourceUrl": "https://www.fujitools.com/en/products/5412104845",
			"sourceLabel": "Fuji, fiche officielle FA-20X-1F N EC, réf. 5412104845",
		...
		{
			"id": "fuji-5412104845-pressure-notice",
	...
	"fieldSources": {
		...
		"workingPressureBar": [
			"fuji-5412104845-pressure-notice"
		],
		"connectorSize": [
			"fuji-5412104845-official"
		],
