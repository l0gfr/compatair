const product = {
	"id": "fuji-fa-150kg-7-sd",
	"slug": "ponceuse-rotative-fuji-fa-150kg-7-sd",
	"categoryId": "ponceuse-rotative",
	"category": "Ponceuse rotative pneumatique",
	"label": "Ponceuse rotative pneumatique Fuji FA-150KG-7 SD",
	"brand": "Fuji",
	"model": "FA-150KG-7 SD",
	"mpn": "5412052243",
	"distributorSkus": [],
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/fuji-fa-150kg-7-sd-technical.webp",
		"alt": "Repères techniques Fuji FA-150KG-7 SD : 1 140 L/min en charge, pression de travail 6,3 bar",
		"sourceUrl": "https://www.fujitools.com/en/products/5412052243",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche et la notice Fuji"
	},
	"editorial": {
		"overview": "Fuji FA-150KG-7 SD, référence 5412052243, présente une consommation en charge de 19 L/s, soit 1 140 L/min. La notice liée à cette fiche indique une pression de travail de 6,3 bar. Vitesse à vide : 5500 tr/min. Puissance maximale de l’outil : 900 W.",
		"verifiedFacts": [
			"Vitesse à vide : 5500 tr/min.",
			"Puissance maximale de l’outil : 900 W.",
			"Filetage de sortie : W1/2-16(F).",
	...
	"evidence": [
		{
			"id": "fuji-5412052243-official",
			"sourceUrl": "https://www.fujitools.com/en/products/5412052243",
			"sourceLabel": "Fuji, fiche officielle FA-150KG-7 SD, réf. 5412052243",
		...
		{
			"id": "fuji-5412052243-pressure-notice",
	...
	"fieldSources": {
		...
		"workingPressureBar": [
			"fuji-5412052243-pressure-notice"
		],
		"connectorSize": [
			"fuji-5412052243-official"
		],
