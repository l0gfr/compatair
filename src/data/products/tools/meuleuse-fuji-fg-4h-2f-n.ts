const product = {
	...
	"label": "Meuleuse pneumatique Fuji FG-4H-2F N",
	"brand": "Fuji",
	"model": "FG-4H-2F N",
	"mpn": "5412052856",
	"distributorSkus": [],
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/fuji-fg-4h-2f-n-technical.webp",
		"alt": "Repères techniques Fuji FG-4H-2F N : 780 L/min en charge, pression de travail 6,3 bar",
		"sourceUrl": "https://www.fujitools.com/en/products/5412052856",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche et la notice Fuji"
	},
	"editorial": {
		"overview": "Fuji FG-4H-2F N, référence 5412052856, présente une consommation en charge de 13 L/s, soit 780 L/min. La notice liée à cette fiche indique une pression de travail de 6,3 bar. Vitesse à vide : 9500 tr/min. Puissance maximale de l’outil : 690 W.",
		"verifiedFacts": [
			"Vitesse à vide : 9500 tr/min.",
			"Puissance maximale de l’outil : 690 W.",
			"Filetage de sortie : W1/2-12.",
	...
	"evidence": [
		{
			"id": "fuji-5412052856-official",
			"sourceUrl": "https://www.fujitools.com/en/products/5412052856",
			"sourceLabel": "Fuji, fiche officielle FG-4H-2F N, réf. 5412052856",
		...
		{
			"id": "fuji-5412052856-pressure-notice",
	...
	"fieldSources": {
		...
		"workingPressureBar": [
			"fuji-5412052856-pressure-notice"
		],
		"connectorSize": [
			"fuji-5412052856-official"
		],
