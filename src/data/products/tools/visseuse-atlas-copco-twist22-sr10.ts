...
const product = {
  "id": "atlas-copco-8431026953",
  "slug": "visseuse-atlas-copco-twist22-sr10",
  "categoryId": "visseuse",
  "category": "Visseuse pneumatique",
  "label": "Visseuse pneumatique Atlas Copco TWIST22 SR10",
  "brand": "Atlas Copco",
  "model": "TWIST22 SR10",
  "mpn": "8431026953",
  "variant": {
    ...
    "distinguishingAttributes": {
      ...
      "Couple maximal de la plage": "10 Nm",
      "Couple minimal de la plage": "1,5 Nm",
      "Couple maximal sur assemblage élastique": "10 Nm",
  ...
  "confidence": "A",
  "connectorSize": "Entrée 1/8 pouce (norme de filetage non précisée) ; flexible intérieur 8 mm",
  "recommendedHose": {
    "innerDiameterMm": 8
  },
  "image": {
    "src": "/images/products/atlas-copco-8431026953-technical.webp",
    "alt": "Atlas Copco TWIST22 SR10, référence 8431026953 : 420 L/min à vide, référence 6,3 bar",
    "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/twist22-sr10-sku8431026953",
    "sourceLabel": "Repères techniques CompatAir d’après Atlas Copco"
  },
  "editorial": {
    "overview": "Atlas Copco TWIST22 SR10, référence 8431026953, demande 420 L/min à vide selon la fiche fabricant. Le dimensionnement utilise la pression de référence de 6,3 bar documentée dans le catalogue Industrial Tools and Solutions UK. Vitesse à vide : 700 tr/min. Couple maximal de la plage : 10 Nm.",
    "verifiedFacts": [
      "Vitesse à vide : 700 tr/min.",
      "Couple maximal de la plage : 10 Nm.",
      "Couple minimal de la plage : 1,5 Nm.",
  ...
  "specifications": [
    {
      ...
      "value": "700 tr/min",
      "evidenceIds": [
        "atlas-copco-8431026953-fiche-fabricant"
      ]
    },
    {
    ...
    },
    {
      ...
      "value": "6,3 bar",
      "evidenceIds": [
        "atlas-copco-8431026953-catalogue-uk"
      ]
    }
  ],
  "evidence": [
    {
      "id": "atlas-copco-8431026953-fiche-fabricant",
      "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/twist22-sr10-sku8431026953",
      "sourceLabel": "Atlas Copco, TWIST22 SR10, 8431026953",
    ...
    {
      "id": "atlas-copco-8431026953-catalogue-uk",
      ...
      "retrievedAt": "2026-09-26",
      "confidence": "A",
      "notes": "Référence 8431026953 présente au tableau. Conditions générales : air détendu à la pression atmosphérique, pression de travail 6,3 bar sauf exception. Le millésime de cette édition n’est pas affirmé."
    }
  ],
  "fieldSources": {
    "mpn": [
