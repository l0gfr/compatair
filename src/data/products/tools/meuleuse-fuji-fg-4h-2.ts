const product = {
	...
	"label": "Meuleuse pneumatique Fuji FG-4H-2",
	"brand": "Fuji",
	"model": "FG-4H-2",
	"mpn": "5412052853",
	"distributorSkus": [],
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/fuji-fg-4h-2-technical.webp",
		"alt": "Repères techniques Fuji FG-4H-2 : 780 L/min en charge, pression de travail 6,3 bar",
		"sourceUrl": "https://www.fujitools.com/en/products/5412052853",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche et la notice Fuji"
	},
	"editorial": {
		"overview": "Fuji FG-4H-2, référence 5412052853, présente une consommation en charge de 13 L/s, soit 780 L/min. La notice liée à cette fiche indique une pression de travail de 6,3 bar. Vitesse à vide : 9500 tr/min. Puissance maximale de l’outil : 690 W.",
		"verifiedFacts": [
			"Vitesse à vide : 9500 tr/min.",
			"Puissance maximale de l’outil : 690 W.",
			"Filetage de sortie : W1/2-12.",
	...
	"evidence": [
		{
			"id": "fuji-5412052853-official",
			"sourceUrl": "https://www.fujitools.com/en/products/5412052853",
			"sourceLabel": "Fuji, fiche officielle FG-4H-2, réf. 5412052853",
		...
		{
			"id": "fuji-5412052853-pressure-notice",
	...
	"fieldSources": {
		...
		"workingPressureBar": [
			"fuji-5412052853-pressure-notice"
		],
		"connectorSize": [
			"fuji-5412052853-official"
		],
