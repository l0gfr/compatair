...
const product = {
  "id": "atlas-copco-8431027835",
  "slug": "visseuse-atlas-copco-lum12-sr1",
  "categoryId": "visseuse",
  "category": "Visseuse pneumatique",
  "label": "Visseuse pneumatique Atlas Copco LUM12 SR1",
  "brand": "Atlas Copco",
  "model": "LUM12 SR1",
  "mpn": "8431027835",
  "variant": {
  ...
  "image": {
    "src": "/images/products/atlas-copco-8431027835-technical.webp",
    "alt": "Atlas Copco LUM12 SR1, référence 8431027835 : 360 L/min à vide, référence 6,3 bar",
    "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/lum12-sr1-sku8431027835",
    "sourceLabel": "Repères techniques CompatAir d’après Atlas Copco"
  },
  "editorial": {
    "overview": "Atlas Copco LUM12 SR1, référence 8431027835, demande 360 L/min à vide selon la fiche fabricant. Le dimensionnement utilise la pression de référence de 6,3 bar documentée dans le catalogue Industrial Tools and Solutions UK. Vitesse à vide : 2200 tr/min. Couple maximal de la plage : 1,8 Nm.",
    "verifiedFacts": [
      "Vitesse à vide : 2200 tr/min.",
      "Couple maximal de la plage : 1,8 Nm.",
      "Couple minimal de la plage : 0,6 Nm.",
  ...
  "specifications": [
    {
      ...
      "value": "2200 tr/min",
      "evidenceIds": [
        "atlas-copco-8431027835-fiche-fabricant"
      ]
    },
    {
    ...
    },
    {
      ...
      "value": "6,3 bar",
      "evidenceIds": [
        "atlas-copco-8431027835-catalogue-uk"
      ]
    }
  ],
  "evidence": [
    {
      "id": "atlas-copco-8431027835-fiche-fabricant",
      "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/lum12-sr1-sku8431027835",
      "sourceLabel": "Atlas Copco, LUM12 SR1, 8431027835",
    ...
    {
      "id": "atlas-copco-8431027835-catalogue-uk",
      ...
      "retrievedAt": "2026-09-26",
      "confidence": "A",
      "notes": "Référence 8431027835 présente au tableau. Conditions générales : air détendu à la pression atmosphérique, pression de travail 6,3 bar sauf exception. Le millésime de cette édition n’est pas affirmé."
    }
  ],
  "fieldSources": {
    "mpn": [
