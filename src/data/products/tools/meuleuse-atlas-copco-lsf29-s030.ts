...
const product = {
  "id": "atlas-copco-8423012718",
  "slug": "meuleuse-atlas-copco-lsf29-s030",
  "categoryId": "meuleuse",
  "category": "Meuleuse pneumatique",
  "label": "Meuleuse pneumatique Atlas Copco LSF29 S030",
  "brand": "Atlas Copco",
  "model": "LSF29 S030",
  "mpn": "8423012718",
  "variant": {
  ...
  "image": {
    "src": "/images/products/atlas-copco-8423012718-technical.webp",
    "alt": "Atlas Copco LSF29 S030, référence 8423012718 : 1 200 L/min à puissance maximale, référence 6,3 bar",
    "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/material-removal-tools/precision-grinding/lsf29-s030-sku8423012718",
    "sourceLabel": "Repères techniques CompatAir d’après Atlas Copco"
  },
  "editorial": {
    "overview": "Atlas Copco LSF29 S030, référence 8423012718, demande 1 200 L/min à puissance maximale selon la fiche fabricant. Le dimensionnement utilise la pression de référence de 6,3 bar documentée dans le catalogue Industrial Tools and Solutions UK. Vitesse maximale à vide : 3000 tr/min. Puissance maximale : 0,8 kW.",
    "verifiedFacts": [
      "Vitesse maximale à vide : 3000 tr/min.",
      "Puissance maximale : 0,8 kW.",
      "Masse : 1,2 kg.",
  ...
  "specifications": [
    {
      ...
      "value": "3000 tr/min",
      "evidenceIds": [
        "atlas-copco-8423012718-fiche-fabricant"
      ]
    },
    {
    ...
    },
    {
      ...
      "value": "6,3 bar",
      "evidenceIds": [
        "atlas-copco-8423012718-catalogue-uk"
      ]
    }
  ],
  "evidence": [
    {
      "id": "atlas-copco-8423012718-fiche-fabricant",
      "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/material-removal-tools/precision-grinding/lsf29-s030-sku8423012718",
      "sourceLabel": "Atlas Copco, LSF29 S030, 8423012718",
    ...
    {
      "id": "atlas-copco-8423012718-catalogue-uk",
      ...
      "retrievedAt": "2026-09-26",
      "confidence": "A",
      "notes": "Référence 8423012718 présente au tableau. Conditions générales : air détendu à la pression atmosphérique, pression de travail 6,3 bar sauf exception. Le millésime de cette édition n’est pas affirmé."
    }
  ],
  "fieldSources": {
    "mpn": [
