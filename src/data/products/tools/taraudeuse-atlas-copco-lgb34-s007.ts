...
const product = {
  "id": "atlas-copco-8421031172",
  "slug": "taraudeuse-atlas-copco-lgb34-s007",
  "categoryId": "taraudeuse",
  "category": "Taraudeuse pneumatique",
  "label": "Taraudeuse pneumatique Atlas Copco LGB34 S007",
  "brand": "Atlas Copco",
  "model": "LGB34 S007",
  "mpn": "8421031172",
  "variant": {
  ...
  "image": {
    "src": "/images/products/atlas-copco-8421031172-technical.webp",
    "alt": "Atlas Copco LGB34 S007, référence 8421031172 : 450 L/min à vide, référence 6,3 bar",
    "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/drilling-solutions/lgb34-s007-sku8421031172",
    "sourceLabel": "Repères techniques CompatAir d’après Atlas Copco"
  },
  "editorial": {
    "overview": "Atlas Copco LGB34 S007, référence 8421031172, demande 450 L/min à vide selon la fiche fabricant. Le dimensionnement utilise la pression de référence de 6,3 bar documentée dans le catalogue Industrial Tools and Solutions UK. Vitesse à vide en marche avant : 700 tr/min. Vitesse à vide en marche arrière : 1400 tr/min.",
    "verifiedFacts": [
      "Vitesse à vide en marche avant : 700 tr/min.",
      "Vitesse à vide en marche arrière : 1400 tr/min.",
      "Masse : 1,8 kg.",
  ...
  "specifications": [
    {
      ...
      "value": "700 tr/min",
      "evidenceIds": [
        "atlas-copco-8421031172-fiche-fabricant"
      ]
    },
    {
    ...
    },
    {
      ...
      "value": "6,3 bar",
      "evidenceIds": [
        "atlas-copco-8421031172-catalogue-uk"
      ]
    }
  ],
  "evidence": [
    {
      "id": "atlas-copco-8421031172-fiche-fabricant",
      "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/drilling-solutions/lgb34-s007-sku8421031172",
      "sourceLabel": "Atlas Copco, LGB34 S007, 8421031172",
    ...
    {
      "id": "atlas-copco-8421031172-catalogue-uk",
      ...
      "retrievedAt": "2026-09-26",
      "confidence": "A",
      "notes": "Référence 8421031172 présente au tableau. Conditions générales : air détendu à la pression atmosphérique, pression de travail 6,3 bar sauf exception. Le millésime de cette édition n’est pas affirmé."
    }
  ],
  "fieldSources": {
    "mpn": [
