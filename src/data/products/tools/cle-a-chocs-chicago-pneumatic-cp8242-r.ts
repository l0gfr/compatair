const product = {
	"id": "chicago-pneumatic-cp8242-r",
	"slug": "cle-a-chocs-chicago-pneumatic-cp8242-r",
	"categoryId": "cle-a-chocs",
	"category": "Clé à chocs",
	"label": "Clé à chocs Chicago Pneumatic CP8242-R",
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/chicago-pneumatic-cp8242-r.webp",
		"alt": "Repères techniques CP8242-R : 600 L/min en charge, 6,3 bar, flexible 10 mm",
		"sourceUrl": "https://tools.cp.com/en/products/impactwrenches/cp8242-r-sku6151590240",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche Chicago Pneumatic"
	},
	"editorial": {
		"overview": "CP8242-R, référence fabricant 6151590240, demande 600 L/min en charge (10 L/s). La fiche Chicago Pneumatic indique une pression dynamique maximale de 6,3 bar, retenue comme point de comparaison. Vitesse à vide : 11500 tr/min.",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "cp-6151590240-official",
			"sourceUrl": "https://tools.cp.com/en/products/impactwrenches/cp8242-r-sku6151590240",
			"sourceLabel": "Chicago Pneumatic, fiche officielle CP8242-R, réf. 6151590240",
