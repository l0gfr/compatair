const product = {
	"id": "chicago-pneumatic-cp3512",
	"slug": "ponceuse-orbitale-chicago-pneumatic-cp3512",
	"categoryId": "ponceuse-orbitale",
	"category": "Ponceuse orbitale pneumatique",
	"label": "Ponceuse orbitale pneumatique Chicago Pneumatic CP3512",
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/chicago-pneumatic-cp3512-catalogue-2026.webp",
		"alt": "Repères techniques CP3512 : 456 L/min en charge à 6,3 bar",
	...
	"editorial": {
		"overview": "CP3512, référence 6151933512, demande 456 L/min en charge à 6,3 bar selon le catalogue Chicago Pneumatic v6.08.2026, page 170. Vitesse à vide : 12 000 tr/min. Puissance de l’outil : 210 W.",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "cp-catalog-202608-6151933512",
			"sourceUrl": "https://tools.cp.com/content/dam/pim/itba/cp/literature/catalogs/General-Industry_catalog_CP_EN.pdf#page=170",
			"sourceLabel": "Chicago Pneumatic, catalogue v6.08.2026, p. 170, réf. 6151933512",
	...
	"notes": [
		...
		"Source versionnée : catalogue v6.08.2026, page 170, référence 6151933512."
	],
