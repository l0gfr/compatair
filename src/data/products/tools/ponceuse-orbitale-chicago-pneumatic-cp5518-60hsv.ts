const product = {
	"id": "chicago-pneumatic-cp5518-60hsv",
	"slug": "ponceuse-orbitale-chicago-pneumatic-cp5518-60hsv",
	"categoryId": "ponceuse-orbitale",
	"category": "Ponceuse orbitale pneumatique",
	"label": "Ponceuse orbitale pneumatique Chicago Pneumatic CP5518-60HSV",
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/chicago-pneumatic-cp5518-60hsv-catalogue-2026.webp",
		"alt": "Repères techniques CP5518-60HSV : 660 L/min en charge à 6,3 bar",
	...
	"editorial": {
		"overview": "CP5518-60HSV, référence 6151702820, demande 660 L/min en charge à 6,3 bar selon le catalogue Chicago Pneumatic v6.08.2026, page 176. Vitesse à vide : 10 000 tr/min. Puissance de l’outil : 375 W.",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "cp-catalog-202608-6151702820",
			"sourceUrl": "https://tools.cp.com/content/dam/pim/itba/cp/literature/catalogs/General-Industry_catalog_CP_EN.pdf#page=176",
			"sourceLabel": "Chicago Pneumatic, catalogue v6.08.2026, p. 176, réf. 6151702820",
	...
	"notes": [
		...
		"Source versionnée : catalogue v6.08.2026, page 176, référence 6151702820."
	],
