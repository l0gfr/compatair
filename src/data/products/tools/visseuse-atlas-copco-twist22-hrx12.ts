...
const product = {
  "id": "atlas-copco-8431026928",
  "slug": "visseuse-atlas-copco-twist22-hrx12",
  "categoryId": "visseuse",
  "category": "Visseuse pneumatique",
  "label": "Visseuse pneumatique Atlas Copco TWIST22 HRX12",
  "brand": "Atlas Copco",
  "model": "TWIST22 HRX12",
  "mpn": "8431026928",
  "variant": {
    ...
    "distinguishingAttributes": {
      ...
      "Couple minimal de la plage": "5 Nm",
      "Couple maximal sur assemblage élastique": "12 Nm",
      "Couple minimal sur assemblage élastique": "5 Nm",
      "Masse": "1,05 kg",
      "Longueur": "205 mm",
  ...
  "image": {
    "src": "/images/products/atlas-copco-8431026928-technical.webp",
    "alt": "Atlas Copco TWIST22 HRX12, référence 8431026928 : 540 L/min à vide, référence 6,3 bar",
    "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/twist22-hrx12-sku8431026928",
    "sourceLabel": "Repères techniques CompatAir d’après Atlas Copco"
  },
  "editorial": {
    "overview": "Atlas Copco TWIST22 HRX12, référence 8431026928, demande 540 L/min à vide selon la fiche fabricant. Le dimensionnement utilise la pression de référence de 6,3 bar documentée dans le catalogue Industrial Tools and Solutions UK. Vitesse à vide : 500 tr/min. Couple maximal de la plage : 12 Nm.",
    "verifiedFacts": [
      "Vitesse à vide : 500 tr/min.",
      "Couple maximal de la plage : 12 Nm.",
      "Couple minimal de la plage : 5 Nm.",
  ...
  "specifications": [
    {
      ...
      "value": "500 tr/min",
      "evidenceIds": [
        "atlas-copco-8431026928-fiche-fabricant"
      ]
    },
    {
    ...
    },
    {
      ...
      "value": "6,3 bar",
      "evidenceIds": [
        "atlas-copco-8431026928-catalogue-uk"
      ]
    }
  ],
  "evidence": [
    {
      "id": "atlas-copco-8431026928-fiche-fabricant",
      "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/twist22-hrx12-sku8431026928",
      "sourceLabel": "Atlas Copco, TWIST22 HRX12, 8431026928",
    ...
    {
      "id": "atlas-copco-8431026928-catalogue-uk",
      ...
      "retrievedAt": "2026-09-26",
      "confidence": "A",
      "notes": "Référence 8431026928 présente au tableau. Conditions générales : air détendu à la pression atmosphérique, pression de travail 6,3 bar sauf exception. Le millésime de cette édition n’est pas affirmé."
    }
  ],
  "fieldSources": {
    "mpn": [
