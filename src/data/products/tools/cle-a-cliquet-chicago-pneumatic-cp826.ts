const product = {
	id: 'chicago-pneumatic-cp826', slug: 'cle-a-cliquet-chicago-pneumatic-cp826', categoryId: 'cle-a-cliquet', category: 'Clé à cliquet', label: 'Clé à cliquet pneumatique Chicago Pneumatic CP826 1/4 pouce', brand: 'Chicago Pneumatic', model: 'CP826', mpn: 'T025074',
