...
const product = {
  "id": "atlas-copco-8431053461",
  "slug": "boulonneuse-atlas-copco-ltd28-r8-re",
  "categoryId": "boulonneuse",
  "category": "Boulonneuse pneumatique",
  "label": "Boulonneuse pneumatique Atlas Copco LTD28 R8-RE",
  "brand": "Atlas Copco",
  "model": "LTD28 R8-RE",
  "mpn": "8431053461",
  "variant": {
  ...
  "image": {
    "src": "/images/products/atlas-copco-8431053461-technical.webp",
    "alt": "Atlas Copco LTD28 R8-RE, référence 8431053461 : 480 L/min à vide, référence 6,3 bar",
    "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/ltd28-r8-re-sku8431053461",
    "sourceLabel": "Repères techniques CompatAir d’après Atlas Copco"
  },
  "editorial": {
    "overview": "Atlas Copco LTD28 R8-RE, référence 8431053461, demande 480 L/min à vide selon la fiche fabricant. Le dimensionnement utilise la pression de référence de 6,3 bar documentée dans le catalogue Industrial Tools and Solutions UK. Vitesse à vide : 1100 tr/min. Couple maximal de la plage : 8 Nm.",
    "verifiedFacts": [
      "Vitesse à vide : 1100 tr/min.",
      "Couple maximal de la plage : 8 Nm.",
      "Couple minimal de la plage : 3 Nm.",
  ...
  "specifications": [
    {
      ...
      "value": "1100 tr/min",
      "evidenceIds": [
        "atlas-copco-8431053461-fiche-fabricant"
      ]
    },
    {
    ...
    },
    {
      ...
      "value": "6,3 bar",
      "evidenceIds": [
        "atlas-copco-8431053461-catalogue-uk"
      ]
    }
  ],
  "evidence": [
    {
      "id": "atlas-copco-8431053461-fiche-fabricant",
      "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/ltd28-r8-re-sku8431053461",
      "sourceLabel": "Atlas Copco, LTD28 R8-RE, 8431053461",
    ...
    {
      "id": "atlas-copco-8431053461-catalogue-uk",
      ...
      "retrievedAt": "2026-09-26",
      "confidence": "A",
      "notes": "Référence 8431053461 présente au tableau. Conditions générales : air détendu à la pression atmosphérique, pression de travail 6,3 bar sauf exception. Le millésime de cette édition n’est pas affirmé."
    }
  ],
  "fieldSources": {
    "mpn": [
