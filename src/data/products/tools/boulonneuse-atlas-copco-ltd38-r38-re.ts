...
const product = {
  "id": "atlas-copco-8431053578",
  "slug": "boulonneuse-atlas-copco-ltd38-r38-re",
  "categoryId": "boulonneuse",
  "category": "Boulonneuse pneumatique",
  "label": "Boulonneuse pneumatique Atlas Copco LTD38 R38-RE",
  "brand": "Atlas Copco",
  "model": "LTD38 R38-RE",
  "mpn": "8431053578",
  "variant": {
  ...
  "image": {
    "src": "/images/products/atlas-copco-8431053578-technical.webp",
    "alt": "Atlas Copco LTD38 R38-RE, référence 8431053578 : 960 L/min à vide, référence 6,3 bar",
    "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/ltd38-r38-re-sku8431053578",
    "sourceLabel": "Repères techniques CompatAir d’après Atlas Copco"
  },
  "editorial": {
    "overview": "Atlas Copco LTD38 R38-RE, référence 8431053578, demande 960 L/min à vide selon la fiche fabricant. Le dimensionnement utilise la pression de référence de 6,3 bar documentée dans le catalogue Industrial Tools and Solutions UK. Vitesse à vide : 480 tr/min. Couple maximal de la plage : 38 Nm.",
    "verifiedFacts": [
      "Vitesse à vide : 480 tr/min.",
      "Couple maximal de la plage : 38 Nm.",
      "Couple minimal de la plage : 19 Nm.",
  ...
  "specifications": [
    {
      ...
      "value": "480 tr/min",
      "evidenceIds": [
        "atlas-copco-8431053578-fiche-fabricant"
      ]
    },
    {
    ...
    },
    {
      ...
      "value": "6,3 bar",
      "evidenceIds": [
        "atlas-copco-8431053578-catalogue-uk"
      ]
    }
  ],
  "evidence": [
    {
      "id": "atlas-copco-8431053578-fiche-fabricant",
      "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/ltd38-r38-re-sku8431053578",
      "sourceLabel": "Atlas Copco, LTD38 R38-RE, 8431053578",
    ...
    {
      "id": "atlas-copco-8431053578-catalogue-uk",
      ...
      "retrievedAt": "2026-09-26",
      "confidence": "A",
      "notes": "Référence 8431053578 présente au tableau. Conditions générales : air détendu à la pression atmosphérique, pression de travail 6,3 bar sauf exception. Le millésime de cette édition n’est pas affirmé."
    }
  ],
  "fieldSources": {
    "mpn": [
