const product = {
	...
	"label": "Ponceuse vibrante pneumatique Chicago Pneumatic CP5303-R5",
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/chicago-pneumatic-cp5303-r5-catalogue-2026.webp",
		"alt": "Repères techniques CP5303-R5 : 480 L/min en charge à 6,3 bar",
	...
	"editorial": {
		"overview": "CP5303-R5, référence 6151702330, demande 480 L/min en charge à 6,3 bar selon le catalogue Chicago Pneumatic v6.08.2026, page 174. Vitesse à vide : 10 000 tr/min. Puissance de l’outil : 210 W.",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "cp-catalog-202608-6151702330",
			"sourceUrl": "https://tools.cp.com/content/dam/pim/itba/cp/literature/catalogs/General-Industry_catalog_CP_EN.pdf#page=174",
			"sourceLabel": "Chicago Pneumatic, catalogue v6.08.2026, p. 174, réf. 6151702330",
	...
	"notes": [
		...
		"Source versionnée : catalogue v6.08.2026, page 174, référence 6151702330."
	],
