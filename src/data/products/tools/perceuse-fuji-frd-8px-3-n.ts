const product = {
	"id": "fuji-frd-8px-3-n",
	"slug": "perceuse-fuji-frd-8px-3-n",
	"categoryId": "perceuse",
	"category": "Perceuse pneumatique",
	"label": "Perceuse pneumatique Fuji FRD-8PX-3 N",
	"brand": "Fuji",
	"model": "FRD-8PX-3 N",
	"mpn": "5412053367",
	"distributorSkus": [],
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/fuji-frd-8px-3-n-technical.webp",
		"alt": "Repères techniques Fuji FRD-8PX-3 N : 780 L/min en charge, pression de travail 6,3 bar",
		"sourceUrl": "https://www.fujitools.com/en/products/5412053367",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche et la notice Fuji"
	},
	"editorial": {
		"overview": "Fuji FRD-8PX-3 N, référence 5412053367, présente une consommation en charge de 13 L/s, soit 780 L/min. La notice liée à cette fiche indique une pression de travail de 6,3 bar. Vitesse à vide : 900 tr/min. Puissance maximale de l’outil : 400 W.",
		"verifiedFacts": [
			"Vitesse à vide : 900 tr/min.",
			"Puissance maximale de l’outil : 400 W.",
			"Capacité maximale du mandrin (mm) : 13.",
	...
	"evidence": [
		{
			"id": "fuji-5412053367-official",
			"sourceUrl": "https://www.fujitools.com/en/products/5412053367",
			"sourceLabel": "Fuji, fiche officielle FRD-8PX-3 N, réf. 5412053367",
		...
		{
			"id": "fuji-5412053367-pressure-notice",
	...
	"fieldSources": {
		...
		"workingPressureBar": [
			"fuji-5412053367-pressure-notice"
		],
		"connectorSize": [
			"fuji-5412053367-official"
		],
