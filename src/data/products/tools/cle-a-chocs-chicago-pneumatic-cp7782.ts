const product = {
	"id": "chicago-pneumatic-cp7782",
	"slug": "cle-a-chocs-chicago-pneumatic-cp7782",
	"categoryId": "cle-a-chocs",
	"category": "Clé à chocs",
	"label": "Clé à chocs Chicago Pneumatic CP7782",
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/chicago-pneumatic-cp7782.webp",
		"alt": "Repères techniques CP7782 : 1 140 L/min en charge, 6,3 bar, flexible 13 mm",
		"sourceUrl": "https://tools.cp.com/en/products/impactwrenches/cp7782-sku8941077820",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche Chicago Pneumatic"
	},
	"editorial": {
		"overview": "CP7782, référence fabricant 8941077820, demande 1 140 L/min en charge (19 L/s). La fiche Chicago Pneumatic indique une pression dynamique maximale de 6,3 bar, retenue comme point de comparaison. Vitesse à vide : 5200 tr/min.",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "cp-8941077820-official",
			"sourceUrl": "https://tools.cp.com/en/products/impactwrenches/cp7782-sku8941077820",
			"sourceLabel": "Chicago Pneumatic, fiche officielle CP7782, réf. 8941077820",
