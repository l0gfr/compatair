const product = {
	...
	"label": "Meuleuse pneumatique Fuji FA-150KG-5",
	"brand": "Fuji",
	"model": "FA-150KG-5",
	"mpn": "5412052239",
	"distributorSkus": [],
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/fuji-fa-150kg-5-technical.webp",
		"alt": "Repères techniques Fuji FA-150KG-5 : 1 260 L/min en charge, pression de travail 6,3 bar",
		"sourceUrl": "https://www.fujitools.com/en/products/5412052239",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche et la notice Fuji"
	},
	"editorial": {
		"overview": "Fuji FA-150KG-5, référence 5412052239, présente une consommation en charge de 21 L/s, soit 1 260 L/min. La notice liée à cette fiche indique une pression de travail de 6,3 bar. Vitesse à vide : 7600 tr/min. Puissance maximale de l’outil : 900 W.",
		"verifiedFacts": [
			"Vitesse à vide : 7600 tr/min.",
			"Puissance maximale de l’outil : 900 W.",
			"Filetage de sortie : W1/2-16.",
	...
	"evidence": [
		{
			"id": "fuji-5412052239-official",
			"sourceUrl": "https://www.fujitools.com/en/products/5412052239",
			"sourceLabel": "Fuji, fiche officielle FA-150KG-5, réf. 5412052239",
		...
		{
			"id": "fuji-5412052239-pressure-notice",
	...
	"fieldSources": {
		...
		"workingPressureBar": [
			"fuji-5412052239-pressure-notice"
		],
		"connectorSize": [
			"fuji-5412052239-official"
		],
