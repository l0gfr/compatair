...
const product = {
  "id": "atlas-copco-8423122482",
  "slug": "meuleuse-atlas-copco-lsf19-s460-1",
  "categoryId": "meuleuse",
  "category": "Meuleuse pneumatique",
  "label": "Meuleuse pneumatique Atlas Copco LSF19 S460-1",
  "brand": "Atlas Copco",
  "model": "LSF19 S460-1",
  "mpn": "8423122482",
  "variant": {
  ...
  "image": {
    "src": "/images/products/atlas-copco-8423122482-technical.webp",
    "alt": "Atlas Copco LSF19 S460-1, référence 8423122482 : 900 L/min à vide, référence 6,3 bar",
    "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/material-removal-tools/precision-grinding/lsf19-s460-1-sku8423122482",
    "sourceLabel": "Repères techniques CompatAir d’après Atlas Copco"
  },
  "editorial": {
    "overview": "Atlas Copco LSF19 S460-1, référence 8423122482, demande 900 L/min à vide selon la fiche fabricant. Le dimensionnement utilise la pression de référence de 6,3 bar documentée dans le catalogue Industrial Tools and Solutions UK. Vitesse maximale à vide : 46000 tr/min. Puissance maximale : 0,5 kW.",
    "verifiedFacts": [
      "Vitesse maximale à vide : 46000 tr/min.",
      "Puissance maximale : 0,5 kW.",
      "Masse : 0,5 kg.",
  ...
  "specifications": [
    {
      ...
      "value": "46000 tr/min",
      "evidenceIds": [
        "atlas-copco-8423122482-fiche-fabricant"
      ]
    },
    {
    ...
    },
    {
      ...
      "value": "6,3 bar",
      "evidenceIds": [
        "atlas-copco-8423122482-catalogue-uk"
      ]
    }
  ],
  "evidence": [
    {
      "id": "atlas-copco-8423122482-fiche-fabricant",
      "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/material-removal-tools/precision-grinding/lsf19-s460-1-sku8423122482",
      "sourceLabel": "Atlas Copco, LSF19 S460-1, 8423122482",
    ...
    {
      "id": "atlas-copco-8423122482-catalogue-uk",
      ...
      "retrievedAt": "2026-09-26",
      "confidence": "A",
      "notes": "Référence 8423122482 présente au tableau. Conditions générales : air détendu à la pression atmosphérique, pression de travail 6,3 bar sauf exception. Le millésime de cette édition n’est pas affirmé."
    }
  ],
  "fieldSources": {
    "mpn": [
