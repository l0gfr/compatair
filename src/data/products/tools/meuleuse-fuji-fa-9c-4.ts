const product = {
	...
	"label": "Meuleuse pneumatique Fuji FA-9C-4",
	"brand": "Fuji",
	"model": "FA-9C-4",
	"mpn": "5412052384",
	"distributorSkus": [],
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/fuji-fa-9c-4-technical.webp",
		"alt": "Repères techniques Fuji FA-9C-4 : 1 260 L/min en charge, pression de travail 6,3 bar",
		"sourceUrl": "https://www.fujitools.com/en/products/5412052384",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche et la notice Fuji"
	},
	"editorial": {
		"overview": "Fuji FA-9C-4, référence 5412052384, présente une consommation en charge de 21 L/s, soit 1 260 L/min. La notice liée à cette fiche indique une pression de travail de 6,3 bar. Vitesse à vide : 5900 tr/min. Puissance maximale de l’outil : 1620 W.",
		"verifiedFacts": [
			"Vitesse à vide : 5900 tr/min.",
			"Puissance maximale de l’outil : 1620 W.",
			"Filetage de sortie : 5/8-11 UNC.",
	...
	"evidence": [
		{
			"id": "fuji-5412052384-official",
			"sourceUrl": "https://www.fujitools.com/en/products/5412052384",
			"sourceLabel": "Fuji, fiche officielle FA-9C-4, réf. 5412052384",
		...
		{
			"id": "fuji-5412052384-pressure-notice",
	...
	"fieldSources": {
		...
		"workingPressureBar": [
			"fuji-5412052384-pressure-notice"
		],
		"connectorSize": [
			"fuji-5412052384-official"
		],
