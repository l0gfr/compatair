const product = {
	...
	"label": "Clé à chocs Fuji FW-330-1CL N EC",
	"brand": "Fuji",
	"model": "FW-330-1CL N EC",
	"mpn": "5412104149",
	"distributorSkus": [],
	"identifierAliases": [],
	"variant": {
		"familyId": "fuji-449443",
		"label": "FW-330-1CL N EC",
		"distinguishingAttributes": {
			"Vitesse à vide": "5000 tr/min",
			"Carré d’entraînement (pouces)": "1",
			"Forme de la poignée": "Straight handle",
			"Couple maximal en marche arrière": "2600 Nm",
			"Entrée d’air": "1/2 pouce NPT"
		}
	},
	"connectorSize": "Entrée 1/2 pouce NPT, flexible intérieur 12,7 mm sur 5 m",
	"usagePattern": "burst",
	"recommendedHose": {
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/fuji-fw-330-1cl-n-ec-technical.webp",
		"alt": "Repères techniques Fuji FW-330-1CL N EC : 1 140 L/min en charge, pression de travail 6,3 bar",
		"sourceUrl": "https://www.fujitools.com/en/products/5412104149",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche et la notice Fuji"
	},
	"editorial": {
		"overview": "Fuji FW-330-1CL N EC, référence 5412104149, présente une consommation en charge de 19 L/s, soit 1 140 L/min. La notice liée à cette fiche indique une pression de travail de 6,3 bar. Vitesse à vide : 5000 tr/min. Carré d’entraînement (pouces) : 1.",
		"verifiedFacts": [
			"Vitesse à vide : 5000 tr/min.",
			"Carré d’entraînement (pouces) : 1.",
			"Forme de la poignée : Straight handle.",
			"Couple maximal en marche arrière : 2600 Nm.",
			"Entrée 1/2 pouce NPT ; flexible de 12,7 mm de diamètre intérieur sur 5 m."
		],
		"limitations": [
	...
	"evidence": [
		{
			"id": "fuji-5412104149-official",
			"sourceUrl": "https://www.fujitools.com/en/products/5412104149",
			"sourceLabel": "Fuji, fiche officielle FW-330-1CL N EC, réf. 5412104149",
		...
		{
			"id": "fuji-5412104149-pressure-notice",
	...
	"fieldSources": {
		...
		"workingPressureBar": [
			"fuji-5412104149-pressure-notice"
		],
		"connectorSize": [
			"fuji-5412104149-official"
		],
