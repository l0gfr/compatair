...
const product = {
  "id": "atlas-copco-8431026947",
  "slug": "visseuse-atlas-copco-lum22-sr6",
  "categoryId": "visseuse",
  "category": "Visseuse pneumatique",
  "label": "Visseuse pneumatique Atlas Copco LUM22 SR6",
  "brand": "Atlas Copco",
  "model": "LUM22 SR6",
  "mpn": "8431026947",
  "variant": {
  ...
  "image": {
    "src": "/images/products/atlas-copco-8431026947-technical.webp",
    "alt": "Atlas Copco LUM22 SR6, référence 8431026947 : 420 L/min à vide, référence 6,3 bar",
    "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/lum22-sr6-sku8431026947",
    "sourceLabel": "Repères techniques CompatAir d’après Atlas Copco"
  },
  "editorial": {
    "overview": "Atlas Copco LUM22 SR6, référence 8431026947, demande 420 L/min à vide selon la fiche fabricant. Le dimensionnement utilise la pression de référence de 6,3 bar documentée dans le catalogue Industrial Tools and Solutions UK. Vitesse à vide : 1000 tr/min. Couple maximal de la plage : 6 Nm.",
    "verifiedFacts": [
      "Vitesse à vide : 1000 tr/min.",
      "Couple maximal de la plage : 6 Nm.",
      "Couple minimal de la plage : 1,5 Nm.",
  ...
  "specifications": [
    {
      ...
      "value": "1000 tr/min",
      "evidenceIds": [
        "atlas-copco-8431026947-fiche-fabricant"
      ]
    },
    {
    ...
    },
    {
      ...
      "value": "6,3 bar",
      "evidenceIds": [
        "atlas-copco-8431026947-catalogue-uk"
      ]
    }
  ],
  "evidence": [
    {
      "id": "atlas-copco-8431026947-fiche-fabricant",
      "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/lum22-sr6-sku8431026947",
      "sourceLabel": "Atlas Copco, LUM22 SR6, 8431026947",
    ...
    {
      "id": "atlas-copco-8431026947-catalogue-uk",
      ...
      "retrievedAt": "2026-09-26",
      "confidence": "A",
      "notes": "Référence 8431026947 présente au tableau. Conditions générales : air détendu à la pression atmosphérique, pression de travail 6,3 bar sauf exception. Le millésime de cette édition n’est pas affirmé."
    }
  ],
  "fieldSources": {
    "mpn": [
