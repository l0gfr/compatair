const product = {
		...
		fieldSources: { workingPressureBar: ['metabo-601581180-official'], airflowLpm: ['metabo-601581180-official'], connectorSize: ['metabo-601581180-official'] }, notes: ['Le débit dépend du réglage. Le calcul utilise 240 L/min par défaut.'],
	};
