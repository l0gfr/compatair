...
const product = {
  "id": "atlas-copco-8431027827",
  "slug": "visseuse-atlas-copco-lum12-pr2",
  "categoryId": "visseuse",
  "category": "Visseuse pneumatique",
  "label": "Visseuse pneumatique Atlas Copco LUM12 PR2",
  "brand": "Atlas Copco",
  "model": "LUM12 PR2",
  "mpn": "8431027827",
  "variant": {
    ...
    "distinguishingAttributes": {
      ...
      "Couple maximal de la plage": "2,3 Nm",
      "Couple minimal de la plage": "0,4 Nm",
      "Couple maximal sur assemblage élastique": "2,3 Nm",
      ...
      "Consommation à vide": "270 L/min (4.5 l/s)",
  ...
  "image": {
    "src": "/images/products/atlas-copco-8431027827-technical.webp",
    "alt": "Atlas Copco LUM12 PR2, référence 8431027827 : 270 L/min à vide, référence 6,3 bar",
    "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/lum12-pr2-sku8431027827",
    "sourceLabel": "Repères techniques CompatAir d’après Atlas Copco"
  },
  "editorial": {
    "overview": "Atlas Copco LUM12 PR2, référence 8431027827, demande 270 L/min à vide selon la fiche fabricant. Le dimensionnement utilise la pression de référence de 6,3 bar documentée dans le catalogue Industrial Tools and Solutions UK. Vitesse à vide : 1450 tr/min. Couple maximal de la plage : 2,3 Nm.",
    "verifiedFacts": [
      "Vitesse à vide : 1450 tr/min.",
      "Couple maximal de la plage : 2,3 Nm.",
      "Couple minimal de la plage : 0,4 Nm.",
      "Couple maximal sur assemblage élastique : 2,3 Nm.",
      "Consommation à vide : 270 L/min, convertis depuis 4.5 l/s.",
  ...
  "specifications": [
    {
      ...
      "value": "1450 tr/min",
      "evidenceIds": [
        "atlas-copco-8431027827-fiche-fabricant"
      ]
    },
    {
    ...
    },
    {
      ...
      "value": "6,3 bar",
      "evidenceIds": [
        "atlas-copco-8431027827-catalogue-uk"
      ]
    }
  ],
  "evidence": [
    {
      "id": "atlas-copco-8431027827-fiche-fabricant",
      "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/lum12-pr2-sku8431027827",
      "sourceLabel": "Atlas Copco, LUM12 PR2, 8431027827",
    ...
    {
      "id": "atlas-copco-8431027827-catalogue-uk",
      ...
      "retrievedAt": "2026-09-26",
      "confidence": "A",
      "notes": "Référence 8431027827 présente au tableau. Conditions générales : air détendu à la pression atmosphérique, pression de travail 6,3 bar sauf exception. Le millésime de cette édition n’est pas affirmé."
    }
  ],
  "fieldSources": {
    "mpn": [
