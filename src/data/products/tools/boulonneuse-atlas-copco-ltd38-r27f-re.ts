...
const product = {
  "id": "atlas-copco-8431053565",
  "slug": "boulonneuse-atlas-copco-ltd38-r27f-re",
  "categoryId": "boulonneuse",
  "category": "Boulonneuse pneumatique",
  "label": "Boulonneuse pneumatique Atlas Copco LTD38 R27F-RE",
  "brand": "Atlas Copco",
  "model": "LTD38 R27F-RE",
  "mpn": "8431053565",
  "variant": {
  ...
  "image": {
    "src": "/images/products/atlas-copco-8431053565-technical.webp",
    "alt": "Atlas Copco LTD38 R27F-RE, référence 8431053565 : 960 L/min à vide, référence 6,3 bar",
    "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/ltd38-r27f-re-sku8431053565",
    "sourceLabel": "Repères techniques CompatAir d’après Atlas Copco"
  },
  "editorial": {
    "overview": "Atlas Copco LTD38 R27F-RE, référence 8431053565, demande 960 L/min à vide selon la fiche fabricant. Le dimensionnement utilise la pression de référence de 6,3 bar documentée dans le catalogue Industrial Tools and Solutions UK. Vitesse à vide : 670 tr/min. Couple maximal de la plage : 27 Nm.",
    "verifiedFacts": [
      "Vitesse à vide : 670 tr/min.",
      "Couple maximal de la plage : 27 Nm.",
      "Couple minimal de la plage : 13 Nm.",
  ...
  "specifications": [
    {
      ...
      "value": "670 tr/min",
      "evidenceIds": [
        "atlas-copco-8431053565-fiche-fabricant"
      ]
    },
    {
    ...
    },
    {
      ...
      "value": "6,3 bar",
      "evidenceIds": [
        "atlas-copco-8431053565-catalogue-uk"
      ]
    }
  ],
  "evidence": [
    {
      "id": "atlas-copco-8431053565-fiche-fabricant",
      "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/ltd38-r27f-re-sku8431053565",
      "sourceLabel": "Atlas Copco, LTD38 R27F-RE, 8431053565",
    ...
    {
      "id": "atlas-copco-8431053565-catalogue-uk",
      ...
      "retrievedAt": "2026-09-26",
      "confidence": "A",
      "notes": "Référence 8431053565 présente au tableau. Conditions générales : air détendu à la pression atmosphérique, pression de travail 6,3 bar sauf exception. Le millésime de cette édition n’est pas affirmé."
    }
  ],
  "fieldSources": {
    "mpn": [
