const product = {
	"id": "chicago-pneumatic-cp0200b18-2f",
	"slug": "fouloir-chicago-pneumatic-cp0200b18-2f",
	"categoryId": "fouloir",
	"category": "Fouloir pneumatique",
	"label": "Fouloir pneumatique Chicago Pneumatic CP0200B18-2F",
	...
	"connectorSize": "Entrée 1/4 pouce NPT, flexible intérieur 13 mm sur 5 m",
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/chicago-pneumatic-cp0200b18-2f.webp",
		"alt": "Repères techniques CP0200B18-2F : 402 L/min en charge, 6,3 bar, flexible 13 mm",
		"sourceUrl": "https://tools.cp.com/en/products/percussivetools/cp0200b18-2f-sku6151618020",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche Chicago Pneumatic"
	},
	"editorial": {
		"overview": "CP0200B18-2F, référence fabricant 6151618020, demande 402 L/min en charge (6,7 L/s). La fiche Chicago Pneumatic indique une pression dynamique maximale de 6,3 bar, retenue comme point de comparaison. Course : 50 mm.",
		"verifiedFacts": [
			"Course : 50 mm.",
	...
	"evidence": [
		{
			"id": "cp-6151618020-official",
			"sourceUrl": "https://tools.cp.com/en/products/percussivetools/cp0200b18-2f-sku6151618020",
			"sourceLabel": "Chicago Pneumatic, fiche officielle CP0200B18-2F, réf. 6151618020",
