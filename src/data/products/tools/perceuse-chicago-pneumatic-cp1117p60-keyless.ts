const product = {
	...
	"label": "Perceuse pneumatique Chicago Pneumatic CP1117P60 (keyless)",
	"brand": "Chicago Pneumatic",
	"model": "CP1117P60 (keyless)",
	"mpn": "6151580100",
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/chicago-pneumatic-cp1117p60-keyless.webp",
		"alt": "Repères techniques CP1117P60 (keyless) : 840 L/min en charge, 6,3 bar, flexible 10 mm",
		"sourceUrl": "https://tools.cp.com/en/products/drills/cp1117p60-keyless-sku6151580100",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche Chicago Pneumatic"
	},
	"editorial": {
		"overview": "CP1117P60 (keyless), référence fabricant 6151580100, demande 840 L/min en charge (14 L/s). La fiche Chicago Pneumatic indique une pression dynamique maximale de 6,3 bar, retenue comme point de comparaison. Vitesse à vide : 6000 tr/min.",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "cp-6151580100-official",
			"sourceUrl": "https://tools.cp.com/en/products/drills/cp1117p60-keyless-sku6151580100",
			"sourceLabel": "Chicago Pneumatic, fiche officielle CP1117P60 (keyless), réf. 6151580100",
