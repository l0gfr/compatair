...
const product = {
  "id": "atlas-copco-8431026960",
  "slug": "visseuse-atlas-copco-lum22-pr5-350",
  "categoryId": "visseuse",
  "category": "Visseuse pneumatique",
  "label": "Visseuse pneumatique Atlas Copco LUM22 PR5-350",
  "brand": "Atlas Copco",
  "model": "LUM22 PR5-350",
  "mpn": "8431026960",
  "variant": {
  ...
  "image": {
    "src": "/images/products/atlas-copco-8431026960-technical.webp",
    "alt": "Atlas Copco LUM22 PR5-350, référence 8431026960 : 420 L/min à vide, référence 6,3 bar",
    "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/lum22-pr5-350-sku8431026960",
    "sourceLabel": "Repères techniques CompatAir d’après Atlas Copco"
  },
  "editorial": {
    "overview": "Atlas Copco LUM22 PR5-350, référence 8431026960, demande 420 L/min à vide selon la fiche fabricant. Le dimensionnement utilise la pression de référence de 6,3 bar documentée dans le catalogue Industrial Tools and Solutions UK. Vitesse à vide : 350 tr/min. Couple maximal de la plage : 5 Nm.",
    "verifiedFacts": [
      "Vitesse à vide : 350 tr/min.",
      "Couple maximal de la plage : 5 Nm.",
      "Couple minimal de la plage : 0,4 Nm.",
  ...
  "specifications": [
    {
      ...
      "value": "350 tr/min",
      "evidenceIds": [
        "atlas-copco-8431026960-fiche-fabricant"
      ]
    },
    {
    ...
    },
    {
      ...
      "value": "6,3 bar",
      "evidenceIds": [
        "atlas-copco-8431026960-catalogue-uk"
      ]
    }
  ],
  "evidence": [
    {
      "id": "atlas-copco-8431026960-fiche-fabricant",
      "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/lum22-pr5-350-sku8431026960",
      "sourceLabel": "Atlas Copco, LUM22 PR5-350, 8431026960",
    ...
    {
      "id": "atlas-copco-8431026960-catalogue-uk",
      ...
      "retrievedAt": "2026-09-26",
      "confidence": "A",
      "notes": "Référence 8431026960 présente au tableau. Conditions générales : air détendu à la pression atmosphérique, pression de travail 6,3 bar sauf exception. Le millésime de cette édition n’est pas affirmé."
    }
  ],
  "fieldSources": {
    "mpn": [
