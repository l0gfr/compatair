...
const product = {
  "id": "atlas-copco-8431027854",
  "slug": "visseuse-atlas-copco-lum12-hrx3",
  "categoryId": "visseuse",
  "category": "Visseuse pneumatique",
  "label": "Visseuse pneumatique Atlas Copco LUM12 HRX3",
  "brand": "Atlas Copco",
  "model": "LUM12 HRX3",
  "mpn": "8431027854",
  "variant": {
  ...
  "image": {
    "src": "/images/products/atlas-copco-8431027854-technical.webp",
    "alt": "Atlas Copco LUM12 HRX3, référence 8431027854 : 360 L/min à vide, référence 6,3 bar",
    "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/lum12-hrx3-sku8431027854",
    "sourceLabel": "Repères techniques CompatAir d’après Atlas Copco"
  },
  "editorial": {
    "overview": "Atlas Copco LUM12 HRX3, référence 8431027854, demande 360 L/min à vide selon la fiche fabricant. Le dimensionnement utilise la pression de référence de 6,3 bar documentée dans le catalogue Industrial Tools and Solutions UK. Vitesse à vide : 1150 tr/min. Couple maximal de la plage : 3,5 Nm.",
    "verifiedFacts": [
      "Vitesse à vide : 1150 tr/min.",
      "Couple maximal de la plage : 3,5 Nm.",
      "Couple minimal de la plage : 0,4 Nm.",
  ...
  "specifications": [
    {
      ...
      "value": "1150 tr/min",
      "evidenceIds": [
        "atlas-copco-8431027854-fiche-fabricant"
      ]
    },
    {
    ...
    },
    {
      ...
      "value": "6,3 bar",
      "evidenceIds": [
        "atlas-copco-8431027854-catalogue-uk"
      ]
    }
  ],
  "evidence": [
    {
      "id": "atlas-copco-8431027854-fiche-fabricant",
      "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/lum12-hrx3-sku8431027854",
      "sourceLabel": "Atlas Copco, LUM12 HRX3, 8431027854",
    ...
    {
      "id": "atlas-copco-8431027854-catalogue-uk",
      ...
      "retrievedAt": "2026-09-26",
      "confidence": "A",
      "notes": "Référence 8431027854 présente au tableau. Conditions générales : air détendu à la pression atmosphérique, pression de travail 6,3 bar sauf exception. Le millésime de cette édition n’est pas affirmé."
    }
  ],
  "fieldSources": {
    "mpn": [
