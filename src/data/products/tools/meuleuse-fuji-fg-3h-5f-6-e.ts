const product = {
	"id": "fuji-fg-3h-5f-6-e",
	"slug": "meuleuse-fuji-fg-3h-5f-6-e",
	"categoryId": "meuleuse",
	"category": "Meuleuse pneumatique",
	"label": "Meuleuse pneumatique Fuji FG-3H-5F 6 E",
	"brand": "Fuji",
	"model": "FG-3H-5F 6 E",
	"mpn": "5412052832",
	"distributorSkus": [],
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/fuji-fg-3h-5f-6-e-technical.webp",
		"alt": "Repères techniques Fuji FG-3H-5F 6 E : 552 L/min en charge, pression de travail 6,3 bar",
		"sourceUrl": "https://www.fujitools.com/en/products/5412052832",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche et la notice Fuji"
	},
	"editorial": {
		"overview": "Fuji FG-3H-5F 6 E, référence 5412052832, présente une consommation en charge de 9,2 L/s, soit 552 L/min. La notice liée à cette fiche indique une pression de travail de 6,3 bar. Puissance maximale de l’outil : 52 W. Capacité de la pince (mm) : 6.",
		"verifiedFacts": [
			"Puissance maximale de l’outil : 52 W.",
			"Capacité de la pince (mm) : 6.",
			"Distance du bord à l’axe : 24 mm.",
	...
	"evidence": [
		{
			"id": "fuji-5412052832-official",
			"sourceUrl": "https://www.fujitools.com/en/products/5412052832",
			"sourceLabel": "Fuji, fiche officielle FG-3H-5F 6 E, réf. 5412052832",
		...
		{
			"id": "fuji-5412052832-pressure-notice",
	...
	"fieldSources": {
		...
		"workingPressureBar": [
			"fuji-5412052832-pressure-notice"
		],
		"connectorSize": [
			"fuji-5412052832-official"
		],
