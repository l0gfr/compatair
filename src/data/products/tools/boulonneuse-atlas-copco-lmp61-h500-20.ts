...
const product = {
  "id": "atlas-copco-8431080333",
  "slug": "boulonneuse-atlas-copco-lmp61-h500-20",
  "categoryId": "boulonneuse",
  "category": "Boulonneuse pneumatique",
  "label": "Boulonneuse pneumatique Atlas Copco LMP61 H500-20",
  "brand": "Atlas Copco",
  "model": "LMP61 H500-20",
  "mpn": "8431080333",
  "variant": {
    ...
    "distinguishingAttributes": {
      ...
      "Couple minimal de la plage": "300 Nm",
  ...
  "image": {
    "src": "/images/products/atlas-copco-8431080333-technical.webp",
    "alt": "Atlas Copco LMP61 H500-20, référence 8431080333 : 1 200 L/min à vide, référence 6,3 bar",
    "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/bolt-tightening-solutions/continuous-rotation/lmp61-h500-20-sku8431080333",
    "sourceLabel": "Repères techniques CompatAir d’après Atlas Copco"
  },
  "editorial": {
    "overview": "Atlas Copco LMP61 H500-20, référence 8431080333, demande 1 200 L/min à vide selon la fiche fabricant. Le dimensionnement utilise la pression de référence de 6,3 bar documentée dans le catalogue Industrial Tools and Solutions UK. Vitesse à vide : 450 tr/min. Couple maximal de la plage : 500 Nm.",
    "verifiedFacts": [
      "Vitesse à vide : 450 tr/min.",
      "Couple maximal de la plage : 500 Nm.",
      "Couple minimal de la plage : 300 Nm.",
  ...
  "specifications": [
    {
      ...
      "value": "450 tr/min",
      "evidenceIds": [
        "atlas-copco-8431080333-fiche-fabricant"
      ]
    },
    {
    ...
    },
    {
      ...
      "value": "6,3 bar",
      "evidenceIds": [
        "atlas-copco-8431080333-catalogue-uk"
      ]
    }
  ],
  "evidence": [
    {
      "id": "atlas-copco-8431080333-fiche-fabricant",
      "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/bolt-tightening-solutions/continuous-rotation/lmp61-h500-20-sku8431080333",
      "sourceLabel": "Atlas Copco, LMP61 H500-20, 8431080333",
    ...
    {
      "id": "atlas-copco-8431080333-catalogue-uk",
      ...
      "retrievedAt": "2026-09-26",
      "confidence": "A",
      "notes": "Référence 8431080333 présente au tableau. Conditions générales : air détendu à la pression atmosphérique, pression de travail 6,3 bar sauf exception. Le millésime de cette édition n’est pas affirmé."
    }
  ],
  "fieldSources": {
    "mpn": [
