const product = {
	id: 'chicago-pneumatic-cp7630', slug: 'cle-a-chocs-chicago-pneumatic-cp7630', categoryId: 'cle-a-chocs', category: 'Clé à chocs', label: 'Clé à chocs pneumatique Chicago Pneumatic CP7630 3/4 pouce', brand: 'Chicago Pneumatic', model: 'CP7630', mpn: '8941076300',
	...
	image: { src: '/images/products/chicago-pneumatic-cp7630.webp', alt: 'Clé à chocs Chicago Pneumatic CP7630', sourceUrl: 'https://tools.cp.com/en/products/impactwrenches/cp7630-sku8941076300', sourceLabel: 'Visuel officiel Chicago Pneumatic' },
