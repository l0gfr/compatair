const product = {
	"id": "fuji-fa-4c-1",
	"slug": "meuleuse-fuji-fa-4c-1",
	"categoryId": "meuleuse",
	"category": "Meuleuse pneumatique",
	"label": "Meuleuse pneumatique Fuji FA-4C-1",
	"brand": "Fuji",
	"model": "FA-4C-1",
	"mpn": "5412071122",
	"distributorSkus": [],
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/fuji-fa-4c-1-technical.webp",
		"alt": "Repères techniques Fuji FA-4C-1 : 1 260 L/min en charge, pression de travail 6,3 bar",
		"sourceUrl": "https://www.fujitools.com/en/products/5412071122",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche et la notice Fuji"
	},
	"editorial": {
		"overview": "Fuji FA-4C-1, référence 5412071122, présente une consommation en charge de 21 L/s, soit 1 260 L/min. La notice liée à cette fiche indique une pression de travail de 6,3 bar. Vitesse à vide : 13500 tr/min. Puissance maximale de l’outil : 550 W.",
		"verifiedFacts": [
			"Vitesse à vide : 13500 tr/min.",
			"Puissance maximale de l’outil : 550 W.",
			"Filetage de sortie : M8.",
	...
	"evidence": [
		{
			"id": "fuji-5412071122-official",
			"sourceUrl": "https://www.fujitools.com/en/products/5412071122",
			"sourceLabel": "Fuji, fiche officielle FA-4C-1, réf. 5412071122",
		...
		{
			"id": "fuji-5412071122-pressure-notice",
	...
	"fieldSources": {
		...
		"workingPressureBar": [
			"fuji-5412071122-pressure-notice"
		],
		"connectorSize": [
			"fuji-5412071122-official"
		],
