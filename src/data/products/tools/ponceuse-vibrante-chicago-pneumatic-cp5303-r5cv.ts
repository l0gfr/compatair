const product = {
	"id": "chicago-pneumatic-cp5303-r5cv",
	"slug": "ponceuse-vibrante-chicago-pneumatic-cp5303-r5cv",
	"categoryId": "ponceuse-vibrante",
	"category": "Ponceuse vibrante pneumatique",
	"label": "Ponceuse vibrante pneumatique Chicago Pneumatic CP5303-R5CV",
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/chicago-pneumatic-cp5303-r5cv-catalogue-2026.webp",
		"alt": "Repères techniques CP5303-R5CV : 480 L/min en charge à 6,3 bar",
	...
	"editorial": {
		"overview": "CP5303-R5CV, référence 6151702370, demande 480 L/min en charge à 6,3 bar selon le catalogue Chicago Pneumatic v6.08.2026, page 174. Vitesse à vide : 10 000 tr/min. Puissance de l’outil : 210 W.",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "cp-catalog-202608-6151702370",
			"sourceUrl": "https://tools.cp.com/content/dam/pim/itba/cp/literature/catalogs/General-Industry_catalog_CP_EN.pdf#page=174",
			"sourceLabel": "Chicago Pneumatic, catalogue v6.08.2026, p. 174, réf. 6151702370",
	...
	"notes": [
		...
		"Source versionnée : catalogue v6.08.2026, page 174, référence 6151702370."
	],
