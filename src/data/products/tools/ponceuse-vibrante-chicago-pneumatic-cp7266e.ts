const product = {
	...
	"label": "Ponceuse vibrante pneumatique Chicago Pneumatic CP7266E",
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/chicago-pneumatic-cp7266e.webp",
		"alt": "Repères techniques CP7266E : 510 L/min en charge, 6,3 bar, flexible 10 mm",
		"sourceUrl": "https://tools.cp.com/en/products/sanders/cp7266e-sku8941072660",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche Chicago Pneumatic"
	},
	"editorial": {
		"overview": "CP7266E, référence fabricant 8941072660, demande 510 L/min en charge (8,5 L/s). La fiche Chicago Pneumatic indique une pression dynamique maximale de 6,3 bar, retenue comme point de comparaison. Vitesse à vide : 10000 tr/min.",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "cp-8941072660-official",
			"sourceUrl": "https://tools.cp.com/en/products/sanders/cp7266e-sku8941072660",
			"sourceLabel": "Chicago Pneumatic, fiche officielle CP7266E, réf. 8941072660",
