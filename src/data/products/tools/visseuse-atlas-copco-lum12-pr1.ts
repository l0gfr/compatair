...
const product = {
  "id": "atlas-copco-8431027829",
  "slug": "visseuse-atlas-copco-lum12-pr1",
  "categoryId": "visseuse",
  "category": "Visseuse pneumatique",
  "label": "Visseuse pneumatique Atlas Copco LUM12 PR1",
  "brand": "Atlas Copco",
  "model": "LUM12 PR1",
  "mpn": "8431027829",
  "variant": {
    ...
    "distinguishingAttributes": {
      ...
      "Couple maximal de la plage": "1,6 Nm",
      "Couple minimal de la plage": "0,6 Nm",
      "Couple maximal sur assemblage élastique": "1,6 Nm",
  ...
  "image": {
    "src": "/images/products/atlas-copco-8431027829-technical.webp",
    "alt": "Atlas Copco LUM12 PR1, référence 8431027829 : 270 L/min à vide, référence 6,3 bar",
    "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/lum12-pr1-sku8431027829",
    "sourceLabel": "Repères techniques CompatAir d’après Atlas Copco"
  },
  "editorial": {
    "overview": "Atlas Copco LUM12 PR1, référence 8431027829, demande 270 L/min à vide selon la fiche fabricant. Le dimensionnement utilise la pression de référence de 6,3 bar documentée dans le catalogue Industrial Tools and Solutions UK. Vitesse à vide : 1900 tr/min. Couple maximal de la plage : 1,6 Nm.",
    "verifiedFacts": [
      "Vitesse à vide : 1900 tr/min.",
      "Couple maximal de la plage : 1,6 Nm.",
      "Couple minimal de la plage : 0,6 Nm.",
  ...
  "specifications": [
    {
      ...
      "value": "1900 tr/min",
      "evidenceIds": [
        "atlas-copco-8431027829-fiche-fabricant"
      ]
    },
    {
    ...
    },
    {
      ...
      "value": "6,3 bar",
      "evidenceIds": [
        "atlas-copco-8431027829-catalogue-uk"
      ]
    }
  ],
  "evidence": [
    {
      "id": "atlas-copco-8431027829-fiche-fabricant",
      "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/lum12-pr1-sku8431027829",
      "sourceLabel": "Atlas Copco, LUM12 PR1, 8431027829",
    ...
    {
      "id": "atlas-copco-8431027829-catalogue-uk",
      ...
      "retrievedAt": "2026-09-26",
      "confidence": "A",
      "notes": "Référence 8431027829 présente au tableau. Conditions générales : air détendu à la pression atmosphérique, pression de travail 6,3 bar sauf exception. Le millésime de cette édition n’est pas affirmé."
    }
  ],
  "fieldSources": {
    "mpn": [
