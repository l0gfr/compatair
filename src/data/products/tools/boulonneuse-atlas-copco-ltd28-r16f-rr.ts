...
const product = {
  "id": "atlas-copco-8431070386",
  "slug": "boulonneuse-atlas-copco-ltd28-r16f-rr",
  "categoryId": "boulonneuse",
  "category": "Boulonneuse pneumatique",
  "label": "Boulonneuse pneumatique Atlas Copco LTD28 R16F-RR",
  "brand": "Atlas Copco",
  "model": "LTD28 R16F-RR",
  "mpn": "8431070386",
  "variant": {
  ...
  "confidence": "A",
  "image": {
    "src": "/images/products/atlas-copco-8431070386-technical.webp",
    "alt": "Atlas Copco LTD28 R16F-RR, référence 8431070386 : 480 L/min à vide, référence 6,3 bar",
    "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/ltd28-r16f-rr-sku8431070386",
    "sourceLabel": "Repères techniques CompatAir d’après Atlas Copco"
  },
  "editorial": {
    "overview": "Atlas Copco LTD28 R16F-RR, référence 8431070386, demande 480 L/min à vide selon la fiche fabricant. Le dimensionnement utilise la pression de référence de 6,3 bar documentée dans le catalogue Industrial Tools and Solutions UK. Vitesse à vide : 620 tr/min. Couple maximal de la plage : 16 Nm.",
    "verifiedFacts": [
      "Vitesse à vide : 620 tr/min.",
      "Couple maximal de la plage : 16 Nm.",
      "Couple minimal de la plage : 7 Nm.",
  ...
  "specifications": [
    {
      ...
      "value": "620 tr/min",
      "evidenceIds": [
        "atlas-copco-8431070386-fiche-fabricant"
      ]
    },
    {
    ...
    },
    {
      ...
      "value": "6,3 bar",
      "evidenceIds": [
        "atlas-copco-8431070386-catalogue-uk"
      ]
    },
    {
  ...
  "evidence": [
    {
      "id": "atlas-copco-8431070386-fiche-fabricant",
      "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/ltd28-r16f-rr-sku8431070386",
      "sourceLabel": "Atlas Copco, LTD28 R16F-RR, 8431070386",
    ...
    {
      "id": "atlas-copco-8431070386-catalogue-uk",
      ...
      "retrievedAt": "2026-09-26",
      "confidence": "A",
      "notes": "Référence 8431070386 présente au tableau. Conditions générales : air détendu à la pression atmosphérique, pression de travail 6,3 bar sauf exception. Le millésime de cette édition n’est pas affirmé."
    }
  ],
  "fieldSources": {
    "mpn": [
