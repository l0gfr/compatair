const product = {
	...
	"label": "Ponceuse orbitale pneumatique Chicago Pneumatic CP7250CVE",
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/chicago-pneumatic-cp7250cve-catalogue-2026.webp",
		"alt": "Repères techniques CP7250CVE : 468 L/min en charge à 6,3 bar",
	...
	"editorial": {
		"overview": "CP7250CVE, référence 8941272503, demande 468 L/min en charge à 6,3 bar selon le catalogue Chicago Pneumatic v6.08.2026, page 173. Vitesse à vide : 12 000 tr/min. Puissance de l’outil : 210 W.",
		"verifiedFacts": [
	...
	"evidence": [
		{
			"id": "cp-catalog-202608-8941272503",
			"sourceUrl": "https://tools.cp.com/content/dam/pim/itba/cp/literature/catalogs/General-Industry_catalog_CP_EN.pdf#page=173",
			"sourceLabel": "Chicago Pneumatic, catalogue v6.08.2026, p. 173, réf. 8941272503",
	...
	"notes": [
		...
		"Source versionnée : catalogue v6.08.2026, page 173, référence 8941272503."
	],
