const product = {
	"id": "fuji-fa-150k-30-br",
	"slug": "meuleuse-fuji-fa-150k-30-br",
	"categoryId": "meuleuse",
	"category": "Meuleuse pneumatique",
	"label": "Meuleuse pneumatique Fuji FA-150K-30 BR",
	"brand": "Fuji",
	"model": "FA-150K-30 BR",
	"mpn": "5412071073",
	"distributorSkus": [],
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/fuji-fa-150k-30-br-technical.webp",
		"alt": "Repères techniques Fuji FA-150K-30 BR : 960 L/min en charge, pression de travail 6,3 bar",
		"sourceUrl": "https://www.fujitools.com/en/products/5412071073",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche et la notice Fuji"
	},
	"editorial": {
		"overview": "Fuji FA-150K-30 BR, référence 5412071073, présente une consommation en charge de 16 L/s, soit 960 L/min. La notice liée à cette fiche indique une pression de travail de 6,3 bar. Vitesse à vide : 8400 tr/min. Puissance maximale de l’outil : 900 W.",
		"verifiedFacts": [
			"Vitesse à vide : 8400 tr/min.",
			"Puissance maximale de l’outil : 900 W.",
			"Filetage de sortie : W1/2-16(F).",
	...
	"evidence": [
		{
			"id": "fuji-5412071073-official",
			"sourceUrl": "https://www.fujitools.com/en/products/5412071073",
			"sourceLabel": "Fuji, fiche officielle FA-150K-30 BR, réf. 5412071073",
		...
		{
			"id": "fuji-5412071073-pressure-notice",
	...
	"fieldSources": {
		...
		"workingPressureBar": [
			"fuji-5412071073-pressure-notice"
		],
		"connectorSize": [
			"fuji-5412071073-official"
		],
