const product = {
	"id": "fuji-fw-14ph-1-bf",
	"slug": "cle-a-chocs-fuji-fw-14ph-1-bf",
	"categoryId": "cle-a-chocs",
	"category": "Clé à chocs",
	"label": "Clé à chocs Fuji FW-14PH-1 BF",
	"brand": "Fuji",
	"model": "FW-14PH-1 BF",
	"mpn": "5412072375",
	"distributorSkus": [],
	...
	"variant": {
		...
		"distinguishingAttributes": {
			...
			"Couple maximal en marche arrière": "130 Nm",
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/fuji-fw-14ph-1-bf-technical.webp",
		"alt": "Repères techniques Fuji FW-14PH-1 BF : 594 L/min en charge, pression de travail 6,3 bar",
		"sourceUrl": "https://www.fujitools.com/en/products/5412072375",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche et la notice Fuji"
	},
	"editorial": {
		"overview": "Fuji FW-14PH-1 BF, référence 5412072375, présente une consommation en charge de 9,9 L/s, soit 594 L/min. La notice liée à cette fiche indique une pression de travail de 6,3 bar. Vitesse à vide : 7500 tr/min. Carré d’entraînement (pouces) : 1/2.",
		"verifiedFacts": [
			"Vitesse à vide : 7500 tr/min.",
			"Carré d’entraînement (pouces) : 1/2.",
			"Forme de la poignée : Pistol.",
	...
	"evidence": [
		{
			"id": "fuji-5412072375-official",
			"sourceUrl": "https://www.fujitools.com/en/products/5412072375",
			"sourceLabel": "Fuji, fiche officielle FW-14PH-1 BF, réf. 5412072375",
		...
		{
			"id": "fuji-5412072375-pressure-notice",
	...
	"fieldSources": {
		...
		"workingPressureBar": [
			"fuji-5412072375-pressure-notice"
		],
		"connectorSize": [
			"fuji-5412072375-official"
		],
