...
const product = {
  "id": "atlas-copco-8431027811",
  "slug": "visseuse-atlas-copco-ltv009-r07-6",
  "categoryId": "visseuse",
  "category": "Visseuse pneumatique",
  "label": "Visseuse pneumatique Atlas Copco LTV009 R07-6",
  "brand": "Atlas Copco",
  "model": "LTV009 R07-6",
  "mpn": "8431027811",
  "variant": {
    ...
    "distinguishingAttributes": {
      ...
      "Couple maximal sur assemblage élastique": "7 Nm",
  ...
  "image": {
    "src": "/images/products/atlas-copco-8431027811-technical.webp",
    "alt": "Atlas Copco LTV009 R07-6, référence 8431027811 : 360 L/min à vide, référence 6,3 bar",
    "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/ltv009-r07-6-sku8431027811",
    "sourceLabel": "Repères techniques CompatAir d’après Atlas Copco"
  },
  "editorial": {
    "overview": "Atlas Copco LTV009 R07-6, référence 8431027811, demande 360 L/min à vide selon la fiche fabricant. Le dimensionnement utilise la pression de référence de 6,3 bar documentée dans le catalogue Industrial Tools and Solutions UK. Vitesse à vide : 500 tr/min. Couple maximal de la plage : 7 Nm.",
    "verifiedFacts": [
      "Vitesse à vide : 500 tr/min.",
      "Couple maximal de la plage : 7 Nm.",
      "Couple minimal de la plage : 1,1 Nm.",
  ...
  "specifications": [
    {
      ...
      "value": "500 tr/min",
      "evidenceIds": [
        "atlas-copco-8431027811-fiche-fabricant"
      ]
    },
    {
    ...
    },
    {
      ...
      "value": "6,3 bar",
      "evidenceIds": [
        "atlas-copco-8431027811-catalogue-uk"
      ]
    }
  ],
  "evidence": [
    {
      "id": "atlas-copco-8431027811-fiche-fabricant",
      "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/ltv009-r07-6-sku8431027811",
      "sourceLabel": "Atlas Copco, LTV009 R07-6, 8431027811",
    ...
    {
      "id": "atlas-copco-8431027811-catalogue-uk",
      ...
      "retrievedAt": "2026-09-26",
      "confidence": "A",
      "notes": "Référence 8431027811 présente au tableau. Conditions générales : air détendu à la pression atmosphérique, pression de travail 6,3 bar sauf exception. Le millésime de cette édition n’est pas affirmé."
    }
  ],
  "fieldSources": {
    "mpn": [
