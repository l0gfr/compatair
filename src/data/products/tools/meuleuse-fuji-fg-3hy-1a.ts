const product = {
	...
	"label": "Meuleuse pneumatique Fuji FG-3HY-1A",
	"brand": "Fuji",
	"model": "FG-3HY-1A",
	"mpn": "5412071529",
	"distributorSkus": [],
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/fuji-fg-3hy-1a-technical.webp",
		"alt": "Repères techniques Fuji FG-3HY-1A : 552 L/min en charge, pression de travail 6,3 bar",
		"sourceUrl": "https://www.fujitools.com/en/products/5412071529",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche et la notice Fuji"
	},
	"editorial": {
		"overview": "Fuji FG-3HY-1A, référence 5412071529, présente une consommation en charge de 9,2 L/s, soit 552 L/min. La notice liée à cette fiche indique une pression de référence des performances de 6,3 bar. Vitesse à vide : 12000 tr/min. Puissance maximale de l’outil : 520 W.",
		"verifiedFacts": [
			"Vitesse à vide : 12000 tr/min.",
			"Puissance maximale de l’outil : 520 W.",
			"Filetage de sortie : W3/8-16.",
	...
	"evidence": [
		{
			"id": "fuji-5412071529-official",
			"sourceUrl": "https://www.fujitools.com/en/products/5412071529",
			"sourceLabel": "Fuji, fiche officielle FG-3HY-1A, réf. 5412071529",
		...
		{
			"id": "fuji-5412071529-pressure-notice",
	...
	"fieldSources": {
		...
		"workingPressureBar": [
			"fuji-5412071529-pressure-notice"
		],
		"connectorSize": [
			"fuji-5412071529-official"
		],
