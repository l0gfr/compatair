...
const product = {
  "id": "atlas-copco-8431027825",
  "slug": "visseuse-atlas-copco-lum12-pr4",
  "categoryId": "visseuse",
  "category": "Visseuse pneumatique",
  "label": "Visseuse pneumatique Atlas Copco LUM12 PR4",
  "brand": "Atlas Copco",
  "model": "LUM12 PR4",
  "mpn": "8431027825",
  "variant": {
  ...
  "image": {
    "src": "/images/products/atlas-copco-8431027825-technical.webp",
    "alt": "Atlas Copco LUM12 PR4, référence 8431027825 : 270 L/min à vide, référence 6,3 bar",
    "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/lum12-pr4-sku8431027825",
    "sourceLabel": "Repères techniques CompatAir d’après Atlas Copco"
  },
  "editorial": {
    "overview": "Atlas Copco LUM12 PR4, référence 8431027825, demande 270 L/min à vide selon la fiche fabricant. Le dimensionnement utilise la pression de référence de 6,3 bar documentée dans le catalogue Industrial Tools and Solutions UK. Vitesse à vide : 750 tr/min. Couple maximal de la plage : 4,2 Nm.",
    "verifiedFacts": [
      "Vitesse à vide : 750 tr/min.",
      "Couple maximal de la plage : 4,2 Nm.",
      "Couple minimal de la plage : 0,4 Nm.",
  ...
  "specifications": [
    {
      ...
      "value": "750 tr/min",
      "evidenceIds": [
        "atlas-copco-8431027825-fiche-fabricant"
      ]
    },
    {
    ...
    },
    {
      ...
      "value": "6,3 bar",
      "evidenceIds": [
        "atlas-copco-8431027825-catalogue-uk"
      ]
    }
  ],
  "evidence": [
    {
      "id": "atlas-copco-8431027825-fiche-fabricant",
      "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/lum12-pr4-sku8431027825",
      "sourceLabel": "Atlas Copco, LUM12 PR4, 8431027825",
    ...
    {
      "id": "atlas-copco-8431027825-catalogue-uk",
      ...
      "retrievedAt": "2026-09-26",
      "confidence": "A",
      "notes": "Référence 8431027825 présente au tableau. Conditions générales : air détendu à la pression atmosphérique, pression de travail 6,3 bar sauf exception. Le millésime de cette édition n’est pas affirmé."
    }
  ],
  "fieldSources": {
    "mpn": [
