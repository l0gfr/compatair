...
const product = {
  "id": "atlas-copco-8431026933",
  "slug": "visseuse-atlas-copco-lum12-hrf5",
  "categoryId": "visseuse",
  "category": "Visseuse pneumatique",
  "label": "Visseuse pneumatique Atlas Copco LUM12 HRF5",
  "brand": "Atlas Copco",
  "model": "LUM12 HRF5",
  "mpn": "8431026933",
  "variant": {
  ...
  "image": {
    "src": "/images/products/atlas-copco-8431026933-technical.webp",
    "alt": "Atlas Copco LUM12 HRF5, référence 8431026933 : 360 L/min à vide, référence 6,3 bar",
    "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/lum12-hrf5-sku8431026933",
    "sourceLabel": "Repères techniques CompatAir d’après Atlas Copco"
  },
  "editorial": {
    "overview": "Atlas Copco LUM12 HRF5, référence 8431026933, demande 360 L/min à vide selon la fiche fabricant. Le dimensionnement utilise la pression de référence de 6,3 bar documentée dans le catalogue Industrial Tools and Solutions UK. Vitesse à vide : 850 tr/min. Couple maximal de la plage : 5 Nm.",
    "verifiedFacts": [
      "Vitesse à vide : 850 tr/min.",
      "Couple maximal de la plage : 5 Nm.",
      "Couple minimal de la plage : 0,4 Nm.",
  ...
  "specifications": [
    {
      ...
      "value": "850 tr/min",
      "evidenceIds": [
        "atlas-copco-8431026933-fiche-fabricant"
      ]
    },
    {
    ...
    },
    {
      ...
      "value": "6,3 bar",
      "evidenceIds": [
        "atlas-copco-8431026933-catalogue-uk"
      ]
    }
  ],
  "evidence": [
    {
      "id": "atlas-copco-8431026933-fiche-fabricant",
      "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/lum12-hrf5-sku8431026933",
      "sourceLabel": "Atlas Copco, LUM12 HRF5, 8431026933",
    ...
    {
      "id": "atlas-copco-8431026933-catalogue-uk",
      ...
      "retrievedAt": "2026-09-26",
      "confidence": "A",
      "notes": "Référence 8431026933 présente au tableau. Conditions générales : air détendu à la pression atmosphérique, pression de travail 6,3 bar sauf exception. Le millésime de cette édition n’est pas affirmé."
    }
  ],
  "fieldSources": {
    "mpn": [
