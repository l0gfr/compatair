const product = {
	"id": "chicago-pneumatic-cp3119-18",
	"slug": "meuleuse-chicago-pneumatic-cp3119-18",
	"categoryId": "meuleuse",
	"category": "Meuleuse pneumatique",
	"label": "Meuleuse pneumatique Chicago Pneumatic CP3119-18",
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/chicago-pneumatic-cp3119-18.webp",
		"alt": "Repères techniques CP3119-18 : 1 080 L/min en charge, 6,3 bar, flexible 10 mm",
		"sourceUrl": "https://tools.cp.com/en/products/grinders/cp3119-18-sku6151600070",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche Chicago Pneumatic"
	},
	"editorial": {
		"overview": "CP3119-18, référence fabricant 6151600070, demande 1 080 L/min en charge (18 L/s). La fiche Chicago Pneumatic indique une pression dynamique maximale de 6,3 bar, retenue comme point de comparaison. Vitesse à vide : 18000 tr/min.",
		"verifiedFacts": [
		...
		"limitations": [
			...
			"La consommation à vide est distincte : 600 L/min publiés. Cette valeur ne remplace pas la consommation en charge dans le calcul."
		]
	},
	"specifications": [
		{
	...
	"evidence": [
		{
			"id": "cp-6151600070-official",
			"sourceUrl": "https://tools.cp.com/en/products/grinders/cp3119-18-sku6151600070",
			"sourceLabel": "Chicago Pneumatic, fiche officielle CP3119-18, réf. 6151600070",
