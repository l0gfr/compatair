...
const product = {
  "id": "atlas-copco-8431080028",
  "slug": "boulonneuse-atlas-copco-ltp61-h350-20",
  "categoryId": "boulonneuse",
  "category": "Boulonneuse pneumatique",
  "label": "Boulonneuse pneumatique Atlas Copco LTP61 H350-20",
  "brand": "Atlas Copco",
  "model": "LTP61 H350-20",
  "mpn": "8431080028",
  "variant": {
  ...
  "image": {
    "src": "/images/products/atlas-copco-8431080028-technical.webp",
    "alt": "Atlas Copco LTP61 H350-20, référence 8431080028 : 1 200 L/min à vide, référence 6,3 bar",
    "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/bolt-tightening-solutions/continuous-rotation/ltp61-h350-20-sku8431080028",
    "sourceLabel": "Repères techniques CompatAir d’après Atlas Copco"
  },
  "editorial": {
    "overview": "Atlas Copco LTP61 H350-20, référence 8431080028, demande 1 200 L/min à vide selon la fiche fabricant. Le dimensionnement utilise la pression de référence de 6,3 bar documentée dans le catalogue Industrial Tools and Solutions UK. Vitesse à vide : 560 tr/min. Couple maximal de la plage : 350 Nm.",
    "verifiedFacts": [
      "Vitesse à vide : 560 tr/min.",
      "Couple maximal de la plage : 350 Nm.",
      "Couple minimal de la plage : 145 Nm.",
  ...
  "specifications": [
    {
      ...
      "value": "560 tr/min",
      "evidenceIds": [
        "atlas-copco-8431080028-fiche-fabricant"
      ]
    },
    {
    ...
    },
    {
      ...
      "value": "6,3 bar",
      "evidenceIds": [
        "atlas-copco-8431080028-catalogue-uk"
      ]
    }
  ],
  "evidence": [
    {
      "id": "atlas-copco-8431080028-fiche-fabricant",
      "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/bolt-tightening-solutions/continuous-rotation/ltp61-h350-20-sku8431080028",
      "sourceLabel": "Atlas Copco, LTP61 H350-20, 8431080028",
    ...
    {
      "id": "atlas-copco-8431080028-catalogue-uk",
      ...
      "retrievedAt": "2026-09-26",
      "confidence": "A",
      "notes": "Référence 8431080028 présente au tableau. Conditions générales : air détendu à la pression atmosphérique, pression de travail 6,3 bar sauf exception. Le millésime de cette édition n’est pas affirmé."
    }
  ],
  "fieldSources": {
    "mpn": [
