const product = {
	"id": "fuji-frd-5s-1f-e",
	"slug": "perceuse-fuji-frd-5s-1f-e",
	"categoryId": "perceuse",
	"category": "Perceuse pneumatique",
	"label": "Perceuse pneumatique Fuji FRD-5S-1F E",
	"brand": "Fuji",
	"model": "FRD-5S-1F E",
	"mpn": "5412072178",
	"distributorSkus": [],
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/fuji-frd-5s-1f-e-technical.webp",
		"alt": "Repères techniques Fuji FRD-5S-1F E : 600 L/min en charge, pression de travail 6,3 bar",
		"sourceUrl": "https://www.fujitools.com/en/products/5412072178",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche et la notice Fuji"
	},
	"editorial": {
		"overview": "Fuji FRD-5S-1F E, référence 5412072178, présente une consommation en charge de 10 L/s, soit 600 L/min. La notice liée à cette fiche indique une pression de travail de 6,3 bar. Vitesse à vide : 3200 tr/min. Puissance maximale de l’outil : 180 W.",
		"verifiedFacts": [
			"Vitesse à vide : 3200 tr/min.",
			"Puissance maximale de l’outil : 180 W.",
			"Capacité maximale du mandrin (mm) : 6.5.",
	...
	"evidence": [
		{
			"id": "fuji-5412072178-official",
			"sourceUrl": "https://www.fujitools.com/en/products/5412072178",
			"sourceLabel": "Fuji, fiche officielle FRD-5S-1F E, réf. 5412072178",
		...
		{
			"id": "fuji-5412072178-pressure-notice",
	...
	"fieldSources": {
		...
		"workingPressureBar": [
			"fuji-5412072178-pressure-notice"
		],
		"connectorSize": [
			"fuji-5412072178-official"
		],
