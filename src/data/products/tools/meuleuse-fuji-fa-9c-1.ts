const product = {
	"id": "fuji-fa-9c-1",
	"slug": "meuleuse-fuji-fa-9c-1",
	"categoryId": "meuleuse",
	"category": "Meuleuse pneumatique",
	"label": "Meuleuse pneumatique Fuji FA-9C-1",
	"brand": "Fuji",
	"model": "FA-9C-1",
	"mpn": "5412071177",
	"distributorSkus": [],
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/fuji-fa-9c-1-technical.webp",
		"alt": "Repères techniques Fuji FA-9C-1 : 1 260 L/min en charge, pression de travail 6,3 bar",
		"sourceUrl": "https://www.fujitools.com/en/products/5412071177",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche et la notice Fuji"
	},
	"editorial": {
		"overview": "Fuji FA-9C-1, référence 5412071177, présente une consommation en charge de 21 L/s, soit 1 260 L/min. La notice liée à cette fiche indique une pression de référence des performances de 6,3 bar. Vitesse à vide : 6600 tr/min. Puissance maximale de l’outil : 1700 W.",
		"verifiedFacts": [
			"Vitesse à vide : 6600 tr/min.",
			"Puissance maximale de l’outil : 1700 W.",
			"Filetage de sortie : W1/2-16.",
	...
	"evidence": [
		{
			"id": "fuji-5412071177-official",
			"sourceUrl": "https://www.fujitools.com/en/products/5412071177",
			"sourceLabel": "Fuji, fiche officielle FA-9C-1, réf. 5412071177",
		...
		{
			"id": "fuji-5412071177-pressure-notice",
	...
	"fieldSources": {
		...
		"workingPressureBar": [
			"fuji-5412071177-pressure-notice"
		],
		"connectorSize": [
			"fuji-5412071177-official"
		],
