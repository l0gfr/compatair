...
const product = {
  "id": "atlas-copco-8431080021",
  "slug": "boulonneuse-atlas-copco-ltp61-h230-19",
  "categoryId": "boulonneuse",
  "category": "Boulonneuse pneumatique",
  "label": "Boulonneuse pneumatique Atlas Copco LTP61 H230-19",
  "brand": "Atlas Copco",
  "model": "LTP61 H230-19",
  "mpn": "8431080021",
  "variant": {
  ...
  "image": {
    "src": "/images/products/atlas-copco-8431080021-technical.webp",
    "alt": "Atlas Copco LTP61 H230-19, référence 8431080021 : 1 200 L/min à vide, référence 6,3 bar",
    "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/bolt-tightening-solutions/continuous-rotation/ltp61-h230-19-sku8431080021",
    "sourceLabel": "Repères techniques CompatAir d’après Atlas Copco"
  },
  "editorial": {
    "overview": "Atlas Copco LTP61 H230-19, référence 8431080021, demande 1 200 L/min à vide selon la fiche fabricant. Le dimensionnement utilise la pression de référence de 6,3 bar documentée dans le catalogue Industrial Tools and Solutions UK. Vitesse à vide : 900 tr/min. Couple maximal de la plage : 230 Nm.",
    "verifiedFacts": [
      "Vitesse à vide : 900 tr/min.",
      "Couple maximal de la plage : 230 Nm.",
      "Couple minimal de la plage : 85 Nm.",
  ...
  "specifications": [
    {
      ...
      "value": "900 tr/min",
      "evidenceIds": [
        "atlas-copco-8431080021-fiche-fabricant"
      ]
    },
    {
    ...
    },
    {
      ...
      "value": "6,3 bar",
      "evidenceIds": [
        "atlas-copco-8431080021-catalogue-uk"
      ]
    }
  ],
  "evidence": [
    {
      "id": "atlas-copco-8431080021-fiche-fabricant",
      "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/bolt-tightening-solutions/continuous-rotation/ltp61-h230-19-sku8431080021",
      "sourceLabel": "Atlas Copco, LTP61 H230-19, 8431080021",
    ...
    {
      "id": "atlas-copco-8431080021-catalogue-uk",
      ...
      "retrievedAt": "2026-09-26",
      "confidence": "A",
      "notes": "Référence 8431080021 présente au tableau. Conditions générales : air détendu à la pression atmosphérique, pression de travail 6,3 bar sauf exception. Le millésime de cette édition n’est pas affirmé."
    }
  ],
  "fieldSources": {
    "mpn": [
