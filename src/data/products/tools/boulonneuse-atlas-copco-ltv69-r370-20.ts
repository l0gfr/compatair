...
const product = {
  "id": "atlas-copco-8431083015",
  "slug": "boulonneuse-atlas-copco-ltv69-r370-20",
  "categoryId": "boulonneuse",
  "category": "Boulonneuse pneumatique",
  "label": "Boulonneuse pneumatique Atlas Copco LTV69 R370-20",
  "brand": "Atlas Copco",
  "model": "LTV69 R370-20",
  "mpn": "8431083015",
  "variant": {
  ...
  "image": {
    "src": "/images/products/atlas-copco-8431083015-technical.webp",
    "alt": "Atlas Copco LTV69 R370-20, référence 8431083015 : 1 200 L/min à vide, référence 6,3 bar",
    "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/ltv69-r370-20-sku8431083015",
    "sourceLabel": "Repères techniques CompatAir d’après Atlas Copco"
  },
  "editorial": {
    "overview": "Atlas Copco LTV69 R370-20, référence 8431083015, demande 1 200 L/min à vide selon la fiche fabricant. Le dimensionnement utilise la pression de référence de 6,3 bar documentée dans le catalogue Industrial Tools and Solutions UK. Vitesse à vide : 480 tr/min. Couple maximal de la plage : 370 Nm.",
    "verifiedFacts": [
      "Vitesse à vide : 480 tr/min.",
      "Couple maximal de la plage : 370 Nm.",
      "Couple minimal de la plage : 140 Nm.",
  ...
  "specifications": [
    {
      ...
      "value": "480 tr/min",
      "evidenceIds": [
        "atlas-copco-8431083015-fiche-fabricant"
      ]
    },
    {
    ...
    },
    {
      ...
      "value": "6,3 bar",
      "evidenceIds": [
        "atlas-copco-8431083015-catalogue-uk"
      ]
    }
  ],
  "evidence": [
    {
      "id": "atlas-copco-8431083015-fiche-fabricant",
      "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/ltv69-r370-20-sku8431083015",
      "sourceLabel": "Atlas Copco, LTV69 R370-20, 8431083015",
    ...
    {
      "id": "atlas-copco-8431083015-catalogue-uk",
      ...
      "retrievedAt": "2026-09-26",
      "confidence": "A",
      "notes": "Référence 8431083015 présente au tableau. Conditions générales : air détendu à la pression atmosphérique, pression de travail 6,3 bar sauf exception. Le millésime de cette édition n’est pas affirmé."
    }
  ],
  "fieldSources": {
    "mpn": [
