...
const product = {
  "id": "atlas-copco-8431026961",
  "slug": "visseuse-atlas-copco-lum22-pr3",
  "categoryId": "visseuse",
  "category": "Visseuse pneumatique",
  "label": "Visseuse pneumatique Atlas Copco LUM22 PR3",
  "brand": "Atlas Copco",
  "model": "LUM22 PR3",
  "mpn": "8431026961",
  "variant": {
  ...
  "image": {
    "src": "/images/products/atlas-copco-8431026961-technical.webp",
    "alt": "Atlas Copco LUM22 PR3, référence 8431026961 : 420 L/min à vide, référence 6,3 bar",
    "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/lum22-pr3-sku8431026961",
    "sourceLabel": "Repères techniques CompatAir d’après Atlas Copco"
  },
  "editorial": {
    "overview": "Atlas Copco LUM22 PR3, référence 8431026961, demande 420 L/min à vide selon la fiche fabricant. Le dimensionnement utilise la pression de référence de 6,3 bar documentée dans le catalogue Industrial Tools and Solutions UK. Vitesse à vide : 2100 tr/min. Couple maximal de la plage : 3,2 Nm.",
    "verifiedFacts": [
      "Vitesse à vide : 2100 tr/min.",
      "Couple maximal de la plage : 3,2 Nm.",
      "Couple minimal de la plage : 0,6 Nm.",
  ...
  "specifications": [
    {
      ...
      "value": "2100 tr/min",
      "evidenceIds": [
        "atlas-copco-8431026961-fiche-fabricant"
      ]
    },
    {
    ...
    },
    {
      ...
      "value": "6,3 bar",
      "evidenceIds": [
        "atlas-copco-8431026961-catalogue-uk"
      ]
    }
  ],
  "evidence": [
    {
      "id": "atlas-copco-8431026961-fiche-fabricant",
      "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/lum22-pr3-sku8431026961",
      "sourceLabel": "Atlas Copco, LUM22 PR3, 8431026961",
    ...
    {
      "id": "atlas-copco-8431026961-catalogue-uk",
      ...
      "retrievedAt": "2026-09-26",
      "confidence": "A",
      "notes": "Référence 8431026961 présente au tableau. Conditions générales : air détendu à la pression atmosphérique, pression de travail 6,3 bar sauf exception. Le millésime de cette édition n’est pas affirmé."
    }
  ],
  "fieldSources": {
    "mpn": [
