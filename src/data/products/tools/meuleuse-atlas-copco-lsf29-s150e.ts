...
const product = {
  "id": "atlas-copco-8423012704",
  "slug": "meuleuse-atlas-copco-lsf29-s150e",
  "categoryId": "meuleuse",
  "category": "Meuleuse pneumatique",
  "label": "Meuleuse pneumatique Atlas Copco LSF29 S150E",
  "brand": "Atlas Copco",
  "model": "LSF29 S150E",
  "mpn": "8423012704",
  "variant": {
    ...
    "distinguishingAttributes": {
      ...
      "Consommation à puissance maximale": "1 080 L/min (18 l/s)",
  ...
  "image": {
    "src": "/images/products/atlas-copco-8423012704-technical.webp",
    "alt": "Atlas Copco LSF29 S150E, référence 8423012704 : 1 080 L/min à puissance maximale, référence 6,3 bar",
    "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/material-removal-tools/precision-grinding/lsf29-s150e-sku8423012704",
    "sourceLabel": "Repères techniques CompatAir d’après Atlas Copco"
  },
  "editorial": {
    "overview": "Atlas Copco LSF29 S150E, référence 8423012704, demande 1 080 L/min à puissance maximale selon la fiche fabricant. Le dimensionnement utilise la pression de référence de 6,3 bar documentée dans le catalogue Industrial Tools and Solutions UK. Vitesse maximale à vide : 15000 tr/min. Puissance maximale : 0,8 kW.",
    "verifiedFacts": [
      "Vitesse maximale à vide : 15000 tr/min.",
      "Puissance maximale : 0,8 kW.",
      "Masse : 1,4 kg.",
      ...
      "Consommation à puissance maximale : 1 080 L/min, convertis depuis 18 l/s.",
  ...
  "specifications": [
    {
      ...
      "value": "15000 tr/min",
      "evidenceIds": [
        "atlas-copco-8423012704-fiche-fabricant"
      ]
    },
    {
    ...
    },
    {
      ...
      "value": "6,3 bar",
      "evidenceIds": [
        "atlas-copco-8423012704-catalogue-uk"
      ]
    }
  ],
  "evidence": [
    {
      "id": "atlas-copco-8423012704-fiche-fabricant",
      "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/material-removal-tools/precision-grinding/lsf29-s150e-sku8423012704",
      "sourceLabel": "Atlas Copco, LSF29 S150E, 8423012704",
    ...
    {
      "id": "atlas-copco-8423012704-catalogue-uk",
      ...
      "retrievedAt": "2026-09-26",
      "confidence": "A",
      "notes": "Référence 8423012704 présente au tableau. Conditions générales : air détendu à la pression atmosphérique, pression de travail 6,3 bar sauf exception. Le millésime de cette édition n’est pas affirmé."
    }
  ],
  "fieldSources": {
    "mpn": [
