...
const product = {
  "id": "atlas-copco-8431053583",
  "slug": "boulonneuse-atlas-copco-ltd38-r47-re",
  "categoryId": "boulonneuse",
  "category": "Boulonneuse pneumatique",
  "label": "Boulonneuse pneumatique Atlas Copco LTD38 R47-RE",
  "brand": "Atlas Copco",
  "model": "LTD38 R47-RE",
  "mpn": "8431053583",
  "variant": {
  ...
  "image": {
    "src": "/images/products/atlas-copco-8431053583-technical.webp",
    "alt": "Atlas Copco LTD38 R47-RE, référence 8431053583 : 1 200 L/min à vide, référence 6,3 bar",
    "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/ltd38-r47-re-sku8431053583",
    "sourceLabel": "Repères techniques CompatAir d’après Atlas Copco"
  },
  "editorial": {
    "overview": "Atlas Copco LTD38 R47-RE, référence 8431053583, demande 1 200 L/min à vide selon la fiche fabricant. Le dimensionnement utilise la pression de référence de 6,3 bar documentée dans le catalogue Industrial Tools and Solutions UK. Vitesse à vide : 380 tr/min. Couple maximal de la plage : 47 Nm.",
    "verifiedFacts": [
      "Vitesse à vide : 380 tr/min.",
      "Couple maximal de la plage : 47 Nm.",
      "Couple minimal de la plage : 22 Nm.",
  ...
  "specifications": [
    {
      ...
      "value": "380 tr/min",
      "evidenceIds": [
        "atlas-copco-8431053583-fiche-fabricant"
      ]
    },
    {
    ...
    },
    {
      ...
      "value": "6,3 bar",
      "evidenceIds": [
        "atlas-copco-8431053583-catalogue-uk"
      ]
    }
  ],
  "evidence": [
    {
      "id": "atlas-copco-8431053583-fiche-fabricant",
      "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/ltd38-r47-re-sku8431053583",
      "sourceLabel": "Atlas Copco, LTD38 R47-RE, 8431053583",
    ...
    {
      "id": "atlas-copco-8431053583-catalogue-uk",
      ...
      "retrievedAt": "2026-09-26",
      "confidence": "A",
      "notes": "Référence 8431053583 présente au tableau. Conditions générales : air détendu à la pression atmosphérique, pression de travail 6,3 bar sauf exception. Le millésime de cette édition n’est pas affirmé."
    }
  ],
  "fieldSources": {
    "mpn": [
