...
const product = {
  "id": "atlas-copco-8431026920",
  "slug": "visseuse-atlas-copco-lum22-hrx4",
  "categoryId": "visseuse",
  "category": "Visseuse pneumatique",
  "label": "Visseuse pneumatique Atlas Copco LUM22 HRX4",
  "brand": "Atlas Copco",
  "model": "LUM22 HRX4",
  "mpn": "8431026920",
  "variant": {
  ...
  "image": {
    "src": "/images/products/atlas-copco-8431026920-technical.webp",
    "alt": "Atlas Copco LUM22 HRX4, référence 8431026920 : 540 L/min à vide, référence 6,3 bar",
    "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/lum22-hrx4-sku8431026920",
    "sourceLabel": "Repères techniques CompatAir d’après Atlas Copco"
  },
  "editorial": {
    "overview": "Atlas Copco LUM22 HRX4, référence 8431026920, demande 540 L/min à vide selon la fiche fabricant. Le dimensionnement utilise la pression de référence de 6,3 bar documentée dans le catalogue Industrial Tools and Solutions UK. Vitesse à vide : 1650 tr/min. Couple maximal de la plage : 4 Nm.",
    "verifiedFacts": [
      "Vitesse à vide : 1650 tr/min.",
      "Couple maximal de la plage : 4 Nm.",
      "Couple minimal de la plage : 0,6 Nm.",
  ...
  "specifications": [
    {
      ...
      "value": "1650 tr/min",
      "evidenceIds": [
        "atlas-copco-8431026920-fiche-fabricant"
      ]
    },
    {
    ...
    },
    {
      ...
      "value": "6,3 bar",
      "evidenceIds": [
        "atlas-copco-8431026920-catalogue-uk"
      ]
    }
  ],
  "evidence": [
    {
      "id": "atlas-copco-8431026920-fiche-fabricant",
      "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/lum22-hrx4-sku8431026920",
      "sourceLabel": "Atlas Copco, LUM22 HRX4, 8431026920",
    ...
    {
      "id": "atlas-copco-8431026920-catalogue-uk",
      ...
      "retrievedAt": "2026-09-26",
      "confidence": "A",
      "notes": "Référence 8431026920 présente au tableau. Conditions générales : air détendu à la pression atmosphérique, pression de travail 6,3 bar sauf exception. Le millésime de cette édition n’est pas affirmé."
    }
  ],
  "fieldSources": {
    "mpn": [
