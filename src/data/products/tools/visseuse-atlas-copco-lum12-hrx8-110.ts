...
const product = {
  "id": "atlas-copco-8431028027",
  "slug": "visseuse-atlas-copco-lum12-hrx8-110",
  "categoryId": "visseuse",
  "category": "Visseuse pneumatique",
  "label": "Visseuse pneumatique Atlas Copco LUM12 HRX8-110",
  "brand": "Atlas Copco",
  "model": "LUM12 HRX8-110",
  "mpn": "8431028027",
  "variant": {
    "familyId": "atlas-copco-6696296459",
    "label": "LUM12 HRX8-110",
    "distinguishingAttributes": {
      "Vitesse à vide": "110 tr/min",
  ...
  "image": {
    "src": "/images/products/atlas-copco-8431028027-technical.webp",
    "alt": "Atlas Copco LUM12 HRX8-110, référence 8431028027 : 360 L/min à vide, référence 6,3 bar",
    "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/lum12-hrx8-110-sku8431028027",
    "sourceLabel": "Repères techniques CompatAir d’après Atlas Copco"
  },
  "editorial": {
    "overview": "Atlas Copco LUM12 HRX8-110, référence 8431028027, demande 360 L/min à vide selon la fiche fabricant. Le dimensionnement utilise la pression de référence de 6,3 bar documentée dans le catalogue Industrial Tools and Solutions UK. Vitesse à vide : 110 tr/min. Couple maximal de la plage : 8 Nm.",
    "verifiedFacts": [
      "Vitesse à vide : 110 tr/min.",
      "Couple maximal de la plage : 8 Nm.",
      "Couple minimal de la plage : 1,5 Nm.",
  ...
  "specifications": [
    {
      ...
      "value": "110 tr/min",
      "evidenceIds": [
        "atlas-copco-8431028027-fiche-fabricant"
      ]
    },
    {
    ...
    },
    {
      ...
      "value": "6,3 bar",
      "evidenceIds": [
        "atlas-copco-8431028027-catalogue-uk"
      ]
    }
  ],
  "evidence": [
    {
      "id": "atlas-copco-8431028027-fiche-fabricant",
      "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/lum12-hrx8-110-sku8431028027",
      "sourceLabel": "Atlas Copco, LUM12 HRX8-110, 8431028027",
    ...
    {
      "id": "atlas-copco-8431028027-catalogue-uk",
      ...
      "retrievedAt": "2026-09-26",
      "confidence": "A",
      "notes": "Référence 8431028027 présente au tableau. Conditions générales : air détendu à la pression atmosphérique, pression de travail 6,3 bar sauf exception. Le millésime de cette édition n’est pas affirmé."
    }
  ],
  "fieldSources": {
    "mpn": [
