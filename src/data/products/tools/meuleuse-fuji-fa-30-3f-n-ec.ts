const product = {
	...
	"label": "Meuleuse pneumatique Fuji FA-30-3F N EC",
	"brand": "Fuji",
	"model": "FA-30-3F N EC",
	"mpn": "5412105126",
	"distributorSkus": [],
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/fuji-fa-30-3f-n-ec-technical.webp",
		"alt": "Repères techniques Fuji FA-30-3F N EC : 1 260 L/min en charge, pression de travail 6,3 bar",
		"sourceUrl": "https://www.fujitools.com/en/products/5412105126",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche et la notice Fuji"
	},
	"editorial": {
		"overview": "Fuji FA-30-3F N EC, référence 5412105126, présente une consommation en charge de 21 L/s, soit 1 260 L/min. La notice liée à cette fiche indique une pression de travail de 6,3 bar. Vitesse à vide : 13500 tr/min. Puissance maximale de l’outil : 482 W.",
		"verifiedFacts": [
			"Vitesse à vide : 13500 tr/min.",
			"Puissance maximale de l’outil : 482 W.",
			"Filetage de sortie : M8.",
	...
	"evidence": [
		{
			"id": "fuji-5412105126-official",
			"sourceUrl": "https://www.fujitools.com/en/products/5412105126",
			"sourceLabel": "Fuji, fiche officielle FA-30-3F N EC, réf. 5412105126",
		...
		{
			"id": "fuji-5412105126-pressure-notice",
	...
	"fieldSources": {
		...
		"workingPressureBar": [
			"fuji-5412105126-pressure-notice"
		],
		"connectorSize": [
			"fuji-5412105126-official"
		],
