const product = {
	"id": "fuji-fbs-1-4",
	"slug": "ponceuse-bande-fuji-fbs-1-4",
	"categoryId": "ponceuse-bande",
	"category": "Ponceuse à bande pneumatique",
	"label": "Ponceuse à bande pneumatique Fuji FBS-1-4",
	"brand": "Fuji",
	"model": "FBS-1-4",
	"mpn": "5412071206",
	"distributorSkus": [],
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/fuji-fbs-1-4-technical.webp",
		"alt": "Repères techniques Fuji FBS-1-4 : 570 L/min en charge, pression de travail 6,3 bar",
		"sourceUrl": "https://www.fujitools.com/en/products/5412071206",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche et la notice Fuji"
	},
	"editorial": {
		"overview": "Fuji FBS-1-4, référence 5412071206, présente une consommation en charge de 9,5 L/s, soit 570 L/min. La notice liée à cette fiche indique une pression de référence des performances de 6,3 bar. Vitesse à vide : 1200 tr/min. Puissance maximale de l’outil : 280 W.",
		"verifiedFacts": [
			"Vitesse à vide : 1200 tr/min.",
			"Puissance maximale de l’outil : 280 W.",
			"Dimensions de la bande (mm) : 20x460.",
	...
	"evidence": [
		{
			"id": "fuji-5412071206-official",
			"sourceUrl": "https://www.fujitools.com/en/products/5412071206",
			"sourceLabel": "Fuji, fiche officielle FBS-1-4, réf. 5412071206",
		...
		{
			"id": "fuji-5412071206-pressure-notice",
			"sourceUrl": "https://files.fujitools.com/documentation-files-mv/9502000410_05.pdf#page=1",
			"sourceLabel": "Fuji, notice 9502000410, révision 05, page 1",
			"sourceType": "manual",
			"sourceRole": "primary",
			"retrievedAt": "2026-09-25",
			"confidence": "A",
	...
	"fieldSources": {
		...
		"workingPressureBar": [
			"fuji-5412071206-pressure-notice"
		],
		"connectorSize": [
			"fuji-5412071206-official"
		],
