const product = {
	"id": "fuji-fw-330-1",
	"slug": "cle-a-chocs-fuji-fw-330-1",
	"categoryId": "cle-a-chocs",
	"category": "Clé à chocs",
	"label": "Clé à chocs Fuji FW-330-1",
	"brand": "Fuji",
	"model": "FW-330-1",
	"mpn": "5412104115",
	"distributorSkus": [],
	...
	"variant": {
		...
		"distinguishingAttributes": {
			...
			"Entrée d’air": "1/2 pouce PT"
		}
	},
	"connectorSize": "Entrée 1/2 pouce PT, flexible intérieur 12,7 mm sur 5 m",
	"usagePattern": "burst",
	"recommendedHose": {
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/fuji-fw-330-1-technical.webp",
		"alt": "Repères techniques Fuji FW-330-1 : 1 140 L/min en charge, pression de travail 6,3 bar",
		"sourceUrl": "https://www.fujitools.com/en/products/5412104115",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche et la notice Fuji"
	},
	"editorial": {
		"overview": "Fuji FW-330-1, référence 5412104115, présente une consommation en charge de 19 L/s, soit 1 140 L/min. La notice liée à cette fiche indique une pression de travail de 6,3 bar. Vitesse à vide : 5000 tr/min. Carré d’entraînement (pouces) : 1.",
		"verifiedFacts": [
			"Vitesse à vide : 5000 tr/min.",
			"Carré d’entraînement (pouces) : 1.",
			"Forme de la poignée : Straight handle.",
			"Couple maximal en marche arrière : 2600 Nm.",
			"Entrée 1/2 pouce PT ; flexible de 12,7 mm de diamètre intérieur sur 5 m."
		],
		"limitations": [
	...
	"evidence": [
		{
			"id": "fuji-5412104115-official",
			"sourceUrl": "https://www.fujitools.com/en/products/5412104115",
			"sourceLabel": "Fuji, fiche officielle FW-330-1, réf. 5412104115",
		...
		{
			"id": "fuji-5412104115-pressure-notice",
	...
	"fieldSources": {
		...
		"workingPressureBar": [
			"fuji-5412104115-pressure-notice"
		],
		"connectorSize": [
			"fuji-5412104115-official"
		],
