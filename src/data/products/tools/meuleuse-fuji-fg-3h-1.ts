const product = {
	"id": "fuji-fg-3h-1",
	"slug": "meuleuse-fuji-fg-3h-1",
	"categoryId": "meuleuse",
	"category": "Meuleuse pneumatique",
	"label": "Meuleuse pneumatique Fuji FG-3H-1",
	"brand": "Fuji",
	"model": "FG-3H-1",
	"mpn": "5412052818",
	"distributorSkus": [],
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/fuji-fg-3h-1-technical.webp",
		"alt": "Repères techniques Fuji FG-3H-1 : 552 L/min en charge, pression de travail 6,3 bar",
		"sourceUrl": "https://www.fujitools.com/en/products/5412052818",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche et la notice Fuji"
	},
	"editorial": {
		"overview": "Fuji FG-3H-1, référence 5412052818, présente une consommation en charge de 9,2 L/s, soit 552 L/min. La notice liée à cette fiche indique une pression de travail de 6,3 bar. Vitesse à vide : 14600 tr/min. Puissance maximale de l’outil : 520 W.",
		"verifiedFacts": [
			"Vitesse à vide : 14600 tr/min.",
			"Puissance maximale de l’outil : 520 W.",
			"Filetage de sortie : W3/8-16.",
	...
	"evidence": [
		{
			"id": "fuji-5412052818-official",
			"sourceUrl": "https://www.fujitools.com/en/products/5412052818",
			"sourceLabel": "Fuji, fiche officielle FG-3H-1, réf. 5412052818",
		...
		{
			"id": "fuji-5412052818-pressure-notice",
	...
	"fieldSources": {
		...
		"workingPressureBar": [
			"fuji-5412052818-pressure-notice"
		],
		"connectorSize": [
			"fuji-5412052818-official"
		],
