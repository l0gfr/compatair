const product = {
	"id": "fuji-fa-30x-3",
	"slug": "meuleuse-fuji-fa-30x-3",
	"categoryId": "meuleuse",
	"category": "Meuleuse pneumatique",
	"label": "Meuleuse pneumatique Fuji FA-30X-3",
	"brand": "Fuji",
	"model": "FA-30X-3",
	"mpn": "5412105127",
	"distributorSkus": [],
	...
	"variant": {
		...
		"distinguishingAttributes": {
			...
			"Puissance maximale de l’outil": "443 W",
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/fuji-fa-30x-3-technical.webp",
		"alt": "Repères techniques Fuji FA-30X-3 : 1 260 L/min en charge, pression de travail 6,3 bar",
		"sourceUrl": "https://www.fujitools.com/en/products/5412105127",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche et la notice Fuji"
	},
	"editorial": {
		"overview": "Fuji FA-30X-3, référence 5412105127, présente une consommation en charge de 21 L/s, soit 1 260 L/min. La notice liée à cette fiche indique une pression de référence des performances de 6,3 bar. Vitesse à vide : 13500 tr/min. Puissance maximale de l’outil : 443 W.",
		"verifiedFacts": [
			"Vitesse à vide : 13500 tr/min.",
			"Puissance maximale de l’outil : 443 W.",
			"Filetage de sortie : M8.",
	...
	"evidence": [
		{
			"id": "fuji-5412105127-official",
			"sourceUrl": "https://www.fujitools.com/en/products/5412105127",
			"sourceLabel": "Fuji, fiche officielle FA-30X-3, réf. 5412105127",
		...
		{
			"id": "fuji-5412105127-pressure-notice",
			"sourceUrl": "https://files.fujitools.com/documentation-files-mv/9502001021_05.pdf#page=1",
			"sourceLabel": "Fuji, notice 9502001021, révision 05, page 1",
			"sourceType": "manual",
			"sourceRole": "primary",
			"retrievedAt": "2026-09-25",
			"confidence": "A",
	...
	"fieldSources": {
		...
		"workingPressureBar": [
			"fuji-5412105127-pressure-notice"
		],
		"connectorSize": [
			"fuji-5412105127-official"
		],
