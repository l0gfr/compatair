const product = {
	"id": "fuji-fg-50h-2-6-fe",
	"slug": "meuleuse-fuji-fg-50h-2-6-fe",
	"categoryId": "meuleuse",
	"category": "Meuleuse pneumatique",
	"label": "Meuleuse pneumatique Fuji FG-50H-2 6 FE",
	"brand": "Fuji",
	"model": "FG-50H-2 6 FE",
	"mpn": "5412103203",
	"distributorSkus": [],
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/fuji-fg-50h-2-6-fe-technical.webp",
		"alt": "Repères techniques Fuji FG-50H-2 6 FE : 432 L/min en charge, pression de travail 6,3 bar",
		"sourceUrl": "https://www.fujitools.com/en/products/5412103203",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche et la notice Fuji"
	},
	"editorial": {
		"overview": "Fuji FG-50H-2 6 FE, référence 5412103203, présente une consommation en charge de 7,2 L/s, soit 432 L/min. La notice liée à cette fiche indique une pression de travail de 6,3 bar. Vitesse à vide : 18000 tr/min. Puissance maximale de l’outil : 340 W.",
		"verifiedFacts": [
			"Vitesse à vide : 18000 tr/min.",
			"Puissance maximale de l’outil : 340 W.",
			"Capacité de la pince (mm) : 6.",
	...
	"evidence": [
		{
			"id": "fuji-5412103203-official",
			"sourceUrl": "https://www.fujitools.com/en/products/5412103203",
			"sourceLabel": "Fuji, fiche officielle FG-50H-2 6 FE, réf. 5412103203",
		...
		{
			"id": "fuji-5412103203-pressure-notice",
	...
	"fieldSources": {
		...
		"workingPressureBar": [
			"fuji-5412103203-pressure-notice"
		],
		"connectorSize": [
			"fuji-5412103203-official"
		],
