const product = {
	id: 'chicago-pneumatic-cp3030-420r', slug: 'meuleuse-droite-chicago-pneumatic-cp3030-420r', category: 'Meuleuse droite', label: 'Meuleuse droite pneumatique Chicago Pneumatic CP3030-420R', brand: 'Chicago Pneumatic', model: 'CP3030-420R', mpn: '6151604140',
	...
	image: { src: '/images/products/chicago-pneumatic-cp3030-420r.jpg', alt: 'Meuleuse droite Chicago Pneumatic CP3030-420R', sourceUrl: 'https://tools.cp.com/en/products/grinders/cp3030-420r-sku6151604140', sourceLabel: 'Visuel officiel Chicago Pneumatic' },
