const product = {
	"id": "fuji-frd-6ph-2",
	"slug": "perceuse-fuji-frd-6ph-2",
	"categoryId": "perceuse",
	"category": "Perceuse pneumatique",
	"label": "Perceuse pneumatique Fuji FRD-6PH-2",
	"brand": "Fuji",
	"model": "FRD-6PH-2",
	"mpn": "5412077834",
	"distributorSkus": [],
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/fuji-frd-6ph-2-technical.webp",
		"alt": "Repères techniques Fuji FRD-6PH-2 : 600 L/min en charge, pression de travail 6,3 bar",
		"sourceUrl": "https://www.fujitools.com/en/products/5412077834",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche et la notice Fuji"
	},
	"editorial": {
		"overview": "Fuji FRD-6PH-2, référence 5412077834, présente une consommation en charge de 10 L/s, soit 600 L/min. La notice liée à cette fiche indique une pression de travail de 6,3 bar. Vitesse à vide : 4300 tr/min. Puissance maximale de l’outil : 340 W.",
		"verifiedFacts": [
			"Vitesse à vide : 4300 tr/min.",
			"Puissance maximale de l’outil : 340 W.",
			"Capacité maximale du mandrin (mm) : 6.5.",
	...
	"evidence": [
		{
			"id": "fuji-5412077834-official",
			"sourceUrl": "https://www.fujitools.com/en/products/5412077834",
			"sourceLabel": "Fuji, fiche officielle FRD-6PH-2, réf. 5412077834",
		...
		{
			"id": "fuji-5412077834-pressure-notice",
	...
	"fieldSources": {
		...
		"workingPressureBar": [
			"fuji-5412077834-pressure-notice"
		],
		"connectorSize": [
			"fuji-5412077834-official"
		],
