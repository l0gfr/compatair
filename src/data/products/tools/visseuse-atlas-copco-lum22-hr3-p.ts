...
const product = {
  "id": "atlas-copco-8431026906",
  "slug": "visseuse-atlas-copco-lum22-hr3-p",
  "categoryId": "visseuse",
  "category": "Visseuse pneumatique",
  "label": "Visseuse pneumatique Atlas Copco LUM22 HR3-P",
  "brand": "Atlas Copco",
  "model": "LUM22 HR3-P",
  "mpn": "8431026906",
  "variant": {
    ...
    "distinguishingAttributes": {
      ...
      "Couple maximal de la plage": "3 Nm",
      "Couple minimal de la plage": "0,6 Nm",
      "Couple maximal sur assemblage élastique": "3 Nm",
  ...
  "image": {
    "src": "/images/products/atlas-copco-8431026906-technical.webp",
    "alt": "Atlas Copco LUM22 HR3-P, référence 8431026906 : 450 L/min à vide, référence 6,3 bar",
    "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/lum22-hr3-p-sku8431026906",
    "sourceLabel": "Repères techniques CompatAir d’après Atlas Copco"
  },
  "editorial": {
    "overview": "Atlas Copco LUM22 HR3-P, référence 8431026906, demande 450 L/min à vide selon la fiche fabricant. Le dimensionnement utilise la pression de référence de 6,3 bar documentée dans le catalogue Industrial Tools and Solutions UK. Vitesse à vide : 2200 tr/min. Couple maximal de la plage : 3 Nm.",
    "verifiedFacts": [
      "Vitesse à vide : 2200 tr/min.",
      "Couple maximal de la plage : 3 Nm.",
      "Couple minimal de la plage : 0,6 Nm.",
  ...
  "specifications": [
    {
      ...
      "value": "2200 tr/min",
      "evidenceIds": [
        "atlas-copco-8431026906-fiche-fabricant"
      ]
    },
    {
    ...
    },
    {
      ...
      "value": "6,3 bar",
      "evidenceIds": [
        "atlas-copco-8431026906-catalogue-uk"
      ]
    }
  ],
  "evidence": [
    {
      "id": "atlas-copco-8431026906-fiche-fabricant",
      "sourceUrl": "https://www.atlascopco.com/en-ca/itba/products/assembly-solutions/pneumatic-assembly-tools/lum22-hr3-p-sku8431026906",
      "sourceLabel": "Atlas Copco, LUM22 HR3-P, 8431026906",
    ...
    {
      "id": "atlas-copco-8431026906-catalogue-uk",
      ...
      "retrievedAt": "2026-09-26",
      "confidence": "A",
      "notes": "Référence 8431026906 présente au tableau. Conditions générales : air détendu à la pression atmosphérique, pression de travail 6,3 bar sauf exception. Le millésime de cette édition n’est pas affirmé."
    }
  ],
  "fieldSources": {
    "mpn": [
