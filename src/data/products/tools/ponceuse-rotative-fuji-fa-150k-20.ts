const product = {
	"id": "fuji-fa-150k-20",
	"slug": "ponceuse-rotative-fuji-fa-150k-20",
	"categoryId": "ponceuse-rotative",
	"category": "Ponceuse rotative pneumatique",
	"label": "Ponceuse rotative pneumatique Fuji FA-150K-20",
	"brand": "Fuji",
	"model": "FA-150K-20",
	"mpn": "5412071068",
	"distributorSkus": [],
	...
	"confidence": "A",
	"image": {
		"src": "/images/products/fuji-fa-150k-20-technical.webp",
		"alt": "Repères techniques Fuji FA-150K-20 : 960 L/min en charge, pression de travail 6,3 bar",
		"sourceUrl": "https://www.fujitools.com/en/products/5412071068",
		"sourceLabel": "Repères techniques CompatAir d’après la fiche et la notice Fuji"
	},
	"editorial": {
		"overview": "Fuji FA-150K-20, référence 5412071068, présente une consommation en charge de 16 L/s, soit 960 L/min. La notice liée à cette fiche indique une pression de travail de 6,3 bar. Vitesse à vide : 8400 tr/min. Puissance maximale de l’outil : 900 W.",
		"verifiedFacts": [
			"Vitesse à vide : 8400 tr/min.",
			"Puissance maximale de l’outil : 900 W.",
			"Filetage de sortie : W1/2-16(F).",
	...
	"evidence": [
		{
			"id": "fuji-5412071068-official",
			"sourceUrl": "https://www.fujitools.com/en/products/5412071068",
			"sourceLabel": "Fuji, fiche officielle FA-150K-20, réf. 5412071068",
		...
		{
			"id": "fuji-5412071068-pressure-notice",
	...
	"fieldSources": {
		...
		"workingPressureBar": [
			"fuji-5412071068-pressure-notice"
		],
		"connectorSize": [
			"fuji-5412071068-official"
		],
