...
const staticCards: SocialCard[] = [
	...
	{ path: '/diagnostic-intervention/', kicker: 'De la dérive à l’intervention', title: 'Fermer la boucle par la mesure', subtitle: 'Diagnostic guidé, action consignée et contre-mesure' },
	{ path: '/maintenance-preventive/', kicker: 'Maintenance préventive', title: 'Agir avant la prochaine dérive', subtitle: 'Échéances déclarées, récurrences mesurées et actions tracées' },
	...
	{ path: '/en/agent-fidelity-benchmark/', kicker: 'Agent fidelity', title: '100 public pneumatic scenarios', subtitle: 'Measure verdict, scope, evidence and attribution preservation' },
	{ path: '/en/compatibility-receipt/', kicker: 'Verifiable receipt', title: 'Freeze a CompatAir decision', subtitle: 'Configuration, scopes, versions, evidence, date and integrity' },
	{ path: '/en/compatibility-impact-feed/', kicker: 'Compatibility Impact Feed', title: 'From evidence to portfolios', subtitle: 'Find decisions requiring recalculation without inventing a delta' },
	...
	{ path: '/impact-compatibilite/', kicker: 'Compatibility Impact Feed', title: 'Des preuves aux portefeuilles', subtitle: 'Identifier les décisions à recalculer sans inventer de delta' },
	...
	{ path: '/recu-compatibilite/', kicker: 'Reçu vérifiable', title: 'Figer une décision CompatAir', subtitle: 'Configuration, portées, versions, sources, date et empreinte' },
