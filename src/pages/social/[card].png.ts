...
const staticCards: SocialCard[] = [
	...
	{ path: '/calculateur/', kicker: 'Calculateur CompatAir', title: 'Dimensionner une installation pneumatique', subtitle: 'Débit, pression, fréquence et limites explicites' },
	{ path: '/passeport/', kicker: 'Dossier daté', title: 'Le Passeport CompatAir', subtitle: 'Installation, calculs, sources, marges et limites' },
	...
	{ path: '/preuves/', kicker: 'Sources et traçabilité', title: 'Historique complet des preuves', subtitle: 'Sources, dates et codes de contrôle' },
